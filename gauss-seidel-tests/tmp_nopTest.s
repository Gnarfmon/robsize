...
# mark_description "=low -fargument-noalias -funroll-loops -fno-builtin -diag-disable=10441 -o ./tmp/tmp_nopTest.s";
	.file "example.cpp"
	.text
..TXTST0:
...
..B1.4:                         # Preds ..B1.3
        ...
        movq      %rdx, -72(%rbp)                               #31.15[spill]
        imulq     %rcx, %rdx                                    #31.19
        shlq      $3, %rdx                                      #31.10
        movl      %eax, -496(%rbp)                              #29.8[spill]
        movq      %rdx, %rax                                    #31.10
        movq      %rcx, -64(%rbp)                               #31.19[spill]
        movq      %rdx, -264(%rbp)                              #31.10[spill]
        addq      $63, %rax                                     #31.10
        andq      $-64, %rax                                    #31.10
        subq      %rax, %rsp                                    #31.10
        movq      %rsp, %rax                                    #31.10
...
..B1.16:                        # Preds ..B1.15
        ...
        testl     %eax, %eax                                    #47.17
        jl        ..B1.108      # Prob 5%                       #47.17
                                # LOE r12 eax
..B1.17:                        # Preds ..B1.16
                                # Execution count [7.44e-01]
        xorl      %r14d, %r14d                                  #51.3
        cmpl      $0, -256(%rbp)                                #51.19[spill]
        jle       ..B1.123      # Prob 10%                      #51.19
                                # LOE r12 r14
..B1.18:                        # Preds ..B1.17
                                # Execution count [6.69e-01]
        movq      -64(%rbp), %rax                               #53.7[spill]
        movq      %r12, %r9                                     #51.3
        movq      -72(%rbp), %r8                                #51.3[spill]
        xorl      %r10d, %r10d                                  #51.3
        movl      -496(%rbp), %r13d                             #51.3[spill]
        movq      %rax, %r11                                    #51.3
...
..B1.46:                        # Preds ..B1.45
        ...
        decq      %rsi                                          #56.3
        imulq     %rsi, %r15                                    #57.9
        movq      %rax, -8(%r15,%r13)                           #57.9
        movq      %rax, (%r15,%r12)                             #58.9
                                # LOE r12 r13
..B1.47:                        # Preds ..B1.123 ..B1.45 ..B1.46
                                # Execution count [7.44e-01]
        cmpl      $0, -496(%rbp)                                #60.19[spill]
        jle       ..B1.61       # Prob 50%                      #60.19
                                # LOE r12 r13
..B1.48:                        # Preds ..B1.47
                                # Execution count [6.69e-01]
        cmpl      $16, -496(%rbp)                               #60.3[spill]
        jl        ..B1.101      # Prob 10%                      #60.3
                                # LOE r12 r13
..B1.49:                        # Preds ..B1.48
                                # Execution count [6.69e-01]
        movl      -256(%rbp), %r8d                              #61.25[spill]
        vxorpd    %xmm0, %xmm0, %xmm0                           #61.28
        movq      -72(%rbp), %rcx                               #62.9[spill]
        xorl      %edi, %edi                                    #60.3
        movl      -496(%rbp), %esi                              #60.3[spill]
        andl      $-16, %esi                                    #60.3
        lea       1(%r8), %eax                                  #61.25
        cltd                                                    #61.28
        idivl     %r8d                                          #61.28
...
..B1.52:                        # Preds ..B1.50 ..B1.101
                                # Execution count [7.44e-01]
        lea       1(%rsi), %eax                                 #60.3
        cmpl      -496(%rbp), %eax                              #60.3[spill]
        ja        ..B1.61       # Prob 50%                      #60.3
                                # LOE r12 r13 esi
..B1.53:                        # Preds ..B1.52
                                # Execution count [6.69e-01]
        movslq    %esi, %rsi                                    #60.3
        movq      -64(%rbp), %r8                                #60.3[spill]
        subq      %rsi, %r8                                     #60.3
        cmpq      $2, %r8                                       #60.3
        jl        ..B1.100      # Prob 10%                      #60.3
                                # LOE rsi r8 r12 r13
..B1.54:                        # Preds ..B1.53
                                # Execution count [6.69e-01]
        movl      -256(%rbp), %r9d                              #61.25[spill]
        vxorpd    %xmm0, %xmm0, %xmm0                           #61.28
        movq      -72(%rbp), %r10                               #62.9[spill]
        movl      %r8d, %edi                                    #60.3
        andl      $-2, %edi                                     #60.3
        xorl      %ecx, %ecx                                    #60.3
        movslq    %edi, %rdi                                    #60.3
...
..B1.58:                        # Preds ..B1.57
                                # Execution count [6.69e-01]
        movl      -256(%rbp), %ecx                              #61.25[spill]
        vxorpd    %xmm0, %xmm0, %xmm0                           #61.28
        movq      -72(%rbp), %r9                                #62.9[spill]
        lea       1(%rcx), %eax                                 #61.25
        cltd                                                    #61.28
        idivl     %ecx                                          #61.28
        vcvtsi2sd %eax, %xmm0, %xmm0                            #61.28
        lea       -8(,%r9,8), %r10                              #62.9
        imulq     -64(%rbp), %r10                               #62.9[spill]
        addq      %r12, %r10                                    #62.9
        lea       (%r12,%rsi,8), %rax                           #61.9
...
..B1.61:                        # Preds ..B1.59 ..B1.47 ..B1.52 ..B1.57
                                # Execution count [7.44e-01]
        movq      -64(%rbp), %r11                               #29.8[spill]
        movq      %r11, %r9                                     #82.19
        movl      -496(%rbp), %r15d                             #79.30[spill]
        movl      $1, %r14d                                     #65.3
        shlq      $5, %r9                                       #82.19
        addq      $-2, -72(%rbp)                                #28.8[spill]
        lea       (%r11,%r11,2), %rcx                           #81.33
        movq      $0, -200(%rbp)                                #67.20
        lea       (%r12,%rcx,8), %rsi                           #81.33
        movl      -256(%rbp), %ecx                              #78.26[spill]
        lea       -2(%r11), %rax                                #29.8
        movq      %rax, -128(%rbp)                              #29.8[spill]
        lea       -1(%r15), %eax                                #79.30
        movl      %eax, -160(%rbp)                              #79.30[spill]
        lea       (%r11,%r11,4), %rdi                           #81.33
        shlq      $4, %r11                                      #81.33
        lea       -2(%rcx), %r15d                               #78.7
        shrl      $2, %r15d                                     #78.7
        lea       (%r12,%rdi,8), %r8                            #81.33
        addq      %r12, %r11                                    #81.33
        lea       (%r12,%r9), %r10                              #81.33
        movq      %rsi, -96(%rbp)                               #81.33[spill]
        lea       -1(%rcx), %eax                                #78.26
        movq      %r8, -112(%rbp)                               #81.33[spill]
        movq      %r9, -104(%rbp)                               #82.19[spill]
        movq      %r10, -216(%rbp)                              #81.33[spill]
        movq      %r11, -208(%rbp)                              #81.33[spill]
        movl      %eax, -136(%rbp)                              #78.26[spill]
        movq      %r15, -120(%rbp)                              #78.7[spill]
                                # LOE r12 r13 r14d r15d
..B1.62:                        # Preds ..B1.85 ..B1.61
                                # Execution count [4.13e+00]
        movq      -200(%rbp), %rax                              #70.12
        movl      $1, %edi                                      #72.17
        movq      %rax, -184(%rbp)                              #70.12[spill]
        lea       -248(%rbp), %rsi                              #72.17
        vzeroupper                                              #72.17
...
..B1.63:                        # Preds ..B1.62
        ...
        vcvtsi2sdq -240(%rbp), %xmm0, %xmm0                     #72.17
        vcvtsi2sdq -248(%rbp), %xmm1, %xmm1                     #72.17
        vfmadd231sd .L_2il0floatpacket.0(%rip), %xmm0, %xmm1    #72.17
        movl      $9216, %esi                                   #73.5
        vmovsd    %xmm1, -176(%rbp)                             #72.17[spill]
        xorl      %edx, %edx                                    #73.5
        xorl      %eax, %eax                                    #73.5
        movl      -192(%rbp), %edi                              #73.5[spill]
...
..B1.64:                        # Preds ..B1.63
        ...
        jle       ..B1.81       # Prob 10%                      #76.22
                                # LOE r12 r13 edi r14d r15d
..B1.65:                        # Preds ..B1.64
                                # Execution count [3.72e+00]
        vmovsd    .L_2il0floatpacket.1(%rip), %xmm0             #
        xorl      %r9d, %r9d                                    #
        movl      -160(%rbp), %r8d                              #[spill]
        movq      -208(%rbp), %rcx                              #[spill]
        movq      -216(%rbp), %rax                              #[spill]
                                # LOE rax rcx r9 r12 r13 edi r8d r14d r15d xmm0
..B1.66:                        # Preds ..B1.79 ..B1.65
                                # Execution count [2.07e+01]
        movq      %r9, %rsi                                     #79.11
        cmpl      $1, %r8d                                      #79.30
        jle       ..B1.79       # Prob 0%                       #79.30
                                # LOE rax rcx rsi r9 r12 r13 edi r8d r14d r15d xmm0
..B1.67:                        # Preds ..B1.66
                                # Execution count [2.07e+01]
        movl      %edi, -152(%rbp)                              #[spill]
        movl      %r14d, -144(%rbp)                             #[spill]
                                # LOE rax rcx rsi r12 r13 r15d xmm0
..B1.68:                        # Preds ..B1.77 ..B1.67
                                # Execution count [1.15e+02]
        cmpl      $1, -136(%rbp)                                #78.26[spill]
...
..B1.69:                        # Preds ..B1.68
        ...
        movl      $1, %r11d                                     #78.7
        xorl      %r9d, %r9d                                    #78.7
        testl     %r15d, %r15d                                  #78.7
        je        ..B1.73       # Prob 0%                       #78.7
                                # LOE rax rdx rcx rsi r9 r12 r13 r11d r15d xmm0
..B1.70:                        # Preds ..B1.69
                                # Execution count [1.15e+02]
        movq      -96(%rbp), %r14                               #81.33[spill]
        lea       (%r13,%rsi,8), %r10                           #82.19
        movq      -112(%rbp), %rdi                              #81.33[spill]
        lea       (%rcx,%rsi,8), %r11                           #81.33
        vmovsd    8(%r12,%rsi,8), %xmm1                         #81.33
        lea       (%rax,%rsi,8), %r8                            #81.33
        movq      %r13, -80(%rbp)                               #81.33[spill]
        lea       (%r14,%rsi,8), %r14                           #81.33
        movq      %r12, -88(%rbp)                               #81.33[spill]
        lea       (%rdi,%rsi,8), %rdi                           #81.33
        movq      -120(%rbp), %r12                              #81.33[spill]
        movq      -104(%rbp), %r13                              #81.33[spill]
                                # LOE rax rdx rcx rsi rdi r8 r9 r10 r11 r12 r13 r14 r15d xmm0 xmm1
..B1.71:                        # Preds ..B1.71 ..B1.70
                                # Execution count [1.59e+02]
        vmovsd    (%r9,%r10), %xmm2                             #81.19
        incq      %rdx                                          #78.7
        vaddsd    8(%r9,%r11), %xmm2, %xmm3                     #80.15
        vaddsd    16(%r9,%r10), %xmm3, %xmm4                    #80.15
        vaddsd    %xmm1, %xmm4, %xmm1                           #80.15
        vmulsd    %xmm1, %xmm0, %xmm5                           #82.33
        vmovsd    %xmm5, 8(%r9,%r10)                            #80.15
        vaddsd    (%r9,%r11), %xmm5, %xmm6                      #81.33
        vaddsd    8(%r9,%r14), %xmm6, %xmm7                     #82.19
nop
nop
nop
nop
...
nop
nop
        vaddsd    16(%r9,%r11), %xmm7, %xmm8                    #82.33
        vmulsd    %xmm8, %xmm0, %xmm9                           #82.33
        vmovsd    %xmm9, 8(%r9,%r11)                            #80.15
        vaddsd    (%r9,%r14), %xmm9, %xmm10                     #81.33
        vaddsd    8(%r9,%r8), %xmm10, %xmm11                    #82.19
        vaddsd    16(%r9,%r14), %xmm11, %xmm12                  #82.33
        vmulsd    %xmm12, %xmm0, %xmm13                         #82.33
        vmovsd    %xmm13, 8(%r9,%r14)                           #80.15
        vaddsd    (%r9,%r8), %xmm13, %xmm14                     #81.33
        vaddsd    8(%r9,%rdi), %xmm14, %xmm15                   #82.19
        vaddsd    16(%r9,%r8), %xmm15, %xmm16                   #82.33
        vmulsd    %xmm16, %xmm0, %xmm1                          #82.33
        vmovsd    %xmm1, 8(%r9,%r8)                             #80.15
        addq      %r13, %r9                                     #78.7
        cmpq      %r12, %rdx                                    #78.7
...
..B1.72:                        # Preds ..B1.71
                                # Execution count [1.15e+02]
        movq      -80(%rbp), %r13                               #[spill]
        lea       1(,%rdx,4), %r11d                             #79.21
        movq      -88(%rbp), %r12                               #[spill]
                                # LOE rax rcx rsi r12 r13 r11d r15d xmm0
..B1.73:                        # Preds ..B1.72 ..B1.69
                                # Execution count [1.15e+02]
        movslq    %r11d, %r11                                   #78.7
        decq      %r11                                          #78.7
        movq      -64(%rbp), %r10                               #78.7[spill]
        imulq     %r11, %r10                                    #78.7
        cmpq      -72(%rbp), %r11                               #78.7[spill]
        jae       ..B1.77       # Prob 0%                       #78.7
                                # LOE rax rcx rsi r10 r11 r12 r13 r15d xmm0
..B1.74:                        # Preds ..B1.73
                                # Execution count [1.15e+02]
        movq      -72(%rbp), %r14                               #81.33[spill]
        lea       (%r12,%rsi,8), %r9                            #82.33
        movq      -64(%rbp), %rdx                               #81.33[spill]
        lea       (%r13,%rsi,8), %r8                            #82.19
        lea       (%rcx,%rsi,8), %rdi                           #81.33
                                # LOE rax rdx rcx rsi rdi r8 r9 r10 r11 r12 r13 r14 r15d xmm0
..B1.75:                        # Preds ..B1.75 ..B1.74
                                # Execution count [3.44e+02]
        vmovsd    (%r8,%r10,8), %xmm1                           #81.19
        incq      %r11                                          #78.7
        vaddsd    8(%rdi,%r10,8), %xmm1, %xmm2                  #81.33
...
..B1.77:                        # Preds ..B1.75 ..B1.68 ..B1.73
                                # Execution count [1.15e+02]
        incq      %rsi                                          #79.11
        cmpq      -128(%rbp), %rsi                              #79.11[spill]
        jb        ..B1.68       # Prob 82%                      #79.11
                                # LOE rax rcx rsi r12 r13 r15d xmm0
..B1.78:                        # Preds ..B1.77
                                # Execution count [2.07e+01]
        movl      -152(%rbp), %edi                              #[spill]
        xorl      %r9d, %r9d                                    #
        movl      -160(%rbp), %r8d                              #[spill]
...
..B1.83:                        # Preds ..B1.82
        ...
        vcvtsi2sdq -224(%rbp), %xmm0, %xmm0                     #89.15
        vcvtsi2sdq -232(%rbp), %xmm1, %xmm1                     #89.15
        vfmadd231sd .L_2il0floatpacket.0(%rip), %xmm0, %xmm1    #89.15
        lea       -200(%rbp), %rsi                              #90.15
        vmovsd    %xmm1, 32(%rsi)                               #89.15[spill]
        movl      $8, %edx                                      #90.15
        movl      8(%rsi), %edi                                 #90.15[spill]
...
..B1.85:                        # Preds ..B1.83
                                # Execution count [4.13e+00]
        vmovsd    -168(%rbp), %xmm16                            #92.20[spill]
        addl      %r14d, %r14d                                  #91.19
        vmovsd    .L_2il0floatpacket.2(%rip), %xmm0             #92.30
        vsubsd    -176(%rbp), %xmm16, %xmm1                     #92.20[spill]
...
..B1.90:                        # Preds ..B1.88
                                # Execution count [7.44e-01]: Infreq
        testl     %eax, %eax                                    #96.13
        jl        ..B1.110      # Prob 6%                       #96.13
                                # LOE r12 r14d
..B1.91:                        # Preds ..B1.90
                                # Execution count [6.92e-01]: Infreq
        vxorpd    %xmm1, %xmm1, %xmm1                           #104.3
        vxorpd    %xmm3, %xmm3, %xmm3                           #104.3
        vcvtsi2sd -496(%rbp), %xmm1, %xmm1                      #104.3[spill]
        vcvtsi2sd -256(%rbp), %xmm3, %xmm3                      #104.3[spill]
        vmovsd    .L_2il0floatpacket.2(%rip), %xmm0             #104.3
        vxorpd    %xmm5, %xmm5, %xmm5                           #104.3
        vdivsd    %xmm1, %xmm0, %xmm2                           #104.3
        vdivsd    %xmm3, %xmm2, %xmm4                           #104.3
        movq      -200(%rbp), %rcx                              #104.3
        movl      %r14d, %esi                                   #104.3
        subq      -184(%rbp), %rcx                              #104.3[spill]
        vxorpd    %xmm7, %xmm7, %xmm7                           #104.3
        vcvtsi2sdq %rcx, %xmm5, %xmm5                           #104.3
        shrl      $31, %esi                                     #104.3
        movl      $.L_2__STRING.5, %edi                         #104.3
        addl      %esi, %r14d                                   #104.3
        movl      $1, %eax                                      #104.3
        sarl      $1, %r14d                                     #104.3
        vcvtsi2sd %r14d, %xmm7, %xmm7                           #104.3
        vmulsd    %xmm5, %xmm4, %xmm6                           #104.3
        vdivsd    %xmm7, %xmm6, %xmm0                           #104.3
...
..B1.123:                       # Preds ..B1.17
        ...
        movq      -64(%rbp), %rax                               #56.3[spill]
        lea       (%r12,%rax,8), %r13                           #56.3
        jmp       ..B1.47       # Prob 100%                     #56.3
                                # LOE r12 r13
..B1.124:                       # Preds ..B1.41
                                # Execution count [7.44e-02]: Infreq
        movq      -64(%rbp), %rax                               #57.9[spill]
        lea       (%r12,%rax,8), %r13                           #57.9
...
..___tag_value_main.164:
	...
	.byte	0
	.uleb128	..___tag_value_main.108 - ..___tag_value_main.2
	.uleb128	..___tag_value_main.111 - ..___tag_value_main.108
	.byte	0
	.byte	0
	.uleb128	..___tag_value_main.112 - ..___tag_value_main.2
	.uleb128	..___tag_value_main.119 - ..___tag_value_main.112
	.uleb128	..___tag_value_main.1 - ..___tag_value_main.2
	.byte	0
	.uleb128	..___tag_value_main.136 - ..___tag_value_main.2
	.uleb128	..___tag_value_main.137 - ..___tag_value_main.136
	.byte	0
	.byte	0
	.uleb128	..___tag_value_main.138 - ..___tag_value_main.2
	.uleb128	..___tag_value_main.160 - ..___tag_value_main.138
	.uleb128	..___tag_value_main.1 - ..___tag_value_main.2
	.byte	0
...
..B2.1:                         # Preds ..B2.0
	...
	.cfi_startproc
	.cfi_personality 0x3,__gxx_personality_v0
..___tag_value__Z12getTimeStampv.168:
..L169:
                                                        #4.1
        subq      $24, %rsp                                     #4.1
	.cfi_def_cfa_offset 32
        movl      $1, %edi                                      #6.3
        lea       (%rsp), %rsi                                  #6.3
..___tag_value__Z12getTimeStampv.171:
#       clock_gettime(clockid_t, timespec *)
...
..B3.1:                         # Preds ..B3.0
	...
	.cfi_startproc
	.cfi_personality 0x3,__gxx_personality_v0
..___tag_value__Z17getTimeResolutionv.175:
..L176:
                                                        #11.1
        subq      $24, %rsp                                     #11.1
	.cfi_def_cfa_offset 32
        movl      $1, %edi                                      #13.3
        lea       (%rsp), %rsi                                  #13.3
..___tag_value__Z17getTimeResolutionv.178:
