...
p.add_argument('--figuresize', help='Set Figure size to x y explicitly (default 9,6)', type=float, nargs='+')
...
if (args.figuresize and len(args.figuresize) == 2):
    ax = df.plot.line(x=0, title=args.title, figsize=(args.figuresize[0],args.figuresize[1]), grid=True, **kwargs)
else :
