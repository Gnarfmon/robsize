...
..B1.28:                        # Preds ..B1.68 ..B1.26 ..B1.61 ..B1.66
                                # Execution count [1.00e+00]
        movl      $1, %r13d                                     #47.3
        lea       16(%rsp), %rsi                                #52.17
        movl      %r13d, %edi                                   #52.17
        xorl      %ebx, %ebx                                    #48.13
        vzeroupper                                              #52.17
..___tag_value_main.14:
#       clock_gettime(clockid_t, timespec *)
        call      clock_gettime                                 #52.17
..___tag_value_main.15:
                                # LOE r12 r14 r15 ebx r13d
..B1.29:                        # Preds ..B1.28
                                # Execution count [9.00e-01]
        vxorpd    %xmm0, %xmm0, %xmm0                           #52.17
        vxorpd    %xmm1, %xmm1, %xmm1                           #52.17
        vcvtsi2sdq 24(%rsp), %xmm0, %xmm0                       #52.17
        vcvtsi2sdq 16(%rsp), %xmm1, %xmm1                       #52.17
        vmovsd    .L_2il0floatpacket.1(%rip), %xmm2             #52.17
        vfmadd231sd %xmm2, %xmm0, %xmm1                         #52.17
        vmovsd    %xmm1, 8(%rsp)                                #59.27[spill]
        movq      %r12, (%rsp)                                  #59.27[spill]
	.cfi_escape 0x10, 0x0c, 0x0e, 0x38, 0x1c, 0x0d, 0x80, 0xff, 0xff, 0xff, 0x1a, 0x0d, 0x80, 0xff, 0xff, 0xff, 0x22
        xorl      %r12d, %r12d                                  #59.27
                                # LOE r12 r14 r15 ebx r13d
..B1.30:                        # Preds ..B1.41 ..B1.29
                                # Execution count [5.00e+00]
        movq      1592(%r15), %rax                              #67.15
        xorl      %edx, %edx                                    #67.3
        vmovsd    .L_2il0floatpacket.2(%rip), %xmm0             #67.15
                                # LOE rax r12 r14 r15 edx ebx r13d xmm0
..B1.32:                        # Preds ..B1.30 ..B1.34
                                # Execution count [2.78e+01]
        movq      %r12, %rcx                                    #58.11
        .align    16,0x90
                                # LOE rax rcx r12 r14 r15 edx ebx r13d xmm0
..B1.33:                        # Preds ..B1.33 ..B1.32
                                # Execution count [2.72e+03]
        vmovsd    800(%r15,%rcx,8), %xmm1                       #60.19
        vmovsd    800(%r14,%rcx,8), %xmm6                       #63.24
        vaddsd    1608(%r15,%rcx,8), %xmm1, %xmm2               #60.33
        vaddsd    1608(%r14,%rcx,8), %xmm6, %xmm7               #63.40
        vaddsd    816(%r15,%rcx,8), %xmm2, %xmm3                #61.19
        vaddsd    816(%r14,%rcx,8), %xmm7, %xmm8                #63.56
        vaddsd    8(%r15,%rcx,8), %xmm3, %xmm4                  #61.33
        vaddsd    8(%r14,%rcx,8), %xmm8, %xmm9                  #63.72
        vmulsd    %xmm4, %xmm0, %xmm5                           #61.33
        vmulsd    %xmm9, %xmm0, %xmm10                          #63.72
        vmovsd    %xmm5, 808(%r15,%rcx,8)                       #59.15
        vmovsd    %xmm10, 808(%r14,%rcx,8)                      #63.1
        incq      %rcx                                          #58.11
        cmpq      $98, %rcx                                     #58.11
        jb        ..B1.33       # Prob 98%                      #58.11
                                # LOE rax rcx r12 r14 r15 edx ebx r13d xmm0
..B1.34:                        # Preds ..B1.33
                                # Execution count [2.78e+01]
        incl      %edx                                          #54.5
        movq      1592(%r14), %rcx                              #68.17
        movq      %rax, 800(%r15)                               #67.3
        movq      %rcx, 1600(%r14)                              #68.1
        cmpl      %r13d, %edx                                   #54.5
        jb        ..B1.32       # Prob 82%                      #54.5
                                # LOE rax r12 r14 r15 edx ebx r13d xmm0
..B1.35:                        # Preds ..B1.34
                                # Execution count [5.00e+00]
        xorl      %eax, %eax                                    #54.5
...
..B1.36:                        # Preds ..B1.35 ..B1.36
        ...
        addl      $98, %ebx                                     #65.19
        cmpl      %r13d, %eax                                   #54.5
        jb        ..B1.36       # Prob 82%                      #54.5
                                # LOE r12 r14 r15 eax ebx r13d
..B1.38:                        # Preds ..B1.36 ..B1.41
                                # Execution count [5.56e+00]
        movl      $1, %edi                                      #72.15
        lea       32(%rsp), %rsi                                #72.15
...
..B1.39:                        # Preds ..B1.38
        ...
        vxorpd    %xmm17, %xmm17, %xmm17                        #72.15
        vcvtsi2sdq 40(%rsp), %xmm16, %xmm16                     #72.15
        vcvtsi2sdq 32(%rsp), %xmm17, %xmm17                     #72.15
        vfmadd231sd .L_2il0floatpacket.1(%rip), %xmm16, %xmm17  #72.15
        addl      %r13d, %r13d                                  #73.19
        vmovsd    .L_2il0floatpacket.4(%rip), %xmm0             #74.30
        vsubsd    8(%rsp), %xmm17, %xmm1                        #74.20[spill]
        vcomisd   %xmm1, %xmm0                                  #74.30
        jbe       ..B1.44       # Prob 18%                      #74.30
...
..B1.41:                        # Preds ..B1.40
        ...
        vcvtsi2sdq 24(%rsp), %xmm0, %xmm0                       #52.17
        vcvtsi2sdq 16(%rsp), %xmm1, %xmm1                       #52.17
        vfmadd231sd .L_2il0floatpacket.1(%rip), %xmm0, %xmm1    #52.17
        vmovsd    %xmm1, 8(%rsp)                                #52.17[spill]
        testl     %r13d, %r13d                                  #54.22
        jle       ..B1.38       # Prob 10%                      #54.22
        jmp       ..B1.30       # Prob 100%                     #54.22
	.cfi_restore 12
                                # LOE r12 r14 r15 ebx r13d
..B1.43:                        # Preds ..B1.5
...
..B1.44:                        # Preds ..B1.39
        ...
        movq      (%rsp), %r12                                  #[spill]
	.cfi_restore 12
        testl     %r13d, %r13d                                  #80.13
        jl        ..B1.49       # Prob 5%                       #80.13
	.cfi_escape 0x10, 0x0c, 0x0e, 0x38, 0x1c, 0x0d, 0x80, 0xff, 0xff, 0xff, 0x1a, 0x0d, 0x80, 0xff, 0xff, 0xff, 0x22
                                # LOE r12 r14 r15 ebx r13d
..B1.45:                        # Preds ..B1.44 ..B1.49
                                # Execution count [1.00e+00]: Infreq
        vxorpd    %xmm2, %xmm2, %xmm2                           #82.3
        movl      $.L_2__STRING.5, %edi                         #82.3
        vcvtsi2sd %r13d, %xmm2, %xmm2                           #82.3
        vmovsd    8(%rsp), %xmm0                                #82.3[spill]
        movl      $1, %eax                                      #82.3
        vmulsd    .L_2il0floatpacket.3(%rip), %xmm0, %xmm1      #82.3
        vdivsd    %xmm2, %xmm1, %xmm0                           #82.3
