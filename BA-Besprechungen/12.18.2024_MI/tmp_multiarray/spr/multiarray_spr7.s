...
..B1.22:                        # Preds ..B1.21
                                # Execution count [9.49e-01]
        movq      288(%rsp), %rsi                               #86.2[spill]
        xorl      %eax, %eax                                    #98.3
        movq      296(%rsp), %r8                                #88.2[spill]
        movq      272(%rsp), %rcx                               #82.9[spill]
        movq      280(%rsp), %rbx                               #84.2[spill]
        ...
        vmovsd    %xmm0, (%r12)                                 #94.2
        vmovsd    %xmm0, 792(%r12)                              #93.1
        vmovsd    %xmm0, (%r15)                                 #96.2
        ...
        vmovsd    %xmm0, 800(%r12)                              #94.2
        vmovsd    %xmm0, 1592(%r12)                             #93.1
        vmovsd    %xmm0, 800(%r15)                              #96.2
...
..B1.23:                        # Preds ..B1.23 ..B1.22
        ...
        vmovsd    %xmm0, 1600(%r8,%rax,8)                       #100.9
        incq      %rax                                          #98.3
        cmpq      $100, %rax                                    #98.3
...
..B1.24:                        # Preds ..B1.23
        ...
        movq      %r13, 304(%rsp)                               #117.3[spill]
        movq      %r14, 312(%rsp)                               #117.3[spill]
        movq      %r12, %r14                                    #117.3
        movl      %edx, %r12d                                   #117.3
...
..B1.27:                        # Preds ..B1.26
                                # Execution count [5.27e+00]
        xorl      %r10d, %r10d                                  #127.15
        testl     %ebx, %ebx                                    #127.22
        jle       ..B1.34       # Prob 10%                      #127.22
                                # LOE r13 r14 r15 ebx r10d r12d
..B1.28:                        # Preds ..B1.27
        ...
        movq      272(%rsp), %r8                                #[spill]
                                # LOE rax rdx rcx rsi r8 r9 r13 r14 r15 ebx r10d r12d xmm0
..B1.30:                        # Preds ..B1.28 ..B1.32
                                # Execution count [2.64e+01]
        movl      $1, %r11d                                     #131.21
                                # LOE rax rdx rcx rsi r8 r9 r11 r13 r14 r15 ebx r10d r12d xmm0
..B1.31:                        # Preds ..B1.31 ..B1.30
                                # Execution count [2.58e+03]
        vmovsd    792(%r8,%r11,8), %xmm1                        #133.19
        vmovsd    792(%rsi,%r11,8), %xmm6                       #136.24
        vmovsd    792(%rcx,%r11,8), %xmm11                      #137.24
        vmovsd    792(%rdx,%r11,8), %xmm16                      #138.24
        vmovsd    792(%rax,%r11,8), %xmm21                      #139.24
        vmovsd    792(%r9,%r11,8), %xmm26                       #140.24
        vmovsd    792(%r14,%r11,8), %xmm31                      #141.24
        vaddsd    1600(%r8,%r11,8), %xmm1, %xmm2                #133.33
        vaddsd    1600(%rsi,%r11,8), %xmm6, %xmm7               #136.40
        vaddsd    1600(%rcx,%r11,8), %xmm11, %xmm12             #137.40
        vaddsd    1600(%rdx,%r11,8), %xmm16, %xmm17             #138.40
        vaddsd    1600(%rax,%r11,8), %xmm21, %xmm22             #139.40
        vaddsd    808(%r8,%r11,8), %xmm2, %xmm3                 #134.19
        vaddsd    1600(%r9,%r11,8), %xmm26, %xmm27              #140.40
        vaddsd    1600(%r14,%r11,8), %xmm31, %xmm1              #141.40
        vaddsd    808(%rsi,%r11,8), %xmm7, %xmm8                #136.56
        vaddsd    808(%rcx,%r11,8), %xmm12, %xmm13              #137.56
        vaddsd    (%r8,%r11,8), %xmm3, %xmm4                    #134.33
        vaddsd    808(%rdx,%r11,8), %xmm17, %xmm18              #138.56
        vaddsd    808(%rax,%r11,8), %xmm22, %xmm23              #139.56
        vaddsd    808(%r9,%r11,8), %xmm27, %xmm28               #140.56
        vaddsd    808(%r14,%r11,8), %xmm1, %xmm2                #141.56
        vmulsd    %xmm4, %xmm0, %xmm5                           #134.33
        vaddsd    (%rsi,%r11,8), %xmm8, %xmm9                   #136.72
        vaddsd    (%rcx,%r11,8), %xmm13, %xmm14                 #137.72
        vaddsd    (%rdx,%r11,8), %xmm18, %xmm19                 #138.72
        vaddsd    (%rax,%r11,8), %xmm23, %xmm24                 #139.72
        vaddsd    (%r9,%r11,8), %xmm28, %xmm29                  #140.72
        vmulsd    %xmm9, %xmm0, %xmm10                          #136.72
        vaddsd    (%r14,%r11,8), %xmm2, %xmm3                   #141.72
        ...
        vmovsd    %xmm5, 800(%r8,%r11,8)                        #132.15
        vmovsd    792(%r15,%r11,8), %xmm5                       #142.24
        vmovsd    %xmm10, 800(%rsi,%r11,8)                      #136.1
        vmovsd    %xmm15, 800(%rcx,%r11,8)                      #137.1
        vmovsd    %xmm20, 800(%rdx,%r11,8)                      #138.1
        vmovsd    %xmm25, 800(%rax,%r11,8)                      #139.1
        vmovsd    %xmm30, 800(%r9,%r11,8)                       #140.1
        vmovsd    %xmm4, 800(%r14,%r11,8)                       #141.1
        vaddsd    1600(%r15,%r11,8), %xmm5, %xmm6               #142.40
        vaddsd    808(%r15,%r11,8), %xmm6, %xmm7                #142.56
        vaddsd    (%r15,%r11,8), %xmm7, %xmm8                   #142.72
        vmulsd    %xmm8, %xmm0, %xmm9                           #142.72
        vmovsd    %xmm9, 800(%r15,%r11,8)                       #142.1
        incq      %r11                                          #131.35
        cmpq      $99, %r11                                     #131.27
...
..B1.32:                        # Preds ..B1.31
                                # Execution count [2.64e+01]
        movq      1592(%r8), %r11                               #144.18
        incl      %r10d                                         #127.31
        movq      %r11, 1600(%r8)                               #144.4
        movq      1592(%rsi), %r11                              #145.17
        movq      %r11, 1600(%rsi)                              #145.1
        movq      1592(%rcx), %r11                              #146.17
        movq      %r11, 1600(%rcx)                              #146.1
        movq      1592(%rdx), %r11                              #147.17
        movq      %r11, 1600(%rdx)                              #147.1
        movq      1592(%rax), %r11                              #148.17
        movq      %r11, 1600(%rax)                              #148.1
        movq      1592(%r9), %r11                               #149.17
        movq      %r11, 1600(%r9)                               #149.1
        movq      1592(%r14), %r11                              #150.17
        movq      %r11, 1600(%r14)                              #150.1
        movq      1592(%r15), %r11                              #151.17
        movq      %r11, 1600(%r15)                              #151.1
        cmpl      %ebx, %r10d                                   #127.22
...
..B1.36:                        # Preds ..B1.35
        ...
        vcvtsi2sdq 264(%rsp), %xmm0, %xmm0                      #156.15
        vcvtsi2sdq 256(%rsp), %xmm1, %xmm1                      #156.15
        vfmadd231sd .L_2il0floatpacket.0(%rip), %xmm0, %xmm1    #156.15
        movl      %r12d, %edi                                   #157.15
        vmovsd    %xmm1, 232(%rsp)                              #156.15[spill]
        movl      $8, %edx                                      #157.15
        lea       320(%rsp), %rsi                               #157.15
...
..B1.37:                        # Preds ..B1.36
                                # Execution count [5.27e+00]
        vmovsd    232(%rsp), %xmm16                             #159.20[spill]
        addl      %ebx, %ebx                                    #158.19
        vmovsd    .L_2il0floatpacket.4(%rip), %xmm0             #159.30
        vsubsd    224(%rsp), %xmm16, %xmm1                      #159.20[spill]
...
..B1.38:                        # Preds ..B1.37
                                # Execution count [9.49e-01]
        movl      %r12d, %edx                                   #
        lea       320(%rsp), %rsi                               #162.13
        movl      %edx, %edi                                    #162.13
        movl      $8, %edx                                      #162.13
        vmovsd    %xmm1, -88(%rsi)                              #[spill]
        movq      %r14, %r12                                    #
        movq      %r13, -96(%rsi)                               #[spill]
...
..B1.39:                        # Preds ..B1.38
        ...
        jge       ..B1.49       # Prob 59%                      #163.13
                                # LOE r12 r13 r14 r15 ebx
..B1.40:                        # Preds ..B1.39
                                # Execution count [2.58e-01]
        movq      272(%rsp), %rdi                               #164.2[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #164.2
                                # LOE r12 r13 r14 r15
..B1.41:                        # Preds ..B1.40
                                # Execution count [2.58e-01]
        movq      280(%rsp), %rdi                               #165.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #165.1
                                # LOE r12 r13 r14 r15
..B1.42:                        # Preds ..B1.41
                                # Execution count [2.58e-01]
        movq      288(%rsp), %rdi                               #166.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #166.1
                                # LOE r12 r13 r14 r15
..B1.43:                        # Preds ..B1.42
                                # Execution count [2.58e-01]
        movq      296(%rsp), %rdi                               #167.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #167.1
                                # LOE r12 r13 r14 r15
..B1.44:                        # Preds ..B1.43
...
..B1.49:                        # Preds ..B1.39
        ...
        movq      320(%rsp), %rcx                               #179.33
        subq      224(%rsp), %rcx                               #179.33[spill]
        vcvtsi2sdq %rcx, %xmm6, %xmm6                           #179.40
        vmovsd    232(%rsp), %xmm2                              #180.72[spill]
        vmulsd    .L_2il0floatpacket.3(%rip), %xmm2, %xmm5      #180.72
        vmulsd    .L_2il0floatpacket.2(%rip), %xmm6, %xmm7      #179.52
        vmulsd    %xmm8, %xmm5, %xmm1                           #180.75
...
..B1.50:                        # Preds ..B1.49
        ...
        movq      272(%rsp), %rdi                               #183.3[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #183.3
                                # LOE r12 r13 r14 r15
..B1.51:                        # Preds ..B1.50
                                # Execution count [3.82e-01]
        movq      280(%rsp), %rdi                               #184.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #184.1
                                # LOE r12 r13 r14 r15
..B1.52:                        # Preds ..B1.51
                                # Execution count [3.82e-01]
        movq      288(%rsp), %rdi                               #185.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #185.1
                                # LOE r12 r13 r14 r15
..B1.53:                        # Preds ..B1.52
                                # Execution count [3.82e-01]
        movq      296(%rsp), %rdi                               #186.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #186.1
                                # LOE r12 r13 r14 r15
..B1.54:                        # Preds ..B1.53
