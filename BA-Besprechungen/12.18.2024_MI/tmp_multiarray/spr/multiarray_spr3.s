...
..B1.44:                        # Preds ..B1.43
                                # Execution count [2.64e+01]
        movq      1592(%r9), %rsi                               #112.18
        incl      %ecx                                          #99.31
        movq      %rsi, 1600(%r9)                               #112.4
        movq      1592(%r8), %r10                               #113.17
        movq      1592(%r13), %r11                              #114.17
        movq      1592(%r15), %rsi                              #115.17
        movq      %r10, 1600(%r8)                               #113.1
        movq      %r11, 1600(%r13)                              #114.1
        movq      %rsi, 1600(%r15)                              #115.1
        cmpl      %ebx, %ecx                                    #99.22
...
..B1.48:                        # Preds ..B1.47
        ...
        vfmadd231sd .L_2il0floatpacket.0(%rip), %xmm0, %xmm1    #120.15
        movl      %r12d, %edi                                   #121.15
        vmovsd    %xmm1, 232(%rsp)                              #120.15[spill]
        movl      $8, %edx                                      #121.15
...
..B1.49:                        # Preds ..B1.48
                                # Execution count [5.27e+00]
        vmovsd    232(%rsp), %xmm16                             #123.20[spill]
        addl      %ebx, %ebx                                    #122.19
        vmovsd    .L_2il0floatpacket.4(%rip), %xmm0             #123.30
        vsubsd    224(%rsp), %xmm16, %xmm1                      #123.20[spill]
        vcomisd   %xmm1, %xmm0                                  #123.30
        ja        ..B1.37       # Prob 82%                      #123.30
...
..B1.57:                        # Preds ..B1.51
        ...
        vmovsd    .L_2il0floatpacket.4(%rip), %xmm2             #139.46
        vdivsd    %xmm16, %xmm2, %xmm5                          #139.46
        movq      288(%rsp), %rcx                               #139.33
        subq      232(%rsp), %rcx                               #139.33[spill]
        vcvtsi2sdq %rcx, %xmm17, %xmm17                         #139.40
        vmovsd    224(%rsp), %xmm3                              #140.72[spill]
        vmulsd    .L_2il0floatpacket.2(%rip), %xmm17, %xmm18    #139.52
        vmulsd    .L_2il0floatpacket.3(%rip), %xmm3, %xmm4      #140.72
        vmulsd    %xmm5, %xmm18, %xmm0                          #139.55
        vmulsd    %xmm5, %xmm4, %xmm1                           #140.75
