...
..B1.21:                        # Preds ..B1.20
                                # Execution count [9.49e-01]
        movq      272(%rsp), %rsi                               #91.2[spill]
        xorl      %eax, %eax                                    #93.3
        movq      280(%rsp), %rcx                               #79.9[spill]
        movq      288(%rsp), %rbx                               #81.2[spill]
        ...
        vmovsd    %xmm0, 792(%rbx)                              #80.1
        vmovsd    %xmm0, (%r12)                                 #83.2
        vmovsd    %xmm0, 792(%r12)                              #82.1
        vmovsd    %xmm0, (%r13)                                 #85.2
        vmovsd    %xmm0, 792(%r13)                              #84.1
        vmovsd    %xmm0, (%r14)                                 #87.2
        vmovsd    %xmm0, 792(%r14)                              #86.1
        vmovsd    %xmm0, (%r15)                                 #89.2
        vmovsd    %xmm0, 792(%r15)                              #88.1
        vmovsd    %xmm0, 800(%rcx)                              #79.9
        vmovsd    %xmm0, 1592(%rcx)                             #78.9
        vmovsd    %xmm0, 800(%rbx)                              #81.2
        vmovsd    %xmm0, 1592(%rbx)                             #80.1
        vmovsd    %xmm0, 800(%r12)                              #83.2
        vmovsd    %xmm0, 1592(%r12)                             #82.1
        vmovsd    %xmm0, 800(%r13)                              #85.2
        vmovsd    %xmm0, 1592(%r13)                             #84.1
        vmovsd    %xmm0, 800(%r14)                              #87.2
        vmovsd    %xmm0, 1592(%r14)                             #86.1
        vmovsd    %xmm0, 800(%r15)                              #89.2
        vmovsd    %xmm0, 1592(%r15)                             #88.1
        vmovsd    %xmm0, 1600(%rcx)                             #79.9
        vmovsd    %xmm0, 2392(%rcx)                             #78.9
        movq      %rsi, %rcx                                    #93.3
        vmovsd    %xmm0, 1600(%rbx)                             #81.2
        vmovsd    %xmm0, 2392(%rbx)                             #80.1
        vmovsd    %xmm0, 1600(%r12)                             #83.2
        vmovsd    %xmm0, 2392(%r12)                             #82.1
        vmovsd    %xmm0, 1600(%r13)                             #85.2
        vmovsd    %xmm0, 2392(%r13)                             #84.1
        vmovsd    %xmm0, 1600(%r14)                             #87.2
        vmovsd    %xmm0, 2392(%r14)                             #86.1
        vmovsd    %xmm0, 1600(%r15)                             #89.2
        vmovsd    %xmm0, 2392(%r15)                             #88.1
        movq      280(%rsp), %rsi                               #93.3[spill]
        .align    16,0x90
...
..B1.22:                        # Preds ..B1.22 ..B1.21
        ...
        vmovsd    %xmm0, 1600(%r15,%rax,8)                      #105.2
        vmovsd    %xmm0, (%r14,%rax,8)                          #102.1
        vmovsd    %xmm0, 1600(%r14,%rax,8)                      #103.2
        vmovsd    %xmm0, (%r13,%rax,8)                          #100.1
        vmovsd    %xmm0, 1600(%r13,%rax,8)                      #101.2
        vmovsd    %xmm0, (%r12,%rax,8)                          #98.1
        vmovsd    %xmm0, 1600(%r12,%rax,8)                      #99.2
        vmovsd    %xmm0, (%rbx,%rax,8)                          #96.1
        vmovsd    %xmm0, 1600(%rbx,%rax,8)                      #97.2
        vmovsd    %xmm0, (%rsi,%rax,8)                          #94.9
        vmovsd    %xmm0, 1600(%rsi,%rax,8)                      #95.9
        incq      %rax                                          #93.3
        cmpq      $100, %rax                                    #93.3
...
..B1.23:                        # Preds ..B1.22
                                # Execution count [9.49e-01]
        movq      %r13, 304(%rsp)                               #125.27[spill]
        movl      $1, %ebx                                      #110.3
        movq      $0, 320(%rsp)                                 #112.20
        vmovsd    .L_2il0floatpacket.0(%rip), %xmm1             #117.17
        vmovsd    .L_2il0floatpacket.1(%rip), %xmm0             #125.27
        movq      %r14, 296(%rsp)                               #125.27[spill]
        movq      %r12, 312(%rsp)                               #125.27[spill]
        movl      %edx, %r12d                                   #125.27
...
..B1.27:                        # Preds ..B1.26
        ...
        movq      304(%rsp), %rax                               #[spill]
        movq      312(%rsp), %rdx                               #[spill]
        movq      288(%rsp), %rcx                               #[spill]
        movq      280(%rsp), %rsi                               #[spill]
                                # LOE rax rdx rcx rsi r8 r13 r14 r15 ebx r9d r12d xmm0
..B1.29:                        # Preds ..B1.27 ..B1.31
                                # Execution count [2.64e+01]
        movl      $1, %r10d                                     #124.21
                                # LOE rax rdx rcx rsi r8 r10 r13 r14 r15 ebx r9d r12d xmm0
..B1.30:                        # Preds ..B1.30 ..B1.29
                                # Execution count [2.58e+03]
        vmovsd    792(%rsi,%r10,8), %xmm1                       #126.19
        vmovsd    792(%rcx,%r10,8), %xmm6                       #129.24
        vmovsd    792(%rdx,%r10,8), %xmm11                      #130.24
        vmovsd    792(%rax,%r10,8), %xmm16                      #131.24
        vmovsd    792(%r8,%r10,8), %xmm21                       #132.24
        vmovsd    792(%r15,%r10,8), %xmm26                      #133.24
        vmovsd    792(%r13,%r10,8), %xmm31                      #134.24
        vaddsd    1600(%rsi,%r10,8), %xmm1, %xmm2               #126.33
        vaddsd    1600(%rcx,%r10,8), %xmm6, %xmm7               #129.40
        vaddsd    1600(%rdx,%r10,8), %xmm11, %xmm12             #130.40
        vaddsd    1600(%rax,%r10,8), %xmm16, %xmm17             #131.40
        vaddsd    1600(%r8,%r10,8), %xmm21, %xmm22              #132.40
        vaddsd    1600(%r15,%r10,8), %xmm26, %xmm27             #133.40
        vaddsd    1600(%r13,%r10,8), %xmm31, %xmm1              #134.40
        vaddsd    808(%rsi,%r10,8), %xmm2, %xmm3                #127.19
        vaddsd    808(%rcx,%r10,8), %xmm7, %xmm8                #129.56
        vaddsd    808(%rdx,%r10,8), %xmm12, %xmm13              #130.56
        vaddsd    808(%rax,%r10,8), %xmm17, %xmm18              #131.56
        vaddsd    808(%r8,%r10,8), %xmm22, %xmm23               #132.56
        vaddsd    808(%r15,%r10,8), %xmm27, %xmm28              #133.56
        vaddsd    808(%r13,%r10,8), %xmm1, %xmm2                #134.56
        vaddsd    (%rsi,%r10,8), %xmm3, %xmm4                   #127.33
        vaddsd    (%rcx,%r10,8), %xmm8, %xmm9                   #129.72
        vaddsd    (%rdx,%r10,8), %xmm13, %xmm14                 #130.72
        vaddsd    (%rax,%r10,8), %xmm18, %xmm19                 #131.72
        vaddsd    (%r8,%r10,8), %xmm23, %xmm24                  #132.72
        vmulsd    %xmm4, %xmm0, %xmm5                           #127.33
        vaddsd    (%r15,%r10,8), %xmm28, %xmm29                 #133.72
        vaddsd    (%r13,%r10,8), %xmm2, %xmm3                   #134.72
        ...
        vmovsd    %xmm5, 800(%rsi,%r10,8)                       #125.15
        vmovsd    %xmm10, 800(%rcx,%r10,8)                      #129.1
        vmovsd    %xmm15, 800(%rdx,%r10,8)                      #130.1
        vmovsd    %xmm20, 800(%rax,%r10,8)                      #131.1
        vmovsd    %xmm25, 800(%r8,%r10,8)                       #132.1
        vmovsd    %xmm30, 800(%r15,%r10,8)                      #133.1
        vmovsd    %xmm4, 800(%r13,%r10,8)                       #134.1
        incq      %r10                                          #124.35
        cmpq      $99, %r10                                     #124.27
...
..B1.31:                        # Preds ..B1.30
                                # Execution count [2.64e+01]
        movq      1592(%rsi), %r10                              #136.18
        incl      %r9d                                          #120.31
        movq      %r10, 1600(%rsi)                              #136.4
        movq      1592(%rdx), %r10                              #138.17
        movq      %r10, 1600(%rdx)                              #138.1
        movq      1592(%rax), %r10                              #139.17
        movq      %r10, 1600(%rax)                              #139.1
        movq      1592(%r8), %r10                               #140.17
        movq      %r10, 1600(%r8)                               #140.1
        movq      1592(%r15), %r10                              #141.17
        movq      %r10, 1600(%r15)                              #141.1
        movq      1592(%rcx), %r11                              #137.17
        movq      1592(%r13), %r10                              #142.17
        movq      %r11, 1600(%rcx)                              #137.1
        movq      %r10, 1600(%r13)                              #142.1
        cmpl      %ebx, %r9d                                    #120.22
...
..B1.35:                        # Preds ..B1.34
        ...
        vcvtsi2sdq 264(%rsp), %xmm0, %xmm0                      #147.15
        vcvtsi2sdq 256(%rsp), %xmm1, %xmm1                      #147.15
        vfmadd231sd .L_2il0floatpacket.0(%rip), %xmm0, %xmm1    #147.15
        movl      %r12d, %edi                                   #148.15
        vmovsd    %xmm1, 232(%rsp)                              #147.15[spill]
        movl      $8, %edx                                      #148.15
        lea       320(%rsp), %rsi                               #148.15
...
..B1.36:                        # Preds ..B1.35
                                # Execution count [5.27e+00]
        vmovsd    232(%rsp), %xmm16                             #150.20[spill]
        addl      %ebx, %ebx                                    #149.19
        vmovsd    .L_2il0floatpacket.4(%rip), %xmm0             #150.30
        vsubsd    224(%rsp), %xmm16, %xmm1                      #150.20[spill]
...
..B1.37:                        # Preds ..B1.36
                                # Execution count [9.49e-01]
        movl      %r12d, %edx                                   #
        lea       320(%rsp), %rsi                               #153.13
        movl      %edx, %edi                                    #153.13
        movl      $8, %edx                                      #153.13
        vmovsd    %xmm1, -88(%rsi)                              #[spill]
        movq      %r14, -96(%rsi)                               #[spill]
...
..B1.38:                        # Preds ..B1.37
        ...
        jge       ..B1.47       # Prob 59%                      #154.13
                                # LOE r12 r13 r14 r15 ebx
..B1.39:                        # Preds ..B1.38
                                # Execution count [2.58e-01]
        movq      280(%rsp), %rdi                               #155.2[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #155.2
                                # LOE r12 r13 r14 r15
..B1.40:                        # Preds ..B1.39
                                # Execution count [2.58e-01]
        movq      288(%rsp), %rdi                               #156.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #156.1
                                # LOE r12 r13 r14 r15
..B1.41:                        # Preds ..B1.40
...
..B1.47:                        # Preds ..B1.38
        ...
        movq      320(%rsp), %rcx                               #169.33
        subq      224(%rsp), %rcx                               #169.33[spill]
        vcvtsi2sdq %rcx, %xmm5, %xmm5                           #169.40
        vmovsd    232(%rsp), %xmm2                              #170.72[spill]
        vmulsd    .L_2il0floatpacket.3(%rip), %xmm2, %xmm7      #170.72
        vmulsd    .L_2il0floatpacket.2(%rip), %xmm5, %xmm6      #169.52
        vmulsd    %xmm8, %xmm7, %xmm1                           #170.75
...
..B1.48:                        # Preds ..B1.47
        ...
        movq      280(%rsp), %rdi                               #173.3[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #173.3
                                # LOE r12 r13 r14 r15
..B1.49:                        # Preds ..B1.48
                                # Execution count [3.82e-01]
        movq      288(%rsp), %rdi                               #174.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #174.1
                                # LOE r12 r13 r14 r15
..B1.50:                        # Preds ..B1.49
