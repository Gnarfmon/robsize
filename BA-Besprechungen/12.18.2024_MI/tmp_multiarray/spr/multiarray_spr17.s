...
..B1.28:                        # Preds ..B1.27
        ...
        movl      %edx, 304(%rsp)                               #88.3[spill]
        movq      %r14, 368(%rsp)                               #88.3[spill]
        movq      %r15, 440(%rsp)                               #88.3[spill]
        movq      %r12, 400(%rsp)                               #88.3[spill]
        movq      %r13, 392(%rsp)                               #88.3[spill]
                                # LOE rax ymm0
..B1.29:                        # Preds ..B1.31 ..B1.28
                                # Execution count [2.85e+00]
        movq      392(%rsp), %r13                               #90.7[spill]
        xorl      %r14d, %r14d                                  #89.5
        movq      400(%rsp), %r11                               #91.1[spill]
        movq      280(%rsp), %r9                                #92.1[spill]
        movq      408(%rsp), %rdi                               #93.1[spill]
        lea       (%r13,%rax), %r12                             #90.7
        movq      416(%rsp), %rbx                               #94.1[spill]
        lea       (%r11,%rax), %r10                             #91.1
        movq      440(%rsp), %r15                               #97.1[spill]
        lea       (%r9,%rax), %r8                               #92.1
        movq      432(%rsp), %rdx                               #96.1[spill]
        lea       (%rdi,%rax), %rsi                             #93.1
        movq      424(%rsp), %rcx                               #95.1[spill]
        lea       (%rbx,%rax), %r13                             #94.1
        movq      352(%rsp), %rbx                               #102.1[spill]
        movq      %r10, 384(%rsp)                               #91.1[spill]
        lea       (%r15,%rax), %r10                             #97.1
        movq      %r8, 320(%rsp)                                #92.1[spill]
        lea       (%rdx,%rax), %r11                             #96.1
        movq      %rsi, 312(%rsp)                               #93.1[spill]
        movq      368(%rsp), %r15                               #104.1[spill]
        movq      288(%rsp), %r9                                #98.1[spill]
        movq      296(%rsp), %r8                                #99.1[spill]
        movq      336(%rsp), %rdi                               #100.1[spill]
        movq      344(%rsp), %rsi                               #101.1[spill]
        movq      360(%rsp), %rdx                               #103.1[spill]
        movq      %r12, 328(%rsp)                               #90.7[spill]
        lea       (%rcx,%rax), %r12                             #95.1
        movq      %r10, 256(%rsp)                               #97.1[spill]
        lea       (%rbx,%rax), %rcx                             #102.1
        movq      %rcx, 232(%rsp)                               #102.1[spill]
        lea       (%r15,%rax), %rbx                             #104.1
        movq      264(%rsp), %r15                               #107.1[spill]
        lea       (%r9,%rax), %r10                              #98.1
...
..B1.30:                        # Preds ..B1.30 ..B1.29
        ...
        movq      384(%rsp), %r15                               #91.1[spill]
        vmovupd   %ymm0, (%r15,%r14,8)                          #91.1
        movq      320(%rsp), %r15                               #92.1[spill]
        vmovupd   %ymm0, (%r15,%r14,8)                          #92.1
        movq      312(%rsp), %r15                               #93.1[spill]
...
..B1.31:                        # Preds ..B1.30
        ...
        cmpb      $3, %dl                                       #88.3
        jb        ..B1.29       # Prob 66%                      #88.3
                                # LOE rax ymm0
..B1.32:                        # Preds ..B1.31
                                # Execution count [9.49e-01]
        movq      416(%rsp), %rsi                               #120.2[spill]
        xorl      %eax, %eax                                    #148.3
        movq      280(%rsp), %rcx                               #116.2[spill]
        movq      408(%rsp), %rbx                               #118.2[spill]
        vmovsd    .L_2il0floatpacket.4(%rip), %xmm0             #112.9
        ...
        movq      352(%rsp), %rsi                               #136.2[spill]
        movq      424(%rsp), %r8                                #122.2[spill]
        movq      336(%rsp), %rcx                               #132.2[spill]
        movq      344(%rsp), %rbx                               #134.2[spill]
        ...
        movq      432(%rsp), %r9                                #124.2[spill]
        movq      288(%rsp), %r10                               #128.2[spill]
        movq      296(%rsp), %r11                               #130.2[spill]
        movq      264(%rsp), %rsi                               #146.2[spill]
        ...
        movq      360(%rsp), %r8                                #138.2[spill]
        movq      376(%rsp), %rcx                               #142.2[spill]
        movq      368(%rsp), %r14                               #[spill]
        movq      272(%rsp), %rbx                               #144.2[spill]
...
..B1.33:                        # Preds ..B1.33 ..B1.32
        ...
        vmovsd    %xmm0, (%rbx,%rax,8)                          #181.1
        vmovsd    %xmm0, 1600(%rbx,%rax,8)                      #182.2
        vmovsd    %xmm0, (%rsi,%rax,8)                          #179.1
        vmovsd    %xmm0, 1600(%rsi,%rax,8)                      #180.2
        vmovsd    %xmm0, (%r14,%rax,8)                          #177.1
        vmovsd    %xmm0, 1600(%r14,%rax,8)                      #178.2
...
..B1.34:                        # Preds ..B1.33
                                # Execution count [9.49e-01]
        vmovsd    .L_2il0floatpacket.4(%rip), %xmm0             #148.3
        xorl      %eax, %eax                                    #148.3
        movq      296(%rsp), %rcx                               #148.3[spill]
        movq      288(%rsp), %rbx                               #148.3[spill]
        movq      432(%rsp), %rsi                               #148.3[spill]
        movq      424(%rsp), %r8                                #148.3[spill]
        movq      416(%rsp), %r9                                #148.3[spill]
        movq      408(%rsp), %r10                               #148.3[spill]
        movq      280(%rsp), %r11                               #148.3[spill]
                                # LOE rax rcx rbx rsi r8 r9 r10 r11 r12 r13 r14 r15 edx xmm0
..B1.35:                        # Preds ..B1.35 ..B1.34
        ...
        vmovsd    %xmm0, 1600(%r15,%rax,8)                      #164.2
...
..B1.37:                        # Preds ..B1.37 ..B1.36
                                # Execution count [4.75e+01]
        incb      %cl                                           #148.3
        vmovsd    %xmm0, (%rax,%r12)                            #151.1
        vmovsd    %xmm0, 1600(%rax,%r12)                        #152.2
        vmovsd    %xmm0, (%rax,%r13)                            #149.9
        vmovsd    %xmm0, 1600(%rax,%r13)                        #150.9
        vmovsd    %xmm0, 8(%rax,%r12)                           #151.1
        vmovsd    %xmm0, 1608(%rax,%r12)                        #152.2
        vmovsd    %xmm0, 8(%rax,%r13)                           #149.9
        vmovsd    %xmm0, 1608(%rax,%r13)                        #150.9
        addq      $16, %rax                                     #148.3
        cmpb      $50, %cl                                      #148.3
        jb        ..B1.37       # Prob 98%                      #148.3
                                # LOE rax r12 r13 r14 r15 edx cl xmm0
..B1.38:                        # Preds ..B1.37
                                # Execution count [9.49e-01]
        movq      %r15, 440(%rsp)                               #187.3[spill]
        movl      $1, %ebx                                      #187.3
        movq      %r13, 392(%rsp)                               #187.3[spill]
        movq      $0, 320(%rsp)                                 #189.20
        vmovsd    .L_2il0floatpacket.0(%rip), %xmm1             #194.17
        vmovsd    .L_2il0floatpacket.1(%rip), %xmm0             #202.27
        movq      %r14, 368(%rsp)                               #187.3[spill]
        movq      %r12, 400(%rsp)                               #187.3[spill]
        movl      %edx, %r12d                                   #187.3
        movq      264(%rsp), %r13                               #187.3[spill]
        movq      272(%rsp), %r15                               #187.3[spill]
                                # LOE r13 r15 ebx r12d
..B1.39:                        # Preds ..B1.54 ..B1.38
                                # Execution count [5.27e+00]
        movl      $1, %edi                                      #194.17
        lea       232(%rsp), %rsi                               #194.17
        movq      88(%rsi), %r14                                #192.12
        vzeroupper                                              #194.17
...
..B1.41:                        # Preds ..B1.40
                                # Execution count [5.27e+00]
        xorl      %eax, %eax                                    #197.5
        testl     %ebx, %ebx                                    #197.22
        jle       ..B1.51       # Prob 10%                      #197.22
                                # LOE r13 r14 r15 eax ebx r12d
..B1.42:                        # Preds ..B1.41
                                # Execution count [4.75e+00]
        movl      %ebx, 384(%rsp)                               #[spill]
        movl      %r12d, 304(%rsp)                              #[spill]
        movq      %r14, 312(%rsp)                               #[spill]
...
..B1.44:                        # Preds ..B1.42 ..B1.49
        ...
        movq      440(%rsp), %rcx                               #201.11[spill]
        xorl      %edx, %edx                                    #201.11
        movq      432(%rsp), %rbx                               #201.11[spill]
        movq      424(%rsp), %rsi                               #201.11[spill]
        movq      416(%rsp), %r9                                #201.11[spill]
        movq      408(%rsp), %r10                               #201.11[spill]
        movq      400(%rsp), %r12                               #201.11[spill]
        movq      392(%rsp), %r14                               #201.11[spill]
                                # LOE rdx rcx rbx rsi rdi r8 r9 r10 r11 r12 r13 r14 r15 eax xmm0
..B1.45:                        # Preds ..B1.45 ..B1.44
                                # Execution count [2.58e+03]
        vmovsd    800(%r14,%rdx,8), %xmm1                       #203.19
        vmovsd    800(%r12,%rdx,8), %xmm6                       #206.25
        vmovsd    800(%r8,%rdx,8), %xmm11                       #207.25
        vmovsd    800(%r10,%rdx,8), %xmm16                      #208.25
        vmovsd    800(%r9,%rdx,8), %xmm21                       #209.25
        vmovsd    800(%rsi,%rdx,8), %xmm26                      #210.25
        vmovsd    800(%rbx,%rdx,8), %xmm31                      #211.25
        vaddsd    1608(%r14,%rdx,8), %xmm1, %xmm2               #203.33
        vaddsd    1608(%r12,%rdx,8), %xmm6, %xmm7               #206.42
        vaddsd    1608(%r8,%rdx,8), %xmm11, %xmm12              #207.42
        vaddsd    1608(%r10,%rdx,8), %xmm16, %xmm17             #208.42
        vaddsd    1608(%r9,%rdx,8), %xmm21, %xmm22              #209.42
        vaddsd    816(%r14,%rdx,8), %xmm2, %xmm3                #204.19
        vaddsd    816(%r12,%rdx,8), %xmm7, %xmm8                #206.59
        vaddsd    816(%r8,%rdx,8), %xmm12, %xmm13               #207.59
        vaddsd    1608(%rsi,%rdx,8), %xmm26, %xmm27             #210.42
        vaddsd    1608(%rbx,%rdx,8), %xmm31, %xmm1              #211.42
        vaddsd    8(%r14,%rdx,8), %xmm3, %xmm4                  #204.33
        vaddsd    8(%r12,%rdx,8), %xmm8, %xmm9                  #206.76
        vaddsd    8(%r8,%rdx,8), %xmm13, %xmm14                 #207.76
        vaddsd    816(%r10,%rdx,8), %xmm17, %xmm18              #208.59
        vaddsd    816(%r9,%rdx,8), %xmm22, %xmm23               #209.59
        vmulsd    %xmm4, %xmm0, %xmm5                           #204.33
        vaddsd    816(%rsi,%rdx,8), %xmm27, %xmm28              #210.59
        vaddsd    816(%rbx,%rdx,8), %xmm1, %xmm2                #211.59
        vmulsd    %xmm9, %xmm0, %xmm10                          #206.76
        vaddsd    8(%r10,%rdx,8), %xmm18, %xmm19                #208.76
        vmulsd    %xmm14, %xmm0, %xmm15                         #207.76
        vaddsd    8(%r9,%rdx,8), %xmm23, %xmm24                 #209.76
        vaddsd    8(%rsi,%rdx,8), %xmm28, %xmm29                #210.76
        vaddsd    8(%rbx,%rdx,8), %xmm2, %xmm3                  #211.76
        vmulsd    %xmm19, %xmm0, %xmm20                         #208.76
        vmulsd    %xmm24, %xmm0, %xmm25                         #209.76
        vmulsd    %xmm29, %xmm0, %xmm30                         #210.76
        vmulsd    %xmm3, %xmm0, %xmm4                           #211.76
        vmovsd    %xmm5, 808(%r14,%rdx,8)                       #202.15
        vmovsd    %xmm10, 808(%r12,%rdx,8)                      #206.1
        vmovsd    %xmm15, 808(%r8,%rdx,8)                       #207.1
        vmovsd    800(%rcx,%rdx,8), %xmm5                       #212.25
        vmovsd    800(%rdi,%rdx,8), %xmm10                      #213.25
        vmovsd    800(%r11,%rdx,8), %xmm15                      #214.24
        vmovsd    %xmm20, 808(%r10,%rdx,8)                      #208.1
        vmovsd    %xmm25, 808(%r9,%rdx,8)                       #209.1
        vmovsd    %xmm30, 808(%rsi,%rdx,8)                      #210.1
        vmovsd    %xmm4, 808(%rbx,%rdx,8)                       #211.1
        vaddsd    1608(%rcx,%rdx,8), %xmm5, %xmm6               #212.42
        vaddsd    1608(%rdi,%rdx,8), %xmm10, %xmm11             #213.42
        vaddsd    1608(%r11,%rdx,8), %xmm15, %xmm16             #214.40
        vaddsd    816(%rcx,%rdx,8), %xmm6, %xmm7                #212.59
        vaddsd    816(%rdi,%rdx,8), %xmm11, %xmm12              #213.59
        vaddsd    816(%r11,%rdx,8), %xmm16, %xmm17              #214.56
        vaddsd    8(%rcx,%rdx,8), %xmm7, %xmm8                  #212.76
        vaddsd    8(%rdi,%rdx,8), %xmm12, %xmm13                #213.76
        vaddsd    8(%r11,%rdx,8), %xmm17, %xmm18                #214.72
        vmulsd    %xmm8, %xmm0, %xmm9                           #212.76
        vmulsd    %xmm13, %xmm0, %xmm14                         #213.76
        vmulsd    %xmm18, %xmm0, %xmm19                         #214.72
        vmovsd    %xmm9, 808(%rcx,%rdx,8)                       #212.1
        vmovsd    %xmm14, 808(%rdi,%rdx,8)                      #213.1
        vmovsd    %xmm19, 808(%r11,%rdx,8)                      #214.1
        incq      %rdx                                          #201.11
        cmpq      $98, %rdx                                     #201.11
        jb        ..B1.45       # Prob 98%                      #201.11
                                # LOE rdx rcx rbx rsi rdi r8 r9 r10 r11 r12 r13 r14 r15 eax xmm0
..B1.46:                        # Preds ..B1.45
                                # Execution count [2.64e+01]
        movq      376(%rsp), %r10                               #[spill]
...
..B1.48:                        # Preds ..B1.48 ..B1.47
                                # Execution count [2.58e+03]
        vmovsd    800(%rsi,%rdx,8), %xmm1                       #215.24
        vmovsd    800(%rbx,%rdx,8), %xmm6                       #216.24
        vmovsd    800(%rcx,%rdx,8), %xmm11                      #217.24
        vmovsd    800(%r9,%rdx,8), %xmm16                       #218.24
        vmovsd    800(%r12,%rdx,8), %xmm21                      #219.24
        vmovsd    800(%r10,%rdx,8), %xmm26                      #220.24
        vmovsd    800(%r15,%rdx,8), %xmm31                      #221.24
        vaddsd    1608(%rsi,%rdx,8), %xmm1, %xmm2               #215.40
        vaddsd    1608(%rbx,%rdx,8), %xmm6, %xmm7               #216.40
        vaddsd    1608(%rcx,%rdx,8), %xmm11, %xmm12             #217.40
        vaddsd    1608(%r9,%rdx,8), %xmm16, %xmm17              #218.40
        vaddsd    1608(%r12,%rdx,8), %xmm21, %xmm22             #219.40
        vaddsd    816(%rsi,%rdx,8), %xmm2, %xmm3                #215.56
        vaddsd    1608(%r10,%rdx,8), %xmm26, %xmm27             #220.40
        vaddsd    1608(%r15,%rdx,8), %xmm31, %xmm1              #221.40
        vaddsd    816(%rbx,%rdx,8), %xmm7, %xmm8                #216.56
        vaddsd    816(%rcx,%rdx,8), %xmm12, %xmm13              #217.56
        vaddsd    8(%rsi,%rdx,8), %xmm3, %xmm4                  #215.72
        vaddsd    816(%r9,%rdx,8), %xmm17, %xmm18               #218.56
        vaddsd    816(%r12,%rdx,8), %xmm22, %xmm23              #219.56
        vaddsd    816(%r10,%rdx,8), %xmm27, %xmm28              #220.56
        vaddsd    816(%r15,%rdx,8), %xmm1, %xmm2                #221.56
        vmulsd    %xmm4, %xmm0, %xmm5                           #215.72
        vaddsd    8(%rbx,%rdx,8), %xmm8, %xmm9                  #216.72
        vaddsd    8(%rcx,%rdx,8), %xmm13, %xmm14                #217.72
        vaddsd    8(%r9,%rdx,8), %xmm18, %xmm19                 #218.72
        vaddsd    8(%r12,%rdx,8), %xmm23, %xmm24                #219.72
        vaddsd    8(%r10,%rdx,8), %xmm28, %xmm29                #220.72
        vmulsd    %xmm9, %xmm0, %xmm10                          #216.72
        vaddsd    8(%r15,%rdx,8), %xmm2, %xmm3                  #221.72
        vmulsd    %xmm14, %xmm0, %xmm15                         #217.72
        vmulsd    %xmm19, %xmm0, %xmm20                         #218.72
        vmulsd    %xmm24, %xmm0, %xmm25                         #219.72
        vmulsd    %xmm29, %xmm0, %xmm30                         #220.72
        vmulsd    %xmm3, %xmm0, %xmm4                           #221.72
        vmovsd    %xmm5, 808(%rsi,%rdx,8)                       #215.1
        vmovsd    800(%r13,%rdx,8), %xmm5                       #222.24
        vmovsd    %xmm10, 808(%rbx,%rdx,8)                      #216.1
        vmovsd    %xmm15, 808(%rcx,%rdx,8)                      #217.1
        vmovsd    %xmm20, 808(%r9,%rdx,8)                       #218.1
        vmovsd    %xmm25, 808(%r12,%rdx,8)                      #219.1
        vmovsd    %xmm30, 808(%r10,%rdx,8)                      #220.1
        vmovsd    %xmm4, 808(%r15,%rdx,8)                       #221.1
        vaddsd    1608(%r13,%rdx,8), %xmm5, %xmm6               #222.40
        vaddsd    816(%r13,%rdx,8), %xmm6, %xmm7                #222.56
        vaddsd    8(%r13,%rdx,8), %xmm7, %xmm8                  #222.72
        vmulsd    %xmm8, %xmm0, %xmm9                           #222.72
        vmovsd    %xmm9, 808(%r13,%rdx,8)                       #222.1
        incq      %rdx                                          #201.11
        cmpq      $98, %rdx                                     #201.11
        jb        ..B1.48       # Prob 98%                      #201.11
                                # LOE rdx rcx rbx rsi rdi r8 r9 r10 r11 r12 r13 r15 eax xmm0
..B1.49:                        # Preds ..B1.48
                                # Execution count [2.64e+01]
        movq      392(%rsp), %r14                               #224.18[spill]
        incl      %eax                                          #197.5
        movq      1592(%r14), %rdx                              #224.18
        movq      %rdx, 1600(%r14)                              #224.4
        movq      400(%rsp), %r14                               #225.18[spill]
        movq      1592(%r14), %rdx                              #225.18
        movq      %rdx, 1600(%r14)                              #225.1
        movq      1592(%r8), %rdx                               #226.18
        movq      %rdx, 1600(%r8)                               #226.1
        movq      408(%rsp), %rdx                               #227.18[spill]
        movq      1592(%rdx), %r14                              #227.18
        movq      %r14, 1600(%rdx)                              #227.1
        movq      416(%rsp), %rdx                               #228.18[spill]
        movq      1592(%rdx), %r14                              #228.18
        movq      %r14, 1600(%rdx)                              #228.1
        movq      424(%rsp), %rdx                               #229.18[spill]
        movq      1592(%rdx), %r14                              #229.18
        movq      %r14, 1600(%rdx)                              #229.1
        movq      432(%rsp), %rdx                               #230.18[spill]
        movq      1592(%rdx), %r14                              #230.18
        movq      %r14, 1600(%rdx)                              #230.1
        movq      440(%rsp), %rdx                               #231.18[spill]
        movq      1592(%rdx), %r14                              #231.18
        movq      %r14, 1600(%rdx)                              #231.1
        movq      1592(%rdi), %r14                              #232.18
        movq      1592(%r11), %rdx                              #233.17
        movq      %r14, 1600(%rdi)                              #232.1
        movq      %rdx, 1600(%r11)                              #233.1
        movq      1592(%rsi), %r14                              #234.17
        movq      1592(%rbx), %rdx                              #235.17
        movq      %r14, 1600(%rsi)                              #234.1
        movq      %rdx, 1600(%rbx)                              #235.1
        movq      1592(%rcx), %r14                              #236.17
        movq      1592(%r9), %rdx                               #237.17
        movq      %r14, 1600(%rcx)                              #236.1
        movq      %rdx, 1600(%r9)                               #237.1
        movq      1592(%r12), %r14                              #238.17
        movq      1592(%r10), %rdx                              #239.17
        movq      %r14, 1600(%r12)                              #238.1
        movq      %rdx, 1600(%r10)                              #239.1
        movq      1592(%r15), %r14                              #240.17
        movq      1592(%r13), %rdx                              #241.17
        movq      %r14, 1600(%r15)                              #240.1
        movq      %rdx, 1600(%r13)                              #241.1
        cmpl      384(%rsp), %eax                               #197.5[spill]
        jb        ..B1.44       # Prob 82%                      #197.5
                                # LOE rcx rbx rsi rdi r8 r9 r10 r11 r12 r13 r15 eax xmm0
..B1.50:                        # Preds ..B1.49
                                # Execution count [4.75e+00]
        movq      312(%rsp), %r14                               #[spill]
        movl      384(%rsp), %ebx                               #[spill]
        movl      304(%rsp), %r12d                              #[spill]
                                # LOE r13 r14 r15 ebx r12d
..B1.51:                        # Preds ..B1.41 ..B1.50
                                # Execution count [5.27e+00]
        movl      %r12d, %edi                                   #245.5
        movl      $9217, %esi                                   #245.5
        xorl      %edx, %edx                                    #245.5
...
..B1.53:                        # Preds ..B1.52
        ...
        vfmadd231sd .L_2il0floatpacket.0(%rip), %xmm0, %xmm1    #246.15
        movl      %r12d, %edi                                   #247.15
        vmovsd    %xmm1, 328(%rsp)                              #246.15[spill]
        movl      $8, %edx                                      #247.15
        lea       320(%rsp), %rsi                               #247.15
...
..B1.54:                        # Preds ..B1.53
                                # Execution count [5.27e+00]
        vmovsd    328(%rsp), %xmm16                             #249.20[spill]
        addl      %ebx, %ebx                                    #248.19
        vmovsd    .L_2il0floatpacket.4(%rip), %xmm0             #249.30
...
..B1.59:                        # Preds ..B1.58
                                # Execution count [2.58e-01]
        movq      280(%rsp), %rdi                               #256.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #256.1
                                # LOE r14 r15
..B1.60:                        # Preds ..B1.59
                                # Execution count [2.58e-01]
        movq      408(%rsp), %rdi                               #257.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #257.1
                                # LOE r14 r15
..B1.61:                        # Preds ..B1.60
...
..B1.62:                        # Preds ..B1.61
                                # Execution count [2.58e-01]
        movq      424(%rsp), %rdi                               #259.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #259.1
                                # LOE r14 r15
..B1.63:                        # Preds ..B1.62
                                # Execution count [2.58e-01]
        movq      432(%rsp), %rdi                               #260.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #260.1
                                # LOE r14 r15
..B1.64:                        # Preds ..B1.63
...
..B1.65:                        # Preds ..B1.64
                                # Execution count [2.58e-01]
        movq      288(%rsp), %rdi                               #262.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #262.1
                                # LOE r14
..B1.66:                        # Preds ..B1.65
                                # Execution count [2.58e-01]
        movq      296(%rsp), %rdi                               #263.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #263.1
                                # LOE r14
..B1.67:                        # Preds ..B1.66
                                # Execution count [2.58e-01]
        movq      336(%rsp), %rdi                               #264.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #264.1
                                # LOE r14
..B1.68:                        # Preds ..B1.67
...
..B1.69:                        # Preds ..B1.68
                                # Execution count [2.58e-01]
        movq      352(%rsp), %rdi                               #266.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #266.1
                                # LOE r14
..B1.70:                        # Preds ..B1.69
                                # Execution count [2.58e-01]
        movq      360(%rsp), %rdi                               #267.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #267.1
                                # LOE r14
..B1.71:                        # Preds ..B1.70
...
..B1.72:                        # Preds ..B1.71
                                # Execution count [2.58e-01]
        movq      376(%rsp), %rdi                               #269.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #269.1
                                # LOE
..B1.73:                        # Preds ..B1.72
                                # Execution count [2.58e-01]
        movq      272(%rsp), %rdi                               #270.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #270.1
                                # LOE
..B1.74:                        # Preds ..B1.73
                                # Execution count [2.58e-01]
        movq      264(%rsp), %rdi                               #271.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #271.1
                                # LOE
..B1.75:                        # Preds ..B1.74
...
..B1.76:                        # Preds ..B1.56
        ...
        sarl      $1, %ebx                                      #251.17
        movl      $3, %eax                                      #282.3
        vcvtsi2sd %ebx, %xmm4, %xmm4                            #279.46
        vmovsd    .L_2il0floatpacket.4(%rip), %xmm3             #279.46
        vdivsd    %xmm4, %xmm3, %xmm8                           #279.46
        movq      320(%rsp), %rcx                               #279.33
        subq      312(%rsp), %rcx                               #279.33[spill]
        vcvtsi2sdq %rcx, %xmm6, %xmm6                           #279.40
        vmovsd    224(%rsp), %xmm2                              #280.72[spill]
        vmulsd    .L_2il0floatpacket.3(%rip), %xmm2, %xmm5      #280.72
        vmulsd    .L_2il0floatpacket.2(%rip), %xmm6, %xmm7      #279.52
...
..B1.85:                        # Preds ..B1.84
                                # Execution count [3.82e-01]
        movq      288(%rsp), %rdi                               #291.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #291.1
                                # LOE r14
..B1.86:                        # Preds ..B1.85
                                # Execution count [3.82e-01]
        movq      296(%rsp), %rdi                               #292.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #292.1
                                # LOE r14
..B1.87:                        # Preds ..B1.86
                                # Execution count [3.82e-01]
        movq      336(%rsp), %rdi                               #293.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #293.1
                                # LOE r14
..B1.88:                        # Preds ..B1.87
                                # Execution count [3.82e-01]
        movq      344(%rsp), %rdi                               #294.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #294.1
                                # LOE r14
..B1.89:                        # Preds ..B1.88
...
..B1.92:                        # Preds ..B1.91
                                # Execution count [3.82e-01]
        movq      376(%rsp), %rdi                               #298.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #298.1
                                # LOE
..B1.93:                        # Preds ..B1.92
                                # Execution count [3.82e-01]
        movq      272(%rsp), %rdi                               #299.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #299.1
                                # LOE
..B1.94:                        # Preds ..B1.93
...
..B1.101:                       # Preds ..B1.99 ..B1.100
                                # Execution count [5.10e-02]: Infreq
        cmpq      $0, 280(%rsp)                                 #70.10[spill]
        je        ..B1.103      # Prob 32%                      #70.10
                                # LOE r14 r15
..B1.102:                       # Preds ..B1.101
                                # Execution count [3.44e-02]: Infreq
        movq      280(%rsp), %rdi                               #70.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #70.1
                                # LOE r14 r15
...
..B1.113:                       # Preds ..B1.111 ..B1.112
                                # Execution count [5.10e-02]: Infreq
        cmpq      $0, 288(%rsp)                                 #76.10[spill]
        je        ..B1.115      # Prob 32%                      #76.10
                                # LOE r14
..B1.114:                       # Preds ..B1.113
                                # Execution count [3.44e-02]: Infreq
        movq      288(%rsp), %rdi                               #76.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #76.1
                                # LOE r14
..B1.115:                       # Preds ..B1.113 ..B1.114
                                # Execution count [5.10e-02]: Infreq
        cmpq      $0, 296(%rsp)                                 #77.10[spill]
        je        ..B1.117      # Prob 32%                      #77.10
                                # LOE r14
..B1.116:                       # Preds ..B1.115
                                # Execution count [3.44e-02]: Infreq
        movq      296(%rsp), %rdi                               #77.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #77.1
                                # LOE r14
...
..B1.121:                       # Preds ..B1.119 ..B1.120
                                # Execution count [5.10e-02]: Infreq
        cmpq      $0, 352(%rsp)                                 #80.10[spill]
        je        ..B1.123      # Prob 32%                      #80.10
                                # LOE r14
..B1.122:                       # Preds ..B1.121
                                # Execution count [3.44e-02]: Infreq
        movq      352(%rsp), %rdi                               #80.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #80.1
                                # LOE r14
...
..B1.129:                       # Preds ..B1.127 ..B1.128
                                # Execution count [5.10e-02]: Infreq
        cmpq      $0, 272(%rsp)                                 #84.10[spill]
        je        ..B1.131      # Prob 32%                      #84.10
                                # LOE
..B1.130:                       # Preds ..B1.129
                                # Execution count [3.44e-02]: Infreq
        movq      272(%rsp), %rdi                               #84.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #84.1
                                # LOE
..B1.131:                       # Preds ..B1.129 ..B1.130
                                # Execution count [5.10e-02]: Infreq
        cmpq      $0, 264(%rsp)                                 #85.10[spill]
        je        ..B1.133      # Prob 32%                      #85.10
                                # LOE
..B1.132:                       # Preds ..B1.131
                                # Execution count [3.44e-02]: Infreq
        movq      264(%rsp), %rdi                               #85.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #85.1
                                # LOE
...
..B2.1:                         # Preds ..B2.0
	...
	.cfi_startproc
	.cfi_personality 0x3,__gxx_personality_v0
..___tag_value__Z12getTimeStampv.320:
..L321:
                                                        #4.1
        subq      $24, %rsp                                     #4.1
	.cfi_def_cfa_offset 32
        movl      $1, %edi                                      #6.3
        lea       (%rsp), %rsi                                  #6.3
..___tag_value__Z12getTimeStampv.323:
#       clock_gettime(clockid_t, timespec *)
...
..B3.1:                         # Preds ..B3.0
	...
	.cfi_startproc
	.cfi_personality 0x3,__gxx_personality_v0
..___tag_value__Z17getTimeResolutionv.327:
..L328:
                                                        #11.1
        subq      $24, %rsp                                     #11.1
	.cfi_def_cfa_offset 32
        movl      $1, %edi                                      #13.3
        lea       (%rsp), %rsi                                  #13.3
..___tag_value__Z17getTimeResolutionv.330:
...
..L335:
	...
	.cfi_def_cfa_offset 32
        movl      $1, %edi                                      #19.10
        lea       (%rsp), %rsi                                  #19.10
..___tag_value__Z13getTimeStamp_v.337:
#       clock_gettime(clockid_t, timespec *)
