...
..B1.19:                        # Preds ..B1.18
        ...
        movq      %r12, 288(%rsp)                               #70.3[spill]
                                # LOE rax rbx r14 cl ymm0
..B1.20:                        # Preds ..B1.22 ..B1.19
                                # Execution count [2.85e+00]
        movq      280(%rsp), %r13                               #72.7[spill]
        xorl      %r15d, %r15d                                  #71.5
        movq      288(%rsp), %r12                               #73.1[spill]
        lea       (%r14,%rax), %r8                              #78.1
        movq      296(%rsp), %r11                               #74.1[spill]
        movq      304(%rsp), %r10                               #75.1[spill]
        addq      %rax, %r13                                    #72.7
        movq      312(%rsp), %r9                                #76.1[spill]
        addq      %rax, %r12                                    #73.1
        movq      320(%rsp), %rdx                               #77.1[spill]
        addq      %rax, %r11                                    #74.1
        movq      272(%rsp), %rdi                               #80.1[spill]
        addq      %rax, %r10                                    #75.1
        addq      %rax, %r9                                     #76.1
        lea       (%rdx,%rax), %rsi                             #77.1
        lea       (%rbx,%rax), %rdx                             #79.1
        addq      %rax, %rdi                                    #80.1
        .align    16,0x90
                                # LOE rax rdx rbx rsi rdi r8 r9 r10 r11 r12 r13 r14 r15 cl ymm0
..B1.21:                        # Preds ..B1.21 ..B1.20
                                # Execution count [2.85e+02]
        vmovupd   %ymm0, (%r13,%r15,8)                          #72.7
        vmovupd   %ymm0, (%r12,%r15,8)                          #73.1
        vmovupd   %ymm0, (%r11,%r15,8)                          #74.1
        vmovupd   %ymm0, (%r10,%r15,8)                          #75.1
        vmovupd   %ymm0, (%r9,%r15,8)                           #76.1
        vmovupd   %ymm0, (%rsi,%r15,8)                          #77.1
...
..B1.23:                        # Preds ..B1.22
                                # Execution count [9.49e-01]
        movq      320(%rsp), %r9                                #95.2[spill]
        xorl      %eax, %eax                                    #103.3
        movq      280(%rsp), %rcx                               #85.9[spill]
        movq      304(%rsp), %rsi                               #91.2[spill]
        movq      312(%rsp), %r8                                #93.2[spill]
        movq      272(%rsp), %r10                               #101.2[spill]
        vmovsd    .L_2il0floatpacket.4(%rip), %xmm0             #85.9
        movq      296(%rsp), %r13                               #[spill]
        movq      288(%rsp), %r12                               #[spill]
        vmovsd    %xmm0, (%r9)                                  #95.2
        vmovsd    %xmm0, 792(%r9)                               #94.1
        vmovsd    %xmm0, 800(%r9)                               #95.2
        vmovsd    %xmm0, 1592(%r9)                              #94.1
        vmovsd    %xmm0, 1600(%r9)                              #95.2
        vmovsd    %xmm0, 2392(%r9)                              #94.1
        movl      224(%rsp), %edx                               #[spill]
        vmovsd    %xmm0, (%rcx)                                 #85.9
        vmovsd    %xmm0, 792(%rcx)                              #84.9
        vmovsd    %xmm0, (%r12)                                 #87.2
        vmovsd    %xmm0, 792(%r12)                              #86.1
        vmovsd    %xmm0, (%r13)                                 #89.2
        vmovsd    %xmm0, 792(%r13)                              #88.1
        vmovsd    %xmm0, (%rsi)                                 #91.2
        vmovsd    %xmm0, 792(%rsi)                              #90.1
        vmovsd    %xmm0, (%r8)                                  #93.2
        vmovsd    %xmm0, 792(%r8)                               #92.1
        vmovsd    %xmm0, (%r14)                                 #97.2
        vmovsd    %xmm0, 792(%r14)                              #96.1
        vmovsd    %xmm0, (%rbx)                                 #99.2
        vmovsd    %xmm0, 800(%rcx)                              #85.9
        vmovsd    %xmm0, 1592(%rcx)                             #84.9
        vmovsd    %xmm0, 800(%r12)                              #87.2
        vmovsd    %xmm0, 1592(%r12)                             #86.1
        vmovsd    %xmm0, 800(%r13)                              #89.2
        vmovsd    %xmm0, 1592(%r13)                             #88.1
        vmovsd    %xmm0, 800(%rsi)                              #91.2
        vmovsd    %xmm0, 1592(%rsi)                             #90.1
        vmovsd    %xmm0, 800(%r8)                               #93.2
        vmovsd    %xmm0, 1592(%r8)                              #92.1
        vmovsd    %xmm0, 800(%r14)                              #97.2
        vmovsd    %xmm0, 1592(%r14)                             #96.1
        vmovsd    %xmm0, 800(%rbx)                              #99.2
        vmovsd    %xmm0, 1600(%rcx)                             #85.9
        vmovsd    %xmm0, 2392(%rcx)                             #84.9
        movq      %r10, %rcx                                    #103.3
        vmovsd    %xmm0, 1600(%r12)                             #87.2
        vmovsd    %xmm0, 2392(%r12)                             #86.1
        vmovsd    %xmm0, 1600(%r13)                             #89.2
        vmovsd    %xmm0, 2392(%r13)                             #88.1
        vmovsd    %xmm0, 1600(%rsi)                             #91.2
        vmovsd    %xmm0, 2392(%rsi)                             #90.1
        movq      %r9, %rsi                                     #103.3
        vmovsd    %xmm0, 1600(%r8)                              #93.2
        vmovsd    %xmm0, 2392(%r8)                              #92.1
        vmovsd    %xmm0, 1600(%r14)                             #97.2
        vmovsd    %xmm0, 2392(%r14)                             #96.1
        vmovsd    %xmm0, 1600(%rbx)                             #99.2
        vmovsd    %xmm0, 792(%rbx)                              #98.1
        vmovsd    %xmm0, (%r10)                                 #101.2
        vmovsd    %xmm0, 792(%r10)                              #100.1
        vmovsd    %xmm0, 1592(%rbx)                             #98.1
        vmovsd    %xmm0, 800(%r10)                              #101.2
        vmovsd    %xmm0, 1592(%r10)                             #100.1
        vmovsd    %xmm0, 2392(%rbx)                             #98.1
        vmovsd    %xmm0, 1600(%r10)                             #101.2
        vmovsd    %xmm0, 2392(%r10)                             #100.1
        movq      304(%rsp), %r9                                #103.3[spill]
...
..B1.24:                        # Preds ..B1.24 ..B1.23
        ...
        vmovsd    %xmm0, 1600(%rbx,%rax,8)                      #119.2
        vmovsd    %xmm0, (%r14,%rax,8)                          #116.1
        vmovsd    %xmm0, 1600(%r14,%rax,8)                      #117.2
        vmovsd    %xmm0, (%rsi,%rax,8)                          #114.1
        vmovsd    %xmm0, 1600(%rsi,%rax,8)                      #115.2
        vmovsd    %xmm0, (%r8,%rax,8)                           #112.1
        vmovsd    %xmm0, 1600(%r8,%rax,8)                       #113.2
        vmovsd    %xmm0, (%r9,%rax,8)                           #110.1
        vmovsd    %xmm0, 1600(%r9,%rax,8)                       #111.2
        vmovsd    %xmm0, (%r13,%rax,8)                          #108.1
        vmovsd    %xmm0, 1600(%r13,%rax,8)                      #109.2
        vmovsd    %xmm0, (%r12,%rax,8)                          #106.1
        vmovsd    %xmm0, 1600(%r12,%rax,8)                      #107.2
        incq      %rax                                          #103.3
        cmpq      $100, %rax                                    #103.3
...
..B1.26:                        # Preds ..B1.26 ..B1.25
        ...
        vmovsd    %xmm0, 1600(%rax,%rsi)                        #105.9
        vmovsd    %xmm0, 8(%rax,%rsi)                           #104.9
        vmovsd    %xmm0, 1608(%rax,%rsi)                        #105.9
        addq      $16, %rax                                     #103.3
        cmpb      $50, %cl                                      #103.3
...
..B1.27:                        # Preds ..B1.26
        ...
        movq      %r14, 328(%rsp)                               #124.3[spill]
        movq      %rbx, %r14                                    #124.3
        movq      %r12, 288(%rsp)                               #124.3[spill]
        movl      %edx, %ebx                                    #124.3
        movq      272(%rsp), %r13                               #124.3[spill]
                                # LOE r13 r14 ebx r15d
..B1.28:                        # Preds ..B1.40 ..B1.27
                                # Execution count [5.27e+00]
        movl      $1, %edi                                      #131.17
        lea       240(%rsp), %rsi                               #131.17
        movq      96(%rsi), %r12                                #129.12
        vzeroupper                                              #131.17
...
..B1.31:                        # Preds ..B1.30
        ...
        movq      328(%rsp), %r8                                #[spill]
        movq      320(%rsp), %r9                                #[spill]
        movq      312(%rsp), %r10                               #[spill]
        movq      304(%rsp), %r11                               #[spill]
        movq      296(%rsp), %rax                               #[spill]
        movq      288(%rsp), %rdx                               #[spill]
        movq      280(%rsp), %rdi                               #[spill]
                                # LOE rax rdx rdi r8 r9 r10 r11 r12 r13 r14 ecx ebx r15d xmm0
..B1.33:                        # Preds ..B1.31 ..B1.35
                                # Execution count [2.64e+01]
        movl      $1, %esi                                      #138.21
                                # LOE rax rdx rsi rdi r8 r9 r10 r11 r12 r13 r14 ecx ebx r15d xmm0
..B1.34:                        # Preds ..B1.34 ..B1.33
                                # Execution count [2.58e+03]
        vmovsd    792(%rdi,%rsi,8), %xmm1                       #140.19
        vmovsd    792(%rdx,%rsi,8), %xmm6                       #143.24
        vmovsd    792(%rax,%rsi,8), %xmm11                      #144.24
        vmovsd    792(%r11,%rsi,8), %xmm16                      #145.24
        vmovsd    792(%r10,%rsi,8), %xmm21                      #146.24
        vmovsd    792(%r9,%rsi,8), %xmm26                       #147.24
        vmovsd    792(%r8,%rsi,8), %xmm31                       #148.24
        vaddsd    1600(%rdi,%rsi,8), %xmm1, %xmm2               #140.33
        vaddsd    1600(%rdx,%rsi,8), %xmm6, %xmm7               #143.40
        vaddsd    1600(%rax,%rsi,8), %xmm11, %xmm12             #144.40
        vaddsd    1600(%r11,%rsi,8), %xmm16, %xmm17             #145.40
        vaddsd    1600(%r10,%rsi,8), %xmm21, %xmm22             #146.40
        vaddsd    808(%rdi,%rsi,8), %xmm2, %xmm3                #141.19
        vaddsd    808(%rdx,%rsi,8), %xmm7, %xmm8                #143.56
        vaddsd    1600(%r9,%rsi,8), %xmm26, %xmm27              #147.40
        vaddsd    1600(%r8,%rsi,8), %xmm31, %xmm1               #148.40
        vaddsd    808(%rax,%rsi,8), %xmm12, %xmm13              #144.56
        vaddsd    (%rdi,%rsi,8), %xmm3, %xmm4                   #141.33
        vaddsd    (%rdx,%rsi,8), %xmm8, %xmm9                   #143.72
        vaddsd    808(%r11,%rsi,8), %xmm17, %xmm18              #145.56
        vaddsd    808(%r10,%rsi,8), %xmm22, %xmm23              #146.56
        vaddsd    808(%r9,%rsi,8), %xmm27, %xmm28               #147.56
        vmulsd    %xmm4, %xmm0, %xmm5                           #141.33
        vaddsd    808(%r8,%rsi,8), %xmm1, %xmm2                 #148.56
        vaddsd    (%rax,%rsi,8), %xmm13, %xmm14                 #144.72
        vmulsd    %xmm9, %xmm0, %xmm10                          #143.72
        vaddsd    (%r11,%rsi,8), %xmm18, %xmm19                 #145.72
        vaddsd    (%r10,%rsi,8), %xmm23, %xmm24                 #146.72
        vaddsd    (%r9,%rsi,8), %xmm28, %xmm29                  #147.72
        vaddsd    (%r8,%rsi,8), %xmm2, %xmm3                    #148.72
        ...
        vmovsd    %xmm5, 800(%rdi,%rsi,8)                       #139.15
        vmovsd    %xmm10, 800(%rdx,%rsi,8)                      #143.1
        vmovsd    792(%r14,%rsi,8), %xmm5                       #149.24
        vmovsd    792(%r13,%rsi,8), %xmm10                      #150.24
        vmovsd    %xmm15, 800(%rax,%rsi,8)                      #144.1
        vmovsd    %xmm20, 800(%r11,%rsi,8)                      #145.1
        vmovsd    %xmm25, 800(%r10,%rsi,8)                      #146.1
        vmovsd    %xmm30, 800(%r9,%rsi,8)                       #147.1
        vmovsd    %xmm4, 800(%r8,%rsi,8)                        #148.1
        vaddsd    1600(%r14,%rsi,8), %xmm5, %xmm6               #149.40
        vaddsd    1600(%r13,%rsi,8), %xmm10, %xmm11             #150.40
        vaddsd    808(%r14,%rsi,8), %xmm6, %xmm7                #149.56
        vaddsd    808(%r13,%rsi,8), %xmm11, %xmm12              #150.56
        vaddsd    (%r14,%rsi,8), %xmm7, %xmm8                   #149.72
        vaddsd    (%r13,%rsi,8), %xmm12, %xmm13                 #150.72
        vmulsd    %xmm8, %xmm0, %xmm9                           #149.72
        vmulsd    %xmm13, %xmm0, %xmm14                         #150.72
        vmovsd    %xmm9, 800(%r14,%rsi,8)                       #149.1
        vmovsd    %xmm14, 800(%r13,%rsi,8)                      #150.1
        incq      %rsi                                          #138.35
        cmpq      $99, %rsi                                     #138.27
...
..B1.38:                        # Preds ..B1.37
                                # Execution count [5.27e+00]
        movl      $1, %edi                                      #157.15
        lea       256(%rsp), %rsi                               #157.15
..___tag_value_main.84:
#       clock_gettime(clockid_t, timespec *)
        call      clock_gettime                                 #157.15
..___tag_value_main.85:
                                # LOE r12 r13 r14 ebx r15d
..B1.39:                        # Preds ..B1.38
                                # Execution count [5.27e+00]
        vxorpd    %xmm0, %xmm0, %xmm0                           #157.15
        vxorpd    %xmm1, %xmm1, %xmm1                           #157.15
        vcvtsi2sdq 264(%rsp), %xmm0, %xmm0                      #157.15
        vcvtsi2sdq 256(%rsp), %xmm1, %xmm1                      #157.15
        vfmadd231sd .L_2il0floatpacket.0(%rip), %xmm0, %xmm1    #157.15
        movl      %ebx, %edi                                    #158.15
        vmovsd    %xmm1, 232(%rsp)                              #157.15[spill]
        movl      $8, %edx                                      #158.15
        lea       336(%rsp), %rsi                               #158.15
...
..B1.40:                        # Preds ..B1.39
                                # Execution count [5.27e+00]
        vmovsd    232(%rsp), %xmm16                             #160.20[spill]
        addl      %r15d, %r15d                                  #159.19
        vmovsd    .L_2il0floatpacket.4(%rip), %xmm0             #160.30
        vsubsd    224(%rsp), %xmm16, %xmm1                      #160.20[spill]
        vcomisd   %xmm1, %xmm0                                  #160.30
        ja        ..B1.28       # Prob 82%                      #160.30
                                # LOE r12 r13 r14 ebx r15d xmm1
..B1.41:                        # Preds ..B1.40
                                # Execution count [9.49e-01]
        movl      %ebx, %edx                                    #
        lea       336(%rsp), %rsi                               #163.13
        movl      %edx, %edi                                    #163.13
        movl      $8, %edx                                      #163.13
        vmovsd    %xmm1, -104(%rsi)                             #[spill]
        movq      %r14, %rbx                                    #
        movq      %r12, -112(%rsi)                              #[spill]
...
..B1.42:                        # Preds ..B1.41
                                # Execution count [9.49e-01]
        testl     %eax, %eax                                    #164.13
        jge       ..B1.53       # Prob 59%                      #164.13
                                # LOE rbx r12 r13 r14 r15d
..B1.43:                        # Preds ..B1.42
                                # Execution count [2.58e-01]
        movq      280(%rsp), %rdi                               #165.2[spill]
...
..B1.46:                        # Preds ..B1.45
                                # Execution count [2.58e-01]
        movq      304(%rsp), %rdi                               #168.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #168.1
                                # LOE rbx r14
..B1.47:                        # Preds ..B1.46
                                # Execution count [2.58e-01]
        movq      312(%rsp), %rdi                               #169.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #169.1
                                # LOE rbx r14
..B1.48:                        # Preds ..B1.47
                                # Execution count [2.58e-01]
        movq      320(%rsp), %rdi                               #170.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #170.1
                                # LOE rbx r14
..B1.49:                        # Preds ..B1.48
...
..B1.53:                        # Preds ..B1.42
        ...
        movl      %r15d, %edx                                   #181.55
        vxorpd    %xmm4, %xmm4, %xmm4                           #181.46
        shrl      $31, %edx                                     #181.55
        vxorpd    %xmm6, %xmm6, %xmm6                           #181.40
        addl      %edx, %r15d                                   #162.17
        movl      $.L_2__STRING.4, %edi                         #184.3
        sarl      $1, %r15d                                     #162.17
        movl      $3, %eax                                      #184.3
        vcvtsi2sd %r15d, %xmm4, %xmm4                           #181.46
        vmovsd    .L_2il0floatpacket.4(%rip), %xmm3             #181.46
        vdivsd    %xmm4, %xmm3, %xmm8                           #181.46
        movq      336(%rsp), %rcx                               #181.33
        subq      224(%rsp), %rcx                               #181.33[spill]
        vcvtsi2sdq %rcx, %xmm6, %xmm6                           #181.40
        vmovsd    232(%rsp), %xmm2                              #182.72[spill]
        vmulsd    .L_2il0floatpacket.3(%rip), %xmm2, %xmm5      #182.72
        vmulsd    .L_2il0floatpacket.2(%rip), %xmm6, %xmm7      #181.52
        vmulsd    %xmm8, %xmm5, %xmm1                           #182.75
        vmulsd    %xmm8, %xmm7, %xmm0                           #181.55
        vdivsd    %xmm0, %xmm1, %xmm2                           #184.3
...
..B1.57:                        # Preds ..B1.56
                                # Execution count [3.82e-01]
        movq      304(%rsp), %rdi                               #188.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #188.1
                                # LOE rbx r14
..B1.58:                        # Preds ..B1.57
                                # Execution count [3.82e-01]
        movq      312(%rsp), %rdi                               #189.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #189.1
                                # LOE rbx r14
..B1.59:                        # Preds ..B1.58
                                # Execution count [3.82e-01]
        movq      320(%rsp), %rdi                               #190.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #190.1
                                # LOE rbx r14
..B1.60:                        # Preds ..B1.59
