...
..B1.56:                        # Preds ..B1.10
                                # Execution count [1.00e+00]
        movq      %rax, 32(%rsp)                                #40.12[spill]
                                # LOE rbx r13 r14 r15
..B1.11:                        # Preds ..B1.56
                                # Execution count [1.00e+00]
        movq      %r14, 8(%rsp)                                 #44.3[spill]
        xorb      %dl, %dl                                      #44.3
        vxorpd    %ymm0, %ymm0, %ymm0                           #46.19
        xorl      %eax, %eax                                    #44.3
        movq      %rbx, 56(%rsp)                                #44.3[spill]
        movq      %r15, (%rsp)                                  #44.3[spill]
                                # LOE rax r13 dl ymm0
..B1.12:                        # Preds ..B1.14 ..B1.11
                                # Execution count [3.00e+00]
        movq      (%rsp), %r14                                  #46.7[spill]
        xorl      %r15d, %r15d                                  #45.5
        movq      40(%rsp), %r12                                #47.1[spill]
        movq      48(%rsp), %r11                                #48.1[spill]
        movq      56(%rsp), %r10                                #49.1[spill]
        addq      %rax, %r14                                    #46.7
        movq      64(%rsp), %r9                                 #50.1[spill]
        addq      %rax, %r12                                    #47.1
        movq      72(%rsp), %r8                                 #51.1[spill]
        addq      %rax, %r11                                    #48.1
        movq      80(%rsp), %rsi                                #52.1[spill]
        addq      %rax, %r10                                    #49.1
        movq      8(%rsp), %rcx                                 #53.1[spill]
        addq      %rax, %r9                                     #50.1
        movq      32(%rsp), %rdi                                #55.1[spill]
        addq      %rax, %r8                                     #51.1
        addq      %rax, %rsi                                    #52.1
...
..B1.15:                        # Preds ..B1.14
                                # Execution count [1.00e+00]
        movq      80(%rsp), %r8                                 #72.2[spill]
        movq      32(%rsp), %r9                                 #78.2[spill]
        movq      40(%rsp), %rax                                #62.2[spill]
        movq      48(%rsp), %rdx                                #64.2[spill]
        movq      64(%rsp), %rcx                                #68.2[spill]
        movq      72(%rsp), %rsi                                #70.2[spill]
...
..B1.16:                        # Preds ..B1.16 ..B1.15
        ...
        vmovsd    %xmm0, (%rsi,%rax,8)                          #91.1
        vmovsd    %xmm0, 1600(%rsi,%rax,8)                      #92.2
        vmovsd    %xmm0, (%r8,%rax,8)                           #89.1
        vmovsd    %xmm0, 1600(%r8,%rax,8)                       #90.2
        vmovsd    %xmm0, (%rbx,%rax,8)                          #87.1
        vmovsd    %xmm0, 1600(%rbx,%rax,8)                      #88.2
...
..B1.17:                        # Preds ..B1.16
        ...
        xorb      %dl, %dl                                      #80.3
        movq      40(%rsp), %rcx                                #80.3[spill]
        xorl      %eax, %eax                                    #80.3
        .align    16,0x90
                                # LOE rax rcx rbx r13 r14 r15 dl xmm0
...
..B1.20:                        # Preds ..B1.19
        ...
        movq      %rbx, 56(%rsp)                                #117.27[spill]
        vmovsd    %xmm1, 88(%rsp)                               #117.27[spill]
        movq      32(%rsp), %rbx                                #117.27[spill]
                                # LOE rbx r13 r14 r15 r12d
..B1.21:                        # Preds ..B1.30 ..B1.20
                                # Execution count [5.00e+00]
        movq      1592(%r15), %r10                              #131.15
        xorl      %r11d, %r11d                                  #131.3
        vmovsd    .L_2il0floatpacket.1(%rip), %xmm0             #131.15
        movq      80(%rsp), %r9                                 #131.15[spill]
        movq      72(%rsp), %rax                                #131.15[spill]
        movq      64(%rsp), %rdx                                #131.15[spill]
        movq      56(%rsp), %rcx                                #131.15[spill]
        movq      48(%rsp), %rsi                                #131.15[spill]
        movq      40(%rsp), %r8                                 #131.15[spill]
                                # LOE rax rdx rcx rbx rsi r8 r9 r10 r13 r14 r15 r11d r12d xmm0
..B1.23:                        # Preds ..B1.21 ..B1.25
                                # Execution count [2.78e+01]
        xorl      %edi, %edi                                    #116.11
                                # LOE rax rdx rcx rbx rsi rdi r8 r9 r10 r13 r14 r15 r11d r12d xmm0
..B1.24:                        # Preds ..B1.24 ..B1.23
                                # Execution count [2.72e+03]
        vmovsd    800(%r15,%rdi,8), %xmm1                       #118.19
        vmovsd    800(%r8,%rdi,8), %xmm6                        #121.24
        vmovsd    800(%rsi,%rdi,8), %xmm11                      #122.24
        vmovsd    800(%rcx,%rdi,8), %xmm16                      #123.24
        vmovsd    800(%rdx,%rdi,8), %xmm21                      #124.24
        vmovsd    800(%rax,%rdi,8), %xmm26                      #125.24
        vmovsd    800(%r9,%rdi,8), %xmm31                       #126.24
        vaddsd    1608(%r15,%rdi,8), %xmm1, %xmm2               #118.33
        vaddsd    1608(%r8,%rdi,8), %xmm6, %xmm7                #121.40
        vaddsd    1608(%rsi,%rdi,8), %xmm11, %xmm12             #122.40
        vaddsd    1608(%rcx,%rdi,8), %xmm16, %xmm17             #123.40
        vaddsd    1608(%rdx,%rdi,8), %xmm21, %xmm22             #124.40
        vaddsd    816(%r15,%rdi,8), %xmm2, %xmm3                #119.19
        vaddsd    816(%r8,%rdi,8), %xmm7, %xmm8                 #121.56
        vaddsd    816(%rsi,%rdi,8), %xmm12, %xmm13              #122.56
        vaddsd    1608(%rax,%rdi,8), %xmm26, %xmm27             #125.40
        vaddsd    1608(%r9,%rdi,8), %xmm31, %xmm1               #126.40
        vaddsd    8(%r15,%rdi,8), %xmm3, %xmm4                  #119.33
        vaddsd    8(%r8,%rdi,8), %xmm8, %xmm9                   #121.72
        vaddsd    8(%rsi,%rdi,8), %xmm13, %xmm14                #122.72
        vaddsd    816(%rcx,%rdi,8), %xmm17, %xmm18              #123.56
        vaddsd    816(%rdx,%rdi,8), %xmm22, %xmm23              #124.56
        vmulsd    %xmm4, %xmm0, %xmm5                           #119.33
        vaddsd    816(%rax,%rdi,8), %xmm27, %xmm28              #125.56
        vaddsd    816(%r9,%rdi,8), %xmm1, %xmm2                 #126.56
        vmulsd    %xmm9, %xmm0, %xmm10                          #121.72
        vaddsd    8(%rcx,%rdi,8), %xmm18, %xmm19                #123.72
        vmulsd    %xmm14, %xmm0, %xmm15                         #122.72
        vaddsd    8(%rdx,%rdi,8), %xmm23, %xmm24                #124.72
        vaddsd    8(%rax,%rdi,8), %xmm28, %xmm29                #125.72
        vaddsd    8(%r9,%rdi,8), %xmm2, %xmm3                   #126.72
        vmulsd    %xmm19, %xmm0, %xmm20                         #123.72
        vmulsd    %xmm24, %xmm0, %xmm25                         #124.72
        vmulsd    %xmm29, %xmm0, %xmm30                         #125.72
        vmulsd    %xmm3, %xmm0, %xmm4                           #126.72
        vmovsd    %xmm5, 808(%r15,%rdi,8)                       #117.15
        vmovsd    %xmm10, 808(%r8,%rdi,8)                       #121.1
        vmovsd    %xmm15, 808(%rsi,%rdi,8)                      #122.1
        vmovsd    800(%r14,%rdi,8), %xmm5                       #127.24
        vmovsd    800(%r13,%rdi,8), %xmm10                      #128.24
        vmovsd    800(%rbx,%rdi,8), %xmm15                      #129.24
        vmovsd    %xmm20, 808(%rcx,%rdi,8)                      #123.1
        vmovsd    %xmm25, 808(%rdx,%rdi,8)                      #124.1
        vmovsd    %xmm30, 808(%rax,%rdi,8)                      #125.1
        vmovsd    %xmm4, 808(%r9,%rdi,8)                        #126.1
        vaddsd    1608(%r14,%rdi,8), %xmm5, %xmm6               #127.40
        vaddsd    1608(%r13,%rdi,8), %xmm10, %xmm11             #128.40
        vaddsd    1608(%rbx,%rdi,8), %xmm15, %xmm16             #129.40
        vaddsd    816(%r14,%rdi,8), %xmm6, %xmm7                #127.56
        vaddsd    816(%r13,%rdi,8), %xmm11, %xmm12              #128.56
        vaddsd    816(%rbx,%rdi,8), %xmm16, %xmm17              #129.56
        vaddsd    8(%r14,%rdi,8), %xmm7, %xmm8                  #127.72
        vaddsd    8(%r13,%rdi,8), %xmm12, %xmm13                #128.72
        vaddsd    8(%rbx,%rdi,8), %xmm17, %xmm18                #129.72
        vmulsd    %xmm8, %xmm0, %xmm9                           #127.72
        vmulsd    %xmm13, %xmm0, %xmm14                         #128.72
        vmulsd    %xmm18, %xmm0, %xmm19                         #129.72
        vmovsd    %xmm9, 808(%r14,%rdi,8)                       #127.1
        vmovsd    %xmm14, 808(%r13,%rdi,8)                      #128.1
        vmovsd    %xmm19, 808(%rbx,%rdi,8)                      #129.1
        incq      %rdi                                          #116.11
        cmpq      $98, %rdi                                     #116.11
...
..B1.25:                        # Preds ..B1.24
                                # Execution count [2.78e+01]
        movq      1592(%r8), %rdi                               #132.17
        incl      %r11d                                         #112.5
        movq      %rdi, 1600(%r8)                               #132.1
        movq      1592(%rsi), %rdi                              #133.17
        movq      %rdi, 1600(%rsi)                              #133.1
        movq      1592(%rcx), %rdi                              #134.17
        movq      %rdi, 1600(%rcx)                              #134.1
        movq      1592(%rdx), %rdi                              #135.17
        movq      %rdi, 1600(%rdx)                              #135.1
        movq      1592(%rax), %rdi                              #136.17
        movq      %rdi, 1600(%rax)                              #136.1
        movq      1592(%r9), %rdi                               #137.17
        movq      %rdi, 1600(%r9)                               #137.1
        movq      1592(%r14), %rdi                              #138.17
        movq      %rdi, 1600(%r14)                              #138.1
        movq      1592(%r13), %rdi                              #139.17
        movq      %rdi, 1600(%r13)                              #139.1
        movq      1592(%rbx), %rdi                              #140.17
        movq      %r10, 800(%r15)                               #131.3
        movq      %rdi, 1600(%rbx)                              #140.1
        cmpl      %r12d, %r11d                                  #112.5
        jb        ..B1.23       # Prob 82%                      #112.5
                                # LOE rax rdx rcx rbx rsi r8 r9 r10 r13 r14 r15 r11d r12d xmm0
..B1.27:                        # Preds ..B1.25 ..B1.30
...
..B1.28:                        # Preds ..B1.27
        ...
        addl      %r12d, %r12d                                  #145.19
        vmovsd    .L_2il0floatpacket.3(%rip), %xmm1             #146.30
        vsubsd    88(%rsp), %xmm16, %xmm0                       #146.20[spill]
...
..B1.30:                        # Preds ..B1.29
        ...
        vmovsd    %xmm1, 88(%rsp)                               #110.17[spill]
        testl     %r12d, %r12d                                  #112.22
        jle       ..B1.27       # Prob 10%                      #112.22
        jmp       ..B1.21       # Prob 100%                     #112.22
                                # LOE rbx r13 r14 r15 r12d
..B1.32:                        # Preds ..B1.28
        ...
        movl      $1, %eax                                      #155.3
        sarl      $1, %r12d                                     #155.3
        vcvtsi2sd %r12d, %xmm1, %xmm1                           #155.3
...
..B1.34:                        # Preds ..B1.33
                                # Execution count [6.74e-01]: Infreq
        movq      40(%rsp), %rdi                                #157.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #157.1
                                # LOE rbx r13 r14
..B1.35:                        # Preds ..B1.34
                                # Execution count [6.74e-01]: Infreq
        movq      48(%rsp), %rdi                                #158.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #158.1
                                # LOE rbx r13 r14
..B1.36:                        # Preds ..B1.35
...
..L96:
	...
	.cfi_def_cfa_offset 32
        movl      $1, %edi                                      #6.3
        lea       (%rsp), %rsi                                  #6.3
..___tag_value__Z12getTimeStampv.98:
#       clock_gettime(clockid_t, timespec *)
        call      clock_gettime                                 #6.3
..___tag_value__Z12getTimeStampv.99:
...
..L103:
	...
	.cfi_def_cfa_offset 32
        movl      $1, %edi                                      #13.3
        lea       (%rsp), %rsi                                  #13.3
..___tag_value__Z17getTimeResolutionv.105:
#       clock_getres(clockid_t, timespec *)
        call      clock_getres                                  #13.3
..___tag_value__Z17getTimeResolutionv.106:
                                # LOE rbx rbp r12 r13 r14 r15
..B3.2:                         # Preds ..B3.1
                                # Execution count [1.00e+00]
