...
..B1.15:                        # Preds ..B1.71
        ...
        movq      %r13, 72(%rsp)                                #48.3[spill]
        movq      %r15, 48(%rsp)                                #48.3[spill]
        movq      %r14, 144(%rsp)                               #48.3[spill]
                                # LOE ymm0
..B1.16:                        # Preds ..B1.18 ..B1.15
                                # Execution count [3.00e+00]
        movq      144(%rsp), %r13                               #50.7[spill]
        xorl      %r14d, %r14d                                  #49.5
        movq      8(%rsp), %rax                                 #50.7[spill]
        movq      48(%rsp), %r10                                #52.1[spill]
        movq      64(%rsp), %r8                                 #54.1[spill]
        movq      80(%rsp), %rsi                                #56.1[spill]
        lea       (%r13,%rax), %r12                             #50.7
        movq      96(%rsp), %rcx                                #58.1[spill]
        movq      112(%rsp), %r15                               #60.1[spill]
        movq      %r12, 16(%rsp)                                #50.7[spill]
        lea       (%r10,%rax), %r12                             #52.1
        movq      160(%rsp), %r11                               #51.1[spill]
        lea       (%r8,%rax), %r10                              #54.1
        movq      56(%rsp), %r9                                 #53.1[spill]
        lea       (%rsi,%rax), %r8                              #56.1
        movq      72(%rsp), %rdi                                #55.1[spill]
        lea       (%rcx,%rax), %rsi                             #58.1
        movq      88(%rsp), %rbx                                #57.1[spill]
        lea       (%r15,%rax), %rcx                             #60.1
        movq      40(%rsp), %r15                                #62.1[spill]
        lea       (%r11,%rax), %r13                             #51.1
        movq      152(%rsp), %rdx                               #59.1[spill]
        lea       (%r9,%rax), %r11                              #53.1
        lea       (%rdi,%rax), %r9                              #55.1
        addq      %rax, %r15                                    #62.1
        movq      %r15, 104(%rsp)                               #62.1[spill]
        movq      32(%rsp), %r15                                #63.1[spill]
        lea       (%rbx,%rax), %rdi                             #57.1
        lea       (%rdx,%rax), %rbx                             #59.1
        movq      120(%rsp), %rdx                               #61.1[spill]
        addq      %rax, %rdx                                    #61.1
        addq      %r15, %rax                                    #63.1
...
..B1.19:                        # Preds ..B1.18
                                # Execution count [1.00e+00]
        movq      160(%rsp), %rax                               #70.2[spill]
        vmovsd    .L_2il0floatpacket.3(%rip), %xmm0             #68.9
        movq      56(%rsp), %rdx                                #74.2[spill]
        movq      112(%rsp), %r9                                #88.2[spill]
        movq      120(%rsp), %r10                               #90.2[spill]
        ...
        movq      64(%rsp), %rcx                                #76.2[spill]
        movq      80(%rsp), %rbx                                #80.2[spill]
        movq      96(%rsp), %rsi                                #84.2[spill]
        movq      152(%rsp), %r8                                #86.2[spill]
        movq      40(%rsp), %r11                                #92.2[spill]
        movq      32(%rsp), %rax                                #94.2[spill]
        ...
        vmovsd    %xmm0, (%r14)                                 #68.9
        vmovsd    %xmm0, 792(%r14)                              #67.9
        ...
        vmovsd    %xmm0, 800(%r14)                              #68.9
        vmovsd    %xmm0, 1592(%r14)                             #67.9
        ...
        vmovsd    %xmm0, 1600(%r14)                             #68.9
        vmovsd    %xmm0, 2392(%r14)                             #67.9
        ...
        xorl      %eax, %eax                                    #96.3
        movq      32(%rsp), %rdx                                #96.3[spill]
        movq      96(%rsp), %r9                                 #96.3[spill]
        movq      80(%rsp), %r10                                #96.3[spill]
...
..B1.22:                        # Preds ..B1.22 ..B1.21
        ...
        vmovsd    %xmm0, (%r14,%rax,8)                          #97.9
        vmovsd    %xmm0, 1600(%r14,%rax,8)                      #98.9
        incq      %rax                                          #96.3
        cmpq      $100, %rax                                    #96.3
...
..B1.24:                        # Preds ..B1.23
        ...
        movq      %r12, 88(%rsp)                                #141.27[spill]
        movq      %r13, 72(%rsp)                                #141.27[spill]
        movq      %r15, 48(%rsp)                                #141.27[spill]
        vmovsd    %xmm1, 104(%rsp)                              #141.27[spill]
        movq      32(%rsp), %r12                                #141.27[spill]
        movq      40(%rsp), %r13                                #141.27[spill]
        movq      120(%rsp), %r15                               #141.27[spill]
                                # LOE r12 r13 r14 r15 ebx
..B1.25:                        # Preds ..B1.37 ..B1.24
                                # Execution count [5.00e+00]
        movq      1592(%r14), %rdx                              #159.15
        xorl      %eax, %eax                                    #159.3
        movl      %ebx, 128(%rsp)                               #159.15[spill]
        movq      %rdx, 136(%rsp)                               #159.15[spill]
        movq      %r14, 144(%rsp)                               #159.15[spill]
        vmovsd    .L_2il0floatpacket.1(%rip), %xmm0             #159.15
        movq      112(%rsp), %r10                               #159.15[spill]
        movq      96(%rsp), %r11                                #159.15[spill]
        movq      88(%rsp), %r9                                 #159.15[spill]
        movq      80(%rsp), %rcx                                #159.15[spill]
        movq      72(%rsp), %rbx                                #159.15[spill]
        movq      64(%rsp), %rsi                                #159.15[spill]
        movq      56(%rsp), %rdi                                #159.15[spill]
        movq      48(%rsp), %r8                                 #159.15[spill]
                                # LOE rcx rbx rsi rdi r8 r9 r10 r11 r12 r13 r15 eax xmm0
..B1.27:                        # Preds ..B1.25 ..B1.32
                                # Execution count [2.78e+01]
        movq      152(%rsp), %r10                               #140.11[spill]
        xorl      %edx, %edx                                    #140.11
        movq      160(%rsp), %r14                               #140.11[spill]
        movq      144(%rsp), %r15                               #140.11[spill]
                                # LOE rdx rcx rbx rsi rdi r8 r9 r10 r11 r12 r13 r14 r15 eax xmm0
..B1.28:                        # Preds ..B1.28 ..B1.27
                                # Execution count [2.72e+03]
        vmovsd    800(%r15,%rdx,8), %xmm1                       #142.19
        vmovsd    800(%r14,%rdx,8), %xmm6                       #145.25
        vmovsd    800(%r8,%rdx,8), %xmm11                       #146.25
        vmovsd    800(%rdi,%rdx,8), %xmm16                      #147.25
        vmovsd    800(%rsi,%rdx,8), %xmm21                      #148.25
        vmovsd    800(%rbx,%rdx,8), %xmm26                      #149.24
        vmovsd    800(%rcx,%rdx,8), %xmm31                      #150.24
        vaddsd    1608(%r15,%rdx,8), %xmm1, %xmm2               #142.33
        vaddsd    1608(%r14,%rdx,8), %xmm6, %xmm7               #145.42
        vaddsd    1608(%r8,%rdx,8), %xmm11, %xmm12              #146.42
        vaddsd    1608(%rdi,%rdx,8), %xmm16, %xmm17             #147.42
        vaddsd    1608(%rsi,%rdx,8), %xmm21, %xmm22             #148.42
        vaddsd    816(%r15,%rdx,8), %xmm2, %xmm3                #143.19
        vaddsd    816(%r14,%rdx,8), %xmm7, %xmm8                #145.59
        vaddsd    816(%r8,%rdx,8), %xmm12, %xmm13               #146.59
        vaddsd    1608(%rbx,%rdx,8), %xmm26, %xmm27             #149.40
        vaddsd    1608(%rcx,%rdx,8), %xmm31, %xmm1              #150.40
        vaddsd    8(%r15,%rdx,8), %xmm3, %xmm4                  #143.33
        vaddsd    8(%r14,%rdx,8), %xmm8, %xmm9                  #145.76
        vaddsd    8(%r8,%rdx,8), %xmm13, %xmm14                 #146.76
        vaddsd    816(%rdi,%rdx,8), %xmm17, %xmm18              #147.59
        vaddsd    816(%rsi,%rdx,8), %xmm22, %xmm23              #148.59
        vmulsd    %xmm4, %xmm0, %xmm5                           #143.33
        vaddsd    816(%rbx,%rdx,8), %xmm27, %xmm28              #149.56
        vaddsd    816(%rcx,%rdx,8), %xmm1, %xmm2                #150.56
        vmulsd    %xmm9, %xmm0, %xmm10                          #145.76
        vaddsd    8(%rdi,%rdx,8), %xmm18, %xmm19                #147.76
        vmulsd    %xmm14, %xmm0, %xmm15                         #146.76
        vaddsd    8(%rsi,%rdx,8), %xmm23, %xmm24                #148.76
        vaddsd    8(%rbx,%rdx,8), %xmm28, %xmm29                #149.72
        vaddsd    8(%rcx,%rdx,8), %xmm2, %xmm3                  #150.72
        vmulsd    %xmm19, %xmm0, %xmm20                         #147.76
        vmulsd    %xmm24, %xmm0, %xmm25                         #148.76
        vmulsd    %xmm29, %xmm0, %xmm30                         #149.72
        vmulsd    %xmm3, %xmm0, %xmm4                           #150.72
        vmovsd    %xmm5, 808(%r15,%rdx,8)                       #141.15
        vmovsd    %xmm10, 808(%r14,%rdx,8)                      #145.1
        vmovsd    %xmm15, 808(%r8,%rdx,8)                       #146.1
        vmovsd    800(%r9,%rdx,8), %xmm5                        #151.24
        vmovsd    800(%r11,%rdx,8), %xmm10                      #152.24
        vmovsd    800(%r10,%rdx,8), %xmm15                      #153.24
        vmovsd    %xmm20, 808(%rdi,%rdx,8)                      #147.1
        vmovsd    %xmm25, 808(%rsi,%rdx,8)                      #148.1
        vmovsd    %xmm30, 808(%rbx,%rdx,8)                      #149.1
        vmovsd    %xmm4, 808(%rcx,%rdx,8)                       #150.1
        vaddsd    1608(%r9,%rdx,8), %xmm5, %xmm6                #151.40
        vaddsd    1608(%r11,%rdx,8), %xmm10, %xmm11             #152.40
        vaddsd    1608(%r10,%rdx,8), %xmm15, %xmm16             #153.40
        vaddsd    816(%r9,%rdx,8), %xmm6, %xmm7                 #151.56
        vaddsd    816(%r11,%rdx,8), %xmm11, %xmm12              #152.56
        vaddsd    816(%r10,%rdx,8), %xmm16, %xmm17              #153.56
        vaddsd    8(%r9,%rdx,8), %xmm7, %xmm8                   #151.72
        vaddsd    8(%r11,%rdx,8), %xmm12, %xmm13                #152.72
        vaddsd    8(%r10,%rdx,8), %xmm17, %xmm18                #153.72
        vmulsd    %xmm8, %xmm0, %xmm9                           #151.72
        vmulsd    %xmm13, %xmm0, %xmm14                         #152.72
        vmulsd    %xmm18, %xmm0, %xmm19                         #153.72
        vmovsd    %xmm9, 808(%r9,%rdx,8)                        #151.1
        vmovsd    %xmm14, 808(%r11,%rdx,8)                      #152.1
        vmovsd    %xmm19, 808(%r10,%rdx,8)                      #153.1
        incq      %rdx                                          #140.11
        cmpq      $98, %rdx                                     #140.11
...
..B1.31:                        # Preds ..B1.31 ..B1.30
                                # Execution count [2.72e+03]
        vmovsd    800(%r10,%rdx,8), %xmm1                       #154.24
        vmovsd    800(%r15,%rdx,8), %xmm6                       #155.24
        vmovsd    800(%r13,%rdx,8), %xmm11                      #156.24
        vmovsd    800(%r12,%rdx,8), %xmm16                      #157.24
        vaddsd    1608(%r10,%rdx,8), %xmm1, %xmm2               #154.40
        vaddsd    1608(%r15,%rdx,8), %xmm6, %xmm7               #155.40
        vaddsd    1608(%r13,%rdx,8), %xmm11, %xmm12             #156.40
        vaddsd    1608(%r12,%rdx,8), %xmm16, %xmm17             #157.40
        vaddsd    816(%r10,%rdx,8), %xmm2, %xmm3                #154.56
        vaddsd    816(%r15,%rdx,8), %xmm7, %xmm8                #155.56
        vaddsd    816(%r13,%rdx,8), %xmm12, %xmm13              #156.56
        vaddsd    816(%r12,%rdx,8), %xmm17, %xmm18              #157.56
        vaddsd    8(%r10,%rdx,8), %xmm3, %xmm4                  #154.72
        vaddsd    8(%r15,%rdx,8), %xmm8, %xmm9                  #155.72
        vaddsd    8(%r13,%rdx,8), %xmm13, %xmm14                #156.72
        vaddsd    8(%r12,%rdx,8), %xmm18, %xmm19                #157.72
        vmulsd    %xmm4, %xmm0, %xmm5                           #154.72
        vmulsd    %xmm9, %xmm0, %xmm10                          #155.72
        vmulsd    %xmm14, %xmm0, %xmm15                         #156.72
        vmulsd    %xmm19, %xmm0, %xmm20                         #157.72
        vmovsd    %xmm5, 808(%r10,%rdx,8)                       #154.1
        vmovsd    %xmm10, 808(%r15,%rdx,8)                      #155.1
        vmovsd    %xmm15, 808(%r13,%rdx,8)                      #156.1
        vmovsd    %xmm20, 808(%r12,%rdx,8)                      #157.1
        incq      %rdx                                          #140.11
        cmpq      $98, %rdx                                     #140.11
...
..B1.32:                        # Preds ..B1.31
                                # Execution count [2.78e+01]
        movq      144(%rsp), %r14                               #159.3[spill]
        incl      %eax                                          #136.5
        movq      136(%rsp), %rdx                               #159.3[spill]
        movq      %rdx, 800(%r14)                               #159.3
        movq      160(%rsp), %r14                               #160.18[spill]
        movq      1592(%r14), %rdx                              #160.18
        movq      %rdx, 1600(%r14)                              #160.1
        movq      1592(%r8), %rdx                               #161.18
        movq      %rdx, 1600(%r8)                               #161.1
        movq      1592(%rsi), %rdx                              #163.18
        movq      %rdx, 1600(%rsi)                              #163.1
        movq      1592(%rcx), %rdx                              #165.17
        movq      %rdx, 1600(%rcx)                              #165.1
        movq      1592(%r11), %rdx                              #167.17
        movq      1592(%rdi), %r14                              #162.18
        movq      %rdx, 1600(%r11)                              #167.1
        movq      %r14, 1600(%rdi)                              #162.1
        movq      152(%rsp), %rdx                               #168.17[spill]
        movq      1592(%rbx), %r14                              #164.17
        movq      %r14, 1600(%rbx)                              #164.1
        movq      1592(%r9), %r14                               #166.17
        movq      %r14, 1600(%r9)                               #166.1
        movq      1592(%rdx), %r14                              #168.17
        movq      %r14, 1600(%rdx)                              #168.1
        movq      1592(%r10), %r14                              #169.17
        movq      1592(%r15), %rdx                              #170.17
        movq      %r14, 1600(%r10)                              #169.1
        movq      %rdx, 1600(%r15)                              #170.1
        movq      1592(%r13), %r14                              #171.17
        movq      1592(%r12), %rdx                              #172.17
        movq      %r14, 1600(%r13)                              #171.1
        movq      %rdx, 1600(%r12)                              #172.1
        cmpl      128(%rsp), %eax                               #136.5[spill]
...
..B1.35:                        # Preds ..B1.34
        ...
        vsubsd    104(%rsp), %xmm16, %xmm0                      #178.20[spill]
...
..B1.37:                        # Preds ..B1.36
        ...
        vmovsd    %xmm1, 104(%rsp)                              #134.17[spill]
        testl     %ebx, %ebx                                    #136.22
        jle       ..B1.34       # Prob 10%                      #136.22
        jmp       ..B1.25       # Prob 100%                     #136.22
                                # LOE r12 r13 r14 r15 ebx
..B1.39:                        # Preds ..B1.35
...
..B1.43:                        # Preds ..B1.42
                                # Execution count [6.74e-01]: Infreq
        movq      56(%rsp), %rdi                                #191.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #191.1
                                # LOE r12 r13
..B1.44:                        # Preds ..B1.43
                                # Execution count [6.74e-01]: Infreq
        movq      64(%rsp), %rdi                                #192.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #192.1
                                # LOE r12 r13
..B1.45:                        # Preds ..B1.44
...
..B1.48:                        # Preds ..B1.47
                                # Execution count [6.74e-01]: Infreq
        movq      96(%rsp), %rdi                                #196.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #196.1
                                # LOE
..B1.49:                        # Preds ..B1.48
                                # Execution count [6.74e-01]: Infreq
        movq      152(%rsp), %rdi                               #197.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #197.1
                                # LOE
..B1.50:                        # Preds ..B1.49
                                # Execution count [6.74e-01]: Infreq
        movq      112(%rsp), %rdi                               #198.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #198.1
                                # LOE
..B1.51:                        # Preds ..B1.50
                                # Execution count [6.74e-01]: Infreq
        movq      120(%rsp), %rdi                               #199.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #199.1
                                # LOE
..B1.52:                        # Preds ..B1.51
                                # Execution count [6.74e-01]: Infreq
        movq      40(%rsp), %rdi                                #200.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #200.1
                                # LOE
..B1.53:                        # Preds ..B1.52
                                # Execution count [6.74e-01]: Infreq
        movq      32(%rsp), %rdi                                #201.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #201.1
                                # LOE
..B1.54:                        # Preds ..B1.53
