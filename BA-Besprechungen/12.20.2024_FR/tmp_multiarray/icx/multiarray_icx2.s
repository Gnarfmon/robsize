...
..B1.31:                        # Preds ..B1.40 ..B1.30
        ...
        movq      1592(%r14), %rcx                              #82.16
        xorl      %esi, %esi                                    #82.4
        movq      1592(%r15), %rdx                              #83.15
        movq      1592(%r13), %rax                              #84.15
        vmovsd    .L_2il0floatpacket.2(%rip), %xmm0             #84.15
                                # LOE rax rdx rcx r12 r13 r14 r15 ebx esi xmm0
..B1.33:                        # Preds ..B1.31 ..B1.35
                                # Execution count [2.78e+01]
        movq      %r12, %r8                                     #74.11
                                # LOE rax rdx rcx r8 r12 r13 r14 r15 ebx esi xmm0
..B1.34:                        # Preds ..B1.34 ..B1.33
                                # Execution count [2.72e+03]
        vmovsd    800(%r14,%r8,8), %xmm1                        #76.19
        vmovsd    800(%r15,%r8,8), %xmm6                        #79.24
        vmovsd    800(%r13,%r8,8), %xmm11                       #80.24
        vaddsd    1608(%r14,%r8,8), %xmm1, %xmm2                #76.33
        vaddsd    1608(%r15,%r8,8), %xmm6, %xmm7                #79.40
        vaddsd    1608(%r13,%r8,8), %xmm11, %xmm12              #80.40
        vaddsd    816(%r14,%r8,8), %xmm2, %xmm3                 #77.19
        vaddsd    816(%r15,%r8,8), %xmm7, %xmm8                 #79.56
        vaddsd    816(%r13,%r8,8), %xmm12, %xmm13               #80.56
        vaddsd    8(%r14,%r8,8), %xmm3, %xmm4                   #77.33
        vaddsd    8(%r15,%r8,8), %xmm8, %xmm9                   #79.72
        vaddsd    8(%r13,%r8,8), %xmm13, %xmm14                 #80.72
        vmulsd    %xmm4, %xmm0, %xmm5                           #77.33
        vmulsd    %xmm9, %xmm0, %xmm10                          #79.72
        vmulsd    %xmm14, %xmm0, %xmm15                         #80.72
        vmovsd    %xmm5, 808(%r14,%r8,8)                        #75.15
        vmovsd    %xmm10, 808(%r15,%r8,8)                       #79.1
        vmovsd    %xmm15, 808(%r13,%r8,8)                       #80.1
        incq      %r8                                           #74.11
        cmpq      $98, %r8                                      #74.11
...
..B1.35:                        # Preds ..B1.34
                                # Execution count [2.78e+01]
        incl      %esi                                          #70.5
        movq      %rcx, 800(%r14)                               #82.4
        movq      %rdx, 800(%r15)                               #83.1
        movq      %rax, 800(%r13)                               #84.1
        cmpl      %ebx, %esi                                    #70.5
