...
..B1.30:                        # Preds ..B1.39 ..B1.29
        ...
        movq      1592(%r15), %rdx                              #75.16
        xorl      %ecx, %ecx                                    #75.4
        movq      1592(%r14), %rax                              #76.15
        vmovsd    .L_2il0floatpacket.2(%rip), %xmm0             #76.15
                                # LOE rax rdx r12 r13 r14 r15 ecx ebx xmm0
..B1.32:                        # Preds ..B1.30 ..B1.34
                                # Execution count [2.78e+01]
        movq      %r13, %rsi                                    #68.11
        .align    16,0x90
                                # LOE rax rdx rsi r12 r13 r14 r15 ecx ebx xmm0
..B1.33:                        # Preds ..B1.33 ..B1.32
                                # Execution count [2.72e+03]
        vmovsd    800(%r15,%rsi,8), %xmm1                       #70.19
        vmovsd    800(%r14,%rsi,8), %xmm6                       #73.24
        vaddsd    1608(%r15,%rsi,8), %xmm1, %xmm2               #70.33
        vaddsd    1608(%r14,%rsi,8), %xmm6, %xmm7               #73.40
        vaddsd    816(%r15,%rsi,8), %xmm2, %xmm3                #71.19
        vaddsd    816(%r14,%rsi,8), %xmm7, %xmm8                #73.56
        vaddsd    8(%r15,%rsi,8), %xmm3, %xmm4                  #71.33
        vaddsd    8(%r14,%rsi,8), %xmm8, %xmm9                  #73.72
        vmulsd    %xmm4, %xmm0, %xmm5                           #71.33
        vmulsd    %xmm9, %xmm0, %xmm10                          #73.72
        vmovsd    %xmm5, 808(%r15,%rsi,8)                       #69.15
        vmovsd    %xmm10, 808(%r14,%rsi,8)                      #73.1
        incq      %rsi                                          #68.11
        cmpq      $98, %rsi                                     #68.11
...
..B1.34:                        # Preds ..B1.33
                                # Execution count [2.78e+01]
        incl      %ecx                                          #64.5
        movq      %rdx, 800(%r15)                               #75.4
        movq      %rax, 800(%r14)                               #76.1
        cmpl      %ebx, %ecx                                    #64.5
