...
# mark_description "w -fargument-noalias -funroll-loops -fno-builtin -diag-disable=10441 -S -o ./tmp_multiarray/multiarray_icx13";
# mark_description ".s";
...
..B1.112:                       # Preds ..B1.82
        ...
        vmovsd    120(%rsp), %xmm2                              #226.70[spill]
        vmulsd    .L_2il0floatpacket.5(%rip), %xmm2, %xmm5      #226.70
        vmulsd    .L_2il0floatpacket.4(%rip), %xmm6, %xmm7      #225.52
        vmulsd    %xmm8, %xmm5, %xmm1                           #226.73
