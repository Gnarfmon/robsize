...
# mark_description "w -fargument-noalias -funroll-loops -fno-builtin -diag-disable=10441 -S -o ./tmp_multiarray/multiarray_icx6.";
# mark_description "s";
...
..B1.74:                        # Preds ..B1.58
        ...
        vmovsd    224(%rsp), %xmm2                              #163.70[spill]
        vmulsd    .L_2il0floatpacket.3(%rip), %xmm2, %xmm7      #163.70
        vmulsd    .L_2il0floatpacket.2(%rip), %xmm5, %xmm6      #162.52
        vmulsd    %xmm8, %xmm7, %xmm1                           #163.73
