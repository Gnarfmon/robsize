...
# mark_description "w -fargument-noalias -funroll-loops -fno-builtin -diag-disable=10441 -S -o ./tmp_multiarray/multiarray_icx20";
# mark_description ".s";
...
..B1.150:                       # Preds ..B1.106
        ...
        vmovsd    224(%rsp), %xmm2                              #289.70[spill]
        vmulsd    .L_2il0floatpacket.5(%rip), %xmm2, %xmm5      #289.70
        vmulsd    .L_2il0floatpacket.4(%rip), %xmm6, %xmm7      #288.52
        vmulsd    %xmm8, %xmm5, %xmm1                           #289.73
