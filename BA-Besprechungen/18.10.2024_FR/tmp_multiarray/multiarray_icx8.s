...
# mark_description "w -fargument-noalias -funroll-loops -fno-builtin -diag-disable=10441 -S -o ./tmp_multiarray/multiarray_icx8.";
# mark_description "s";
...
..B1.97:                        # Preds ..B1.77
        ...
        vmovsd    224(%rsp), %xmm2                              #181.70[spill]
        vmulsd    .L_2il0floatpacket.5(%rip), %xmm2, %xmm5      #181.70
        vmulsd    .L_2il0floatpacket.4(%rip), %xmm6, %xmm7      #180.52
        vmulsd    %xmm8, %xmm5, %xmm1                           #181.73
