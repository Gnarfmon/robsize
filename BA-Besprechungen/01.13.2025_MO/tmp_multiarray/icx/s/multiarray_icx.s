...
..B1.45:                        # Preds ..B1.43 ..B1.40 ..B1.33 ..B1.38
                                # Execution count [1.00e+00]
        movl      $1, %ebx                                      #41.3
        lea       16(%rsp), %rsi                                #48.17
        movl      %ebx, %edi                                    #48.17
        xorl      %r14d, %r14d                                  #42.13
        vzeroupper                                              #48.17
..___tag_value_main.11:
#       clock_gettime(clockid_t, timespec *)
        call      clock_gettime                                 #48.17
..___tag_value_main.12:
                                # LOE r12 r13 r15 ebx r14d
..B1.46:                        # Preds ..B1.45
                                # Execution count [9.00e-01]
        vxorpd    %xmm0, %xmm0, %xmm0                           #48.17
        vxorpd    %xmm1, %xmm1, %xmm1                           #48.17
        vcvtsi2sdq 24(%rsp), %xmm0, %xmm0                       #48.17
        vcvtsi2sdq 16(%rsp), %xmm1, %xmm1                       #48.17
        vmovsd    .L_2il0floatpacket.1(%rip), %xmm2             #48.17
        vfmadd231sd %xmm2, %xmm0, %xmm1                         #48.17
        vmovsd    %xmm1, 8(%rsp)                                #55.27[spill]
        movq      %r13, (%rsp)                                  #55.27[spill]
	.cfi_escape 0x10, 0x0d, 0x0e, 0x38, 0x1c, 0x0d, 0x80, 0xff, 0xff, 0xff, 0x1a, 0x0d, 0x80, 0xff, 0xff, 0xff, 0x22
        xorl      %r13d, %r13d                                  #55.27
                                # LOE r12 r13 r15 ebx r14d
..B1.47:                        # Preds ..B1.58 ..B1.46
                                # Execution count [5.00e+00]
        movq      1592(%r15), %rax                              #62.16
        xorl      %edx, %edx                                    #62.4
        vmovsd    .L_2il0floatpacket.2(%rip), %xmm0             #62.16
...
..B1.50:                        # Preds ..B1.50 ..B1.49
        ...
        vmovsd    800(%r15,%rcx,8), %xmm1                       #56.19
        vaddsd    1608(%r15,%rcx,8), %xmm1, %xmm2               #56.33
        vaddsd    816(%r15,%rcx,8), %xmm2, %xmm3                #57.19
        vaddsd    8(%r15,%rcx,8), %xmm3, %xmm4                  #57.33
        vmulsd    %xmm4, %xmm0, %xmm5                           #57.33
        vmovsd    %xmm5, 808(%r15,%rcx,8)                       #55.15
        incq      %rcx                                          #54.11
        cmpq      $98, %rcx                                     #54.11
        jb        ..B1.50       # Prob 98%                      #54.11
                                # LOE rax rcx r12 r13 r15 edx ebx r14d xmm0
..B1.51:                        # Preds ..B1.50
                                # Execution count [2.78e+01]
        incl      %edx                                          #50.5
        movq      %rax, 800(%r15)                               #62.4
        cmpl      %ebx, %edx                                    #50.5
        jb        ..B1.49       # Prob 82%                      #50.5
                                # LOE rax r12 r13 r15 edx ebx r14d xmm0
..B1.52:                        # Preds ..B1.51
                                # Execution count [5.00e+00]
        xorl      %eax, %eax                                    #50.5
...
..B1.53:                        # Preds ..B1.52 ..B1.53
        ...
        addl      $98, %r14d                                    #60.23
        cmpl      %ebx, %eax                                    #50.5
        jb        ..B1.53       # Prob 82%                      #50.5
                                # LOE r12 r13 r15 eax ebx r14d
..B1.55:                        # Preds ..B1.53 ..B1.58
                                # Execution count [5.56e+00]
        movl      $1, %edi                                      #66.15
        lea       32(%rsp), %rsi                                #66.15
..___tag_value_main.16:
#       clock_gettime(clockid_t, timespec *)
        call      clock_gettime                                 #66.15
..___tag_value_main.17:
                                # LOE r12 r13 r15 ebx r14d
..B1.56:                        # Preds ..B1.55
                                # Execution count [5.56e+00]
        vxorpd    %xmm16, %xmm16, %xmm16                        #66.15
        vxorpd    %xmm17, %xmm17, %xmm17                        #66.15
        vcvtsi2sdq 40(%rsp), %xmm16, %xmm16                     #66.15
        vcvtsi2sdq 32(%rsp), %xmm17, %xmm17                     #66.15
        vfmadd231sd .L_2il0floatpacket.1(%rip), %xmm16, %xmm17  #66.15
        addl      %ebx, %ebx                                    #67.19
        vmovsd    .L_2il0floatpacket.4(%rip), %xmm0             #68.30
        vsubsd    8(%rsp), %xmm17, %xmm1                        #68.20[spill]
        vcomisd   %xmm1, %xmm0                                  #68.30
        jbe       ..B1.63       # Prob 18%                      #68.30
...
..B1.58:                        # Preds ..B1.57
        ...
        vcvtsi2sdq 24(%rsp), %xmm0, %xmm0                       #48.17
        vcvtsi2sdq 16(%rsp), %xmm1, %xmm1                       #48.17
        vfmadd231sd .L_2il0floatpacket.1(%rip), %xmm0, %xmm1    #48.17
        vmovsd    %xmm1, 8(%rsp)                                #48.17[spill]
        testl     %ebx, %ebx                                    #50.22
        jle       ..B1.55       # Prob 10%                      #50.22
        jmp       ..B1.47       # Prob 100%                     #50.22
	.cfi_restore 13
                                # LOE r12 r13 r15 ebx r14d
..B1.60:                        # Preds ..B1.4
...
..B1.63:                        # Preds ..B1.56
	...
	.cfi_restore 13
        testl     %ebx, %ebx                                    #74.14
        jl        ..B1.67       # Prob 5%                       #74.14
	.cfi_escape 0x10, 0x0d, 0x0e, 0x38, 0x1c, 0x0d, 0x80, 0xff, 0xff, 0xff, 0x1a, 0x0d, 0x80, 0xff, 0xff, 0xff, 0x22
                                # LOE r12 r13 r15 ebx r14d
..B1.64:                        # Preds ..B1.63 ..B1.67
                                # Execution count [1.00e+00]: Infreq
        vxorpd    %xmm2, %xmm2, %xmm2                           #76.3
        movl      $.L_2__STRING.5, %edi                         #76.3
        vcvtsi2sd %ebx, %xmm2, %xmm2                            #76.3
        vmovsd    8(%rsp), %xmm0                                #76.3[spill]
        movl      $1, %eax                                      #76.3
        vmulsd    .L_2il0floatpacket.3(%rip), %xmm0, %xmm1      #76.3
        vdivsd    %xmm2, %xmm1, %xmm0                           #76.3
