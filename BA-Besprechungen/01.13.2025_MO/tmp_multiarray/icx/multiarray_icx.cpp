...
#pragma distribute_point
	  ...
	  phi[i][0] = phi[i][NK-1];
phi_39[i][0] = phi_39[i][NK-1];
phi_38[i][0] = phi_38[i][NK-1];
phi_37[i][0] = phi_37[i][NK-1];
phi_36[i][0] = phi_36[i][NK-1];
phi_35[i][0] = phi_35[i][NK-1];
phi_34[i][0] = phi_34[i][NK-1];
phi_33[i][0] = phi_33[i][NK-1];
phi_32[i][0] = phi_32[i][NK-1];
phi_31[i][0] = phi_31[i][NK-1];
phi_30[i][0] = phi_30[i][NK-1];
phi_29[i][0] = phi_29[i][NK-1];
phi_28[i][0] = phi_28[i][NK-1];
phi_27[i][0] = phi_27[i][NK-1];
phi_26[i][0] = phi_26[i][NK-1];
phi_25[i][0] = phi_25[i][NK-1];
phi_24[i][0] = phi_24[i][NK-1];
phi_23[i][0] = phi_23[i][NK-1];
phi_22[i][0] = phi_22[i][NK-1];
phi_21[i][0] = phi_21[i][NK-1];
phi_20[i][0] = phi_20[i][NK-1];
phi_19[i][0] = phi_19[i][NK-1];
phi_18[i][0] = phi_18[i][NK-1];
phi_17[i][0] = phi_17[i][NK-1];
phi_16[i][0] = phi_16[i][NK-1];
phi_15[i][0] = phi_15[i][NK-1];
phi_14[i][0] = phi_14[i][NK-1];
phi_13[i][0] = phi_13[i][NK-1];
phi_12[i][0] = phi_12[i][NK-1];
phi_11[i][0] = phi_11[i][NK-1];
phi_10[i][0] = phi_10[i][NK-1];
phi_9[i][0] = phi_9[i][NK-1];
phi_8[i][0] = phi_8[i][NK-1];
phi_7[i][0] = phi_7[i][NK-1];
phi_6[i][0] = phi_6[i][NK-1];
phi_5[i][0] = phi_5[i][NK-1];
phi_4[i][0] = phi_4[i][NK-1];
phi_3[i][0] = phi_3[i][NK-1];
phi_2[i][0] = phi_2[i][NK-1];
phi_1[i][0] = phi_1[i][NK-1];
      }
  ...
  if(NITER < 0) printf("%d", dummy);
  double cycle_calc = (double)(wct_end-wct_start)*2400000000.0/NITER/(NI-2)/(NK-2);
  printf("%f\n", cycle_calc); 
  delete[] phi;
delete[] phi_39;
delete[] phi_38;
