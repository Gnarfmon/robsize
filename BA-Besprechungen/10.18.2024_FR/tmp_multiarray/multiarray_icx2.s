...
# mark_description "w -fargument-noalias -funroll-loops -fno-builtin -diag-disable=10441 -S -o ./tmp_multiarray/multiarray_icx2.";
# mark_description "s";
...
..B1.65:                        # Preds ..B1.57
        ...
        vmovsd    224(%rsp), %xmm3                              #127.70[spill]
        vmulsd    .L_2il0floatpacket.4(%rip), %xmm17, %xmm18    #126.52
        vmulsd    .L_2il0floatpacket.5(%rip), %xmm3, %xmm4      #127.70
        vmulsd    %xmm5, %xmm18, %xmm0                          #126.55
        vmulsd    %xmm5, %xmm4, %xmm1                           #127.73
