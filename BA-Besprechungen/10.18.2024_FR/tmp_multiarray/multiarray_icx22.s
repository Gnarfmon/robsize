...
# mark_description "w -fargument-noalias -funroll-loops -fno-builtin -diag-disable=10441 -S -o ./tmp_multiarray/multiarray_icx22";
# mark_description ".s";
...
..B1.161:                       # Preds ..B1.113
        ...
        vmovsd    120(%rsp), %xmm2                              #307.70[spill]
        vmulsd    .L_2il0floatpacket.5(%rip), %xmm2, %xmm5      #307.70
        vmulsd    .L_2il0floatpacket.4(%rip), %xmm6, %xmm7      #306.52
        vmulsd    %xmm8, %xmm5, %xmm1                           #307.73
