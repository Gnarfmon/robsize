...
# mark_description "w -fargument-noalias -funroll-loops -fno-builtin -diag-disable=10441 -S -o ./tmp_multiarray/multiarray_icx7.";
# mark_description "s";
...
..B1.74:                        # Preds ..B1.56
        ...
        vmovsd    224(%rsp), %xmm2                              #172.70[spill]
        vmulsd    .L_2il0floatpacket.5(%rip), %xmm2, %xmm5      #172.70
        vmulsd    .L_2il0floatpacket.4(%rip), %xmm6, %xmm7      #171.52
        vmulsd    %xmm8, %xmm5, %xmm1                           #172.73
