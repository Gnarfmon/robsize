...
# mark_description "w -fargument-noalias -funroll-loops -fno-builtin -diag-disable=10441 -S -o ./tmp_multiarray/multiarray_icx19";
# mark_description ".s";
...
..B1.147:                       # Preds ..B1.105
        ...
        vmulsd    .L_2il0floatpacket.5(%rip), %xmm2, %xmm5      #280.70
        vmulsd    .L_2il0floatpacket.4(%rip), %xmm6, %xmm7      #279.52
        vmulsd    %xmm8, %xmm5, %xmm1                           #280.73
