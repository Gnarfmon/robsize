...
# mark_description "w -fargument-noalias -funroll-loops -fno-builtin -diag-disable=10441 -S -o ./tmp_multiarray/multiarray_icx17";
# mark_description ".s";
...
..B1.141:                       # Preds ..B1.103
        ...
        vmovsd    120(%rsp), %xmm2                              #262.70[spill]
        vmulsd    .L_2il0floatpacket.6(%rip), %xmm2, %xmm5      #262.70
        vmulsd    .L_2il0floatpacket.5(%rip), %xmm6, %xmm7      #261.52
        vmulsd    %xmm8, %xmm5, %xmm1                           #262.73
