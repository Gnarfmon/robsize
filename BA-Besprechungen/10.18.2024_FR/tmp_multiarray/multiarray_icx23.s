...
# mark_description "w -fargument-noalias -funroll-loops -fno-builtin -diag-disable=10441 -S -o ./tmp_multiarray/multiarray_icx23";
# mark_description ".s";
...
..B1.159:                       # Preds ..B1.109
        ...
        vmovsd    120(%rsp), %xmm2                              #316.70[spill]
        vmulsd    .L_2il0floatpacket.6(%rip), %xmm2, %xmm5      #316.70
        vmulsd    .L_2il0floatpacket.5(%rip), %xmm6, %xmm7      #315.52
        vmulsd    %xmm8, %xmm5, %xmm1                           #316.73
