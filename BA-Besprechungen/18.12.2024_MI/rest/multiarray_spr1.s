...
..B1.48:                        # Preds ..B1.47
                                # Execution count [5.27e+00]
        movl      $1, %edi                                      #101.15
        lea       256(%rsp), %rsi                               #101.15
..___tag_value_main.35:
#       clock_gettime(clockid_t, timespec *)
        call      clock_gettime                                 #101.15
..___tag_value_main.36:
                                # LOE r12 r14 r15 ebx r13d
..B1.49:                        # Preds ..B1.48
                                # Execution count [5.27e+00]
        vxorpd    %xmm0, %xmm0, %xmm0                           #101.15
        vxorpd    %xmm1, %xmm1, %xmm1                           #101.15
        vcvtsi2sdq 264(%rsp), %xmm0, %xmm0                      #101.15
        vcvtsi2sdq 256(%rsp), %xmm1, %xmm1                      #101.15
        vfmadd231sd .L_2il0floatpacket.1(%rip), %xmm0, %xmm1    #101.15
        movl      %ebx, %edi                                    #102.15
        vmovsd    %xmm1, 280(%rsp)                              #101.15[spill]
        movl      $8, %edx                                      #102.15
        lea       272(%rsp), %rsi                               #102.15
...
..B1.50:                        # Preds ..B1.49
                                # Execution count [5.27e+00]
        vmovsd    280(%rsp), %xmm16                             #104.20[spill]
        addl      %r13d, %r13d                                  #103.19
        vmovsd    .L_2il0floatpacket.5(%rip), %xmm0             #104.30
        vsubsd    224(%rsp), %xmm16, %xmm1                      #104.20[spill]
        vcomisd   %xmm1, %xmm0                                  #104.30
        ja        ..B1.38       # Prob 82%                      #104.30
                                # LOE r12 r14 r15 ebx r13d xmm1
..B1.51:                        # Preds ..B1.50
                                # Execution count [9.49e-01]
        movl      %ebx, %edx                                    #
        lea       272(%rsp), %rsi                               #107.13
        movl      %edx, %edi                                    #107.13
        movl      $8, %edx                                      #107.13
...
..B1.52:                        # Preds ..B1.51
                                # Execution count [9.49e-01]
        testl     %eax, %eax                                    #108.13
        jge       ..B1.56       # Prob 59%                      #108.13
...
..B1.56:                        # Preds ..B1.52
        ...
        movl      %r13d, %edx                                   #118.55
        vxorpd    %xmm16, %xmm16, %xmm16                        #118.46
        shrl      $31, %edx                                     #118.55
        vxorpd    %xmm17, %xmm17, %xmm17                        #118.40
        addl      %edx, %r13d                                   #106.17
        movl      $.L_2__STRING.4, %edi                         #121.3
        sarl      $1, %r13d                                     #106.17
        movl      $3, %eax                                      #121.3
        vcvtsi2sd %r13d, %xmm16, %xmm16                         #118.46
        vmovsd    .L_2il0floatpacket.5(%rip), %xmm2             #118.46
        vdivsd    %xmm16, %xmm2, %xmm5                          #118.46
        movq      272(%rsp), %rcx                               #118.33
        subq      %r12, %rcx                                    #118.33
        vcvtsi2sdq %rcx, %xmm17, %xmm17                         #118.40
        vmovsd    224(%rsp), %xmm3                              #119.72[spill]
        vmulsd    .L_2il0floatpacket.3(%rip), %xmm17, %xmm18    #118.52
        vmulsd    .L_2il0floatpacket.4(%rip), %xmm3, %xmm4      #119.72
        vmulsd    %xmm5, %xmm18, %xmm0                          #118.55
        vmulsd    %xmm5, %xmm4, %xmm1                           #119.75
        vdivsd    %xmm0, %xmm1, %xmm2                           #121.3
