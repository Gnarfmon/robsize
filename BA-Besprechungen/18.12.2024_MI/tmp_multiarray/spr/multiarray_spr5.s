...
..B1.22:                        # Preds ..B1.21
        ...
        movl      %edx, %ebx                                    #118.27
        movl      240(%rsp), %r13d                              #118.27[spill]
        movq      280(%rsp), %r12                               #118.27[spill]
                                # LOE r12 r15 ebx r13d
..B1.23:                        # Preds ..B1.35 ..B1.22
                                # Execution count [5.27e+00]
        movl      $1, %edi                                      #110.17
        lea       248(%rsp), %rsi                               #110.17
        movq      72(%rsi), %r14                                #108.12
        vzeroupper                                              #110.17
...
..B1.26:                        # Preds ..B1.25
        ...
        movq      312(%rsp), %rcx                               #[spill]
                                # LOE rax rdx rcx rsi r12 r14 r15 ebx r8d r13d xmm0
..B1.28:                        # Preds ..B1.26 ..B1.30
                                # Execution count [2.64e+01]
        movl      $1, %r9d                                      #117.21
                                # LOE rax rdx rcx rsi r9 r12 r14 r15 ebx r8d r13d xmm0
..B1.29:                        # Preds ..B1.29 ..B1.28
                                # Execution count [2.58e+03]
        vmovsd    792(%rcx,%r9,8), %xmm1                        #119.19
        vmovsd    792(%rdx,%r9,8), %xmm6                        #122.24
        vmovsd    792(%rax,%r9,8), %xmm11                       #123.24
        vmovsd    792(%rsi,%r9,8), %xmm16                       #124.24
        vmovsd    792(%r15,%r9,8), %xmm21                       #125.24
        vmovsd    792(%r12,%r9,8), %xmm26                       #126.24
        vaddsd    1600(%rcx,%r9,8), %xmm1, %xmm2                #119.33
        vaddsd    1600(%rdx,%r9,8), %xmm6, %xmm7                #122.40
        vaddsd    1600(%rax,%r9,8), %xmm11, %xmm12              #123.40
        vaddsd    1600(%rsi,%r9,8), %xmm16, %xmm17              #124.40
        vaddsd    1600(%r15,%r9,8), %xmm21, %xmm22              #125.40
        vaddsd    1600(%r12,%r9,8), %xmm26, %xmm27              #126.40
        vaddsd    808(%rcx,%r9,8), %xmm2, %xmm3                 #120.19
        vaddsd    808(%rdx,%r9,8), %xmm7, %xmm8                 #122.56
        vaddsd    808(%rax,%r9,8), %xmm12, %xmm13               #123.56
        vaddsd    808(%rsi,%r9,8), %xmm17, %xmm18               #124.56
        vaddsd    808(%r15,%r9,8), %xmm22, %xmm23               #125.56
        vaddsd    808(%r12,%r9,8), %xmm27, %xmm28               #126.56
        vaddsd    (%rcx,%r9,8), %xmm3, %xmm4                    #120.33
        vaddsd    (%rdx,%r9,8), %xmm8, %xmm9                    #122.72
        vaddsd    (%rax,%r9,8), %xmm13, %xmm14                  #123.72
        vaddsd    (%rsi,%r9,8), %xmm18, %xmm19                  #124.72
        vaddsd    (%r15,%r9,8), %xmm23, %xmm24                  #125.72
        vmulsd    %xmm4, %xmm0, %xmm5                           #120.33
        vaddsd    (%r12,%r9,8), %xmm28, %xmm29                  #126.72
        ...
        vmovsd    %xmm5, 800(%rcx,%r9,8)                        #118.15
        vmovsd    %xmm10, 800(%rdx,%r9,8)                       #122.1
        vmovsd    %xmm15, 800(%rax,%r9,8)                       #123.1
        vmovsd    %xmm20, 800(%rsi,%r9,8)                       #124.1
        vmovsd    %xmm25, 800(%r15,%r9,8)                       #125.1
        vmovsd    %xmm30, 800(%r12,%r9,8)                       #126.1
        incq      %r9                                           #117.35
        cmpq      $99, %r9                                      #117.27
...
..B1.30:                        # Preds ..B1.29
                                # Execution count [2.64e+01]
        movq      1592(%rcx), %r9                               #128.18
        incl      %r8d                                          #113.31
        movq      %r9, 1600(%rcx)                               #128.4
        movq      1592(%rsi), %r9                               #131.17
        movq      %r9, 1600(%rsi)                               #131.1
        movq      1592(%r15), %r9                               #132.17
        movq      %r9, 1600(%r15)                               #132.1
        movq      1592(%rdx), %r10                              #129.17
        movq      1592(%rax), %r11                              #130.17
        movq      1592(%r12), %r9                               #133.17
        movq      %r10, 1600(%rdx)                              #129.1
        movq      %r11, 1600(%rax)                              #130.1
        movq      %r9, 1600(%r12)                               #133.1
        cmpl      %r13d, %r8d                                   #113.22
...
..B1.34:                        # Preds ..B1.33
        ...
        vcvtsi2sdq 272(%rsp), %xmm0, %xmm0                      #138.15
        vcvtsi2sdq 264(%rsp), %xmm1, %xmm1                      #138.15
        vfmadd231sd .L_2il0floatpacket.0(%rip), %xmm0, %xmm1    #138.15
        movl      %ebx, %edi                                    #139.15
        vmovsd    %xmm1, 232(%rsp)                              #138.15[spill]
        movl      $8, %edx                                      #139.15
        lea       320(%rsp), %rsi                               #139.15
...
..B1.35:                        # Preds ..B1.34
                                # Execution count [5.27e+00]
        vmovsd    232(%rsp), %xmm16                             #141.20[spill]
        addl      %r13d, %r13d                                  #140.19
        vmovsd    .L_2il0floatpacket.4(%rip), %xmm0             #141.30
        vsubsd    224(%rsp), %xmm16, %xmm1                      #141.20[spill]
...
..B1.36:                        # Preds ..B1.35
                                # Execution count [9.49e-01]
        movl      %ebx, %edx                                    #
        lea       320(%rsp), %rsi                               #144.13
        movl      %edx, %edi                                    #144.13
        movl      $8, %edx                                      #144.13
        vmovsd    %xmm1, -96(%rsi)                              #[spill]
        movq      %r15, %rbx                                    #
        movq      %r14, -88(%rsi)                               #[spill]
        movl      %r13d, -80(%rsi)                              #[spill]
...
..B1.45:                        # Preds ..B1.37
        ...
        movq      320(%rsp), %rsi                               #159.33
        subq      232(%rsp), %rsi                               #159.33[spill]
        vcvtsi2sdq %rsi, %xmm17, %xmm17                         #159.40
        vmovsd    224(%rsp), %xmm3                              #160.72[spill]
        vmulsd    .L_2il0floatpacket.2(%rip), %xmm17, %xmm18    #159.52
        vmulsd    .L_2il0floatpacket.3(%rip), %xmm3, %xmm4      #160.72
        vmulsd    %xmm5, %xmm18, %xmm0                          #159.55
        vmulsd    %xmm5, %xmm4, %xmm1                           #160.75
