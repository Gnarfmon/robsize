...
..B1.46:                        # Preds ..B1.45
                                # Execution count [2.64e+01]
        incl      %ecx                                          #92.31
        movq      1592(%r8), %rsi                               #104.18
        movq      1592(%r14), %r9                               #105.17
        movq      1592(%r15), %r10                              #106.17
        movq      %rsi, 1600(%r8)                               #104.4
        movq      %r9, 1600(%r14)                               #105.1
        movq      %r10, 1600(%r15)                              #106.1
        cmpl      %r12d, %ecx                                   #92.22
...
..B1.50:                        # Preds ..B1.49
        ...
        vfmadd231sd .L_2il0floatpacket.1(%rip), %xmm0, %xmm1    #111.15
...
..B1.51:                        # Preds ..B1.50
        ...
        addl      %r12d, %r12d                                  #113.19
        vmovsd    .L_2il0floatpacket.5(%rip), %xmm0             #114.30
        vsubsd    224(%rsp), %xmm16, %xmm1                      #114.20[spill]
        vcomisd   %xmm1, %xmm0                                  #114.30
        ja        ..B1.39       # Prob 82%                      #114.30
...
..B1.58:                        # Preds ..B1.53
        ...
        movl      %r12d, %edx                                   #129.55
        vxorpd    %xmm16, %xmm16, %xmm16                        #129.46
        shrl      $31, %edx                                     #129.55
        vxorpd    %xmm17, %xmm17, %xmm17                        #129.40
        addl      %edx, %r12d                                   #116.17
        movl      $.L_2__STRING.4, %edi                         #132.3
        sarl      $1, %r12d                                     #116.17
        movl      $3, %eax                                      #132.3
        vcvtsi2sd %r12d, %xmm16, %xmm16                         #129.46
        vmovsd    .L_2il0floatpacket.5(%rip), %xmm2             #129.46
        vdivsd    %xmm16, %xmm2, %xmm5                          #129.46
        movq      272(%rsp), %rcx                               #129.33
        subq      %rbx, %rcx                                    #129.33
        vcvtsi2sdq %rcx, %xmm17, %xmm17                         #129.40
        vmovsd    224(%rsp), %xmm3                              #130.72[spill]
        vmulsd    .L_2il0floatpacket.3(%rip), %xmm17, %xmm18    #129.52
        vmulsd    .L_2il0floatpacket.4(%rip), %xmm3, %xmm4      #130.72
        vmulsd    %xmm5, %xmm18, %xmm0                          #129.55
        vmulsd    %xmm5, %xmm4, %xmm1                           #130.75
