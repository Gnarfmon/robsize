...
..B1.21:                        # Preds ..B1.23 ..B1.20
        ...
        movq      280(%rsp), %r15                               #74.7[spill]
        xorl      %edi, %edi                                    #73.5
        movq      288(%rsp), %r14                               #75.1[spill]
...
..B1.22:                        # Preds ..B1.22 ..B1.21
        ...
        vmovupd   %ymm0, (%r15,%rdi,8)                          #74.7
        vmovupd   %ymm0, (%r14,%rdi,8)                          #75.1
...
..B1.32:                        # Preds ..B1.31
        ...
        movq      280(%rsp), %r8                                #[spill]
                                # LOE rax rdx rcx rsi rdi r8 r9 r10 r13 r14 r15 ebx r11d xmm0
..B1.34:                        # Preds ..B1.32 ..B1.36
                                # Execution count [2.64e+01]
        movl      $1, %r12d                                     #145.21
                                # LOE rax rdx rcx rsi rdi r8 r9 r10 r12 r13 r14 r15 ebx r11d xmm0
..B1.35:                        # Preds ..B1.35 ..B1.34
                                # Execution count [2.58e+03]
        vmovsd    792(%r8,%r12,8), %xmm1                        #147.19
        vmovsd    792(%rdi,%r12,8), %xmm6                       #150.24
        vmovsd    792(%rsi,%r12,8), %xmm11                      #151.24
        vmovsd    792(%rcx,%r12,8), %xmm16                      #152.24
        vmovsd    792(%rdx,%r12,8), %xmm21                      #153.24
        vmovsd    792(%rax,%r12,8), %xmm26                      #154.24
        vmovsd    792(%r9,%r12,8), %xmm31                       #155.24
        vaddsd    1600(%r8,%r12,8), %xmm1, %xmm2                #147.33
        vaddsd    1600(%rdi,%r12,8), %xmm6, %xmm7               #150.40
        vaddsd    1600(%rsi,%r12,8), %xmm11, %xmm12             #151.40
        vaddsd    1600(%rcx,%r12,8), %xmm16, %xmm17             #152.40
        vaddsd    1600(%rdx,%r12,8), %xmm21, %xmm22             #153.40
        vaddsd    808(%r8,%r12,8), %xmm2, %xmm3                 #148.19
        vaddsd    808(%rdi,%r12,8), %xmm7, %xmm8                #150.56
        vaddsd    808(%rsi,%r12,8), %xmm12, %xmm13              #151.56
        vaddsd    1600(%rax,%r12,8), %xmm26, %xmm27             #154.40
        vaddsd    1600(%r9,%r12,8), %xmm31, %xmm1               #155.40
        vaddsd    (%r8,%r12,8), %xmm3, %xmm4                    #148.33
        vaddsd    (%rdi,%r12,8), %xmm8, %xmm9                   #150.72
        vaddsd    (%rsi,%r12,8), %xmm13, %xmm14                 #151.72
        vaddsd    808(%rcx,%r12,8), %xmm17, %xmm18              #152.56
        vaddsd    808(%rdx,%r12,8), %xmm22, %xmm23              #153.56
        vmulsd    %xmm4, %xmm0, %xmm5                           #148.33
        vaddsd    808(%rax,%r12,8), %xmm27, %xmm28              #154.56
        vaddsd    808(%r9,%r12,8), %xmm1, %xmm2                 #155.56
        vmulsd    %xmm9, %xmm0, %xmm10                          #150.72
        vaddsd    (%rcx,%r12,8), %xmm18, %xmm19                 #152.72
        vmulsd    %xmm14, %xmm0, %xmm15                         #151.72
        vaddsd    (%rdx,%r12,8), %xmm23, %xmm24                 #153.72
        vaddsd    (%rax,%r12,8), %xmm28, %xmm29                 #154.72
        vaddsd    (%r9,%r12,8), %xmm2, %xmm3                    #155.72
        vmulsd    %xmm19, %xmm0, %xmm20                         #152.72
        vmulsd    %xmm24, %xmm0, %xmm25                         #153.72
        vmulsd    %xmm29, %xmm0, %xmm30                         #154.72
        vmulsd    %xmm3, %xmm0, %xmm4                           #155.72
        vmovsd    %xmm5, 800(%r8,%r12,8)                        #146.15
        vmovsd    %xmm10, 800(%rdi,%r12,8)                      #150.1
        vmovsd    %xmm15, 800(%rsi,%r12,8)                      #151.1
        vmovsd    792(%r10,%r12,8), %xmm5                       #156.24
        vmovsd    792(%r13,%r12,8), %xmm10                      #157.24
        vmovsd    792(%r15,%r12,8), %xmm15                      #158.24
        vmovsd    %xmm20, 800(%rcx,%r12,8)                      #152.1
        vmovsd    %xmm25, 800(%rdx,%r12,8)                      #153.1
        vmovsd    %xmm30, 800(%rax,%r12,8)                      #154.1
        vmovsd    %xmm4, 800(%r9,%r12,8)                        #155.1
        vaddsd    1600(%r10,%r12,8), %xmm5, %xmm6               #156.40
        vaddsd    1600(%r13,%r12,8), %xmm10, %xmm11             #157.40
        vaddsd    1600(%r15,%r12,8), %xmm15, %xmm16             #158.40
        vaddsd    808(%r10,%r12,8), %xmm6, %xmm7                #156.56
        vaddsd    808(%r13,%r12,8), %xmm11, %xmm12              #157.56
        vaddsd    808(%r15,%r12,8), %xmm16, %xmm17              #158.56
        .byte     102                                           #156.72
        .byte     144                                           #156.72
        vaddsd    (%r10,%r12,8), %xmm7, %xmm8                   #156.72
        vaddsd    (%r13,%r12,8), %xmm12, %xmm13                 #157.72
        vaddsd    (%r15,%r12,8), %xmm17, %xmm18                 #158.72
        vmulsd    %xmm8, %xmm0, %xmm9                           #156.72
        vmulsd    %xmm13, %xmm0, %xmm14                         #157.72
        vmulsd    %xmm18, %xmm0, %xmm19                         #158.72
        vmovsd    %xmm9, 800(%r10,%r12,8)                       #156.1
        vmovsd    %xmm14, 800(%r13,%r12,8)                      #157.1
        vmovsd    %xmm19, 800(%r15,%r12,8)                      #158.1
        incq      %r12                                          #145.35
        cmpq      $99, %r12                                     #145.27
...
..B1.36:                        # Preds ..B1.35
                                # Execution count [2.64e+01]
        movq      1592(%r8), %r12                               #160.18
        incl      %r11d                                         #141.31
        movq      %r12, 1600(%r8)                               #160.4
        movq      1592(%rdi), %r12                              #161.17
        movq      %r12, 1600(%rdi)                              #161.1
        movq      1592(%rsi), %r12                              #162.17
        movq      %r12, 1600(%rsi)                              #162.1
        movq      1592(%rcx), %r12                              #163.17
        movq      %r12, 1600(%rcx)                              #163.1
        movq      1592(%rdx), %r12                              #164.17
        movq      %r12, 1600(%rdx)                              #164.1
        movq      1592(%rax), %r12                              #165.17
        movq      %r12, 1600(%rax)                              #165.1
        movq      1592(%r9), %r12                               #166.17
        movq      %r12, 1600(%r9)                               #166.1
        movq      1592(%r10), %r12                              #167.17
        movq      %r12, 1600(%r10)                              #167.1
        movq      1592(%r13), %r12                              #168.17
        movq      %r12, 1600(%r13)                              #168.1
        movq      1592(%r15), %r12                              #169.17
        movq      %r12, 1600(%r15)                              #169.1
        cmpl      %ebx, %r11d                                   #141.22
...
..B1.40:                        # Preds ..B1.39
        ...
        vcvtsi2sdq 264(%rsp), %xmm0, %xmm0                      #174.15
        vcvtsi2sdq 256(%rsp), %xmm1, %xmm1                      #174.15
        vfmadd231sd .L_2il0floatpacket.0(%rip), %xmm0, %xmm1    #174.15
        movl      %r12d, %edi                                   #175.15
        vmovsd    %xmm1, 352(%rsp)                              #174.15[spill]
        movl      $8, %edx                                      #175.15
        lea       344(%rsp), %rsi                               #175.15
...
..B1.41:                        # Preds ..B1.40
                                # Execution count [5.27e+00]
        vmovsd    352(%rsp), %xmm16                             #177.20[spill]
        addl      %ebx, %ebx                                    #176.19
        vmovsd    .L_2il0floatpacket.4(%rip), %xmm0             #177.30
        vsubsd    232(%rsp), %xmm16, %xmm1                      #177.20[spill]
...
..B1.42:                        # Preds ..B1.41
                                # Execution count [9.49e-01]
        movl      %r12d, %edx                                   #
        lea       344(%rsp), %rsi                               #180.13
        movl      %edx, %edi                                    #180.13
        movl      $8, %edx                                      #180.13
        vmovsd    %xmm1, -112(%rsi)                             #[spill]
        movq      %r13, %r12                                    #
        movq      %r14, -120(%rsi)                              #[spill]
...
..B1.43:                        # Preds ..B1.42
        ...
        jge       ..B1.55       # Prob 59%                      #181.13
                                # LOE r12 r13 r14 r15 ebx
..B1.44:                        # Preds ..B1.43
                                # Execution count [2.58e-01]
        movq      280(%rsp), %rdi                               #182.2[spill]
...
..B1.55:                        # Preds ..B1.43
        ...
        movl      %ebx, %edx                                    #199.55
        vxorpd    %xmm4, %xmm4, %xmm4                           #199.46
        shrl      $31, %edx                                     #199.55
        vxorpd    %xmm6, %xmm6, %xmm6                           #199.40
        addl      %edx, %ebx                                    #179.17
        movl      $.L_2__STRING.4, %edi                         #202.3
        sarl      $1, %ebx                                      #179.17
        movl      $3, %eax                                      #202.3
        vcvtsi2sd %ebx, %xmm4, %xmm4                            #199.46
        vmovsd    .L_2il0floatpacket.4(%rip), %xmm3             #199.46
        vdivsd    %xmm4, %xmm3, %xmm8                           #199.46
        movq      344(%rsp), %rcx                               #199.33
        subq      224(%rsp), %rcx                               #199.33[spill]
        vcvtsi2sdq %rcx, %xmm6, %xmm6                           #199.40
        vmovsd    232(%rsp), %xmm2                              #200.72[spill]
        vmulsd    .L_2il0floatpacket.3(%rip), %xmm2, %xmm5      #200.72
        vmulsd    .L_2il0floatpacket.2(%rip), %xmm6, %xmm7      #199.52
        vmulsd    %xmm8, %xmm5, %xmm1                           #200.75
        vmulsd    %xmm8, %xmm7, %xmm0                           #199.55
...
..B1.59:                        # Preds ..B1.58
                                # Execution count [3.82e-01]
        movq      304(%rsp), %rdi                               #206.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #206.1
                                # LOE r12 r15
..B1.60:                        # Preds ..B1.59
                                # Execution count [3.82e-01]
        movq      312(%rsp), %rdi                               #207.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #207.1
                                # LOE r12 r15
..B1.61:                        # Preds ..B1.60
