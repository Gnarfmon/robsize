...
..B1.22:                        # Preds ..B1.21
        ...
        movl      %edx, 360(%rsp)                               #76.3[spill]
        xorb      %cl, %cl                                      #76.3
        vxorpd    %ymm0, %ymm0, %ymm0                           #78.19
        xorl      %eax, %eax                                    #76.3
        movq      %r15, 336(%rsp)                               #76.3[spill]
        movq      %r12, 328(%rsp)                               #76.3[spill]
        movq      %r13, 296(%rsp)                               #76.3[spill]
        movq      %r14, 288(%rsp)                               #76.3[spill]
                                # LOE rax cl ymm0
..B1.23:                        # Preds ..B1.25 ..B1.22
                                # Execution count [2.85e+00]
        movq      328(%rsp), %rdi                               #84.1[spill]
        xorl      %r14d, %r14d                                  #77.5
        movq      336(%rsp), %rbx                               #85.1[spill]
        movq      352(%rsp), %r15                               #87.1[spill]
        movq      344(%rsp), %rdx                               #86.1[spill]
        lea       (%rdi,%rax), %rsi                             #84.1
        movq      280(%rsp), %r13                               #78.7[spill]
        lea       (%rbx,%rax), %rdi                             #85.1
        movq      288(%rsp), %r12                               #79.1[spill]
        lea       (%r15,%rax), %rbx                             #87.1
        movq      264(%rsp), %r15                               #89.1[spill]
        movq      296(%rsp), %r11                               #80.1[spill]
        addq      %rax, %r13                                    #78.7
        movq      304(%rsp), %r10                               #81.1[spill]
        addq      %rax, %r12                                    #79.1
        movq      312(%rsp), %r9                                #82.1[spill]
        addq      %rax, %r15                                    #89.1
        movq      320(%rsp), %r8                                #83.1[spill]
        addq      %rax, %r11                                    #80.1
        movq      %rsi, 232(%rsp)                               #84.1[spill]
        lea       (%rdx,%rax), %rsi                             #86.1
        movq      272(%rsp), %rdx                               #88.1[spill]
        addq      %rax, %r10                                    #81.1
        addq      %rax, %r9                                     #82.1
...
..B1.26:                        # Preds ..B1.25
                                # Execution count [9.49e-01]
        movq      280(%rsp), %rcx                               #94.9[spill]
        xorl      %eax, %eax                                    #118.3
        vmovsd    .L_2il0floatpacket.4(%rip), %xmm0             #94.9
        movq      344(%rsp), %r9                                #110.2[spill]
        movq      352(%rsp), %r10                               #112.2[spill]
        ...
        movq      304(%rsp), %rbx                               #100.2[spill]
        movq      312(%rsp), %rsi                               #102.2[spill]
        movq      320(%rsp), %r8                                #104.2[spill]
        movq      272(%rsp), %r11                               #114.2[spill]
        ...
        movq      320(%rsp), %r9                                #118.3[spill]
        movq      312(%rsp), %r10                               #118.3[spill]
...
..B1.28:                        # Preds ..B1.27
        ...
        xorl      %eax, %eax                                    #118.3
        movq      304(%rsp), %rcx                               #118.3[spill]
        movq      280(%rsp), %rbx                               #118.3[spill]
        .align    16,0x90
...
..B1.34:                        # Preds ..B1.33
        ...
        movl      %ebx, 392(%rsp)                               #[spill]
        movl      %r12d, 360(%rsp)                              #[spill]
        movq      %r15, 368(%rsp)                               #[spill]
...
..B1.36:                        # Preds ..B1.34 ..B1.41
        ...
        xorl      %r15d, %r15d                                  #159.11
                                # LOE rdx rcx rbx rsi rdi r8 r9 r10 r11 r12 r13 r14 r15 eax xmm0
..B1.37:                        # Preds ..B1.37 ..B1.36
                                # Execution count [2.58e+03]
        vmovsd    800(%r8,%r15,8), %xmm1                        #161.19
        vmovsd    800(%rdi,%r15,8), %xmm6                       #164.25
        vmovsd    800(%rsi,%r15,8), %xmm11                      #165.25
        vmovsd    800(%rbx,%r15,8), %xmm16                      #166.24
        vmovsd    800(%rcx,%r15,8), %xmm21                      #167.24
        vmovsd    800(%rdx,%r15,8), %xmm26                      #168.24
        vmovsd    800(%r9,%r15,8), %xmm31                       #169.24
        vaddsd    1608(%r8,%r15,8), %xmm1, %xmm2                #161.33
        vaddsd    1608(%rdi,%r15,8), %xmm6, %xmm7               #164.42
        vaddsd    1608(%rsi,%r15,8), %xmm11, %xmm12             #165.42
        vaddsd    1608(%rbx,%r15,8), %xmm16, %xmm17             #166.40
        vaddsd    1608(%rcx,%r15,8), %xmm21, %xmm22             #167.40
        vaddsd    816(%r8,%r15,8), %xmm2, %xmm3                 #162.19
        vaddsd    816(%rdi,%r15,8), %xmm7, %xmm8                #164.59
        vaddsd    816(%rsi,%r15,8), %xmm12, %xmm13              #165.59
        vaddsd    1608(%rdx,%r15,8), %xmm26, %xmm27             #168.40
        vaddsd    1608(%r9,%r15,8), %xmm31, %xmm1               #169.40
        vaddsd    8(%r8,%r15,8), %xmm3, %xmm4                   #162.33
        vaddsd    8(%rdi,%r15,8), %xmm8, %xmm9                  #164.76
        vaddsd    8(%rsi,%r15,8), %xmm13, %xmm14                #165.76
        vaddsd    816(%rbx,%r15,8), %xmm17, %xmm18              #166.56
        vaddsd    816(%rcx,%r15,8), %xmm22, %xmm23              #167.56
        vmulsd    %xmm4, %xmm0, %xmm5                           #162.33
        vaddsd    816(%rdx,%r15,8), %xmm27, %xmm28              #168.56
        vaddsd    816(%r9,%r15,8), %xmm1, %xmm2                 #169.56
        vmulsd    %xmm9, %xmm0, %xmm10                          #164.76
        vaddsd    8(%rbx,%r15,8), %xmm18, %xmm19                #166.72
        vmulsd    %xmm14, %xmm0, %xmm15                         #165.76
        vaddsd    8(%rcx,%r15,8), %xmm23, %xmm24                #167.72
        vaddsd    8(%rdx,%r15,8), %xmm28, %xmm29                #168.72
        vaddsd    8(%r9,%r15,8), %xmm2, %xmm3                   #169.72
        vmulsd    %xmm19, %xmm0, %xmm20                         #166.72
        vmulsd    %xmm24, %xmm0, %xmm25                         #167.72
        vmulsd    %xmm29, %xmm0, %xmm30                         #168.72
        vmulsd    %xmm3, %xmm0, %xmm4                           #169.72
        vmovsd    %xmm5, 808(%r8,%r15,8)                        #160.15
        vmovsd    %xmm10, 808(%rdi,%r15,8)                      #164.1
        vmovsd    %xmm15, 808(%rsi,%r15,8)                      #165.1
        .byte     144                                           #170.24
        vmovsd    800(%r12,%r15,8), %xmm5                       #170.24
        vmovsd    800(%r10,%r15,8), %xmm10                      #171.24
        vmovsd    800(%r11,%r15,8), %xmm15                      #172.24
        vmovsd    %xmm20, 808(%rbx,%r15,8)                      #166.1
        vmovsd    %xmm25, 808(%rcx,%r15,8)                      #167.1
        vmovsd    %xmm30, 808(%rdx,%r15,8)                      #168.1
        vmovsd    %xmm4, 808(%r9,%r15,8)                        #169.1
        vaddsd    1608(%r12,%r15,8), %xmm5, %xmm6               #170.40
        vaddsd    1608(%r10,%r15,8), %xmm10, %xmm11             #171.40
        vaddsd    1608(%r11,%r15,8), %xmm15, %xmm16             #172.40
        vaddsd    816(%r12,%r15,8), %xmm6, %xmm7                #170.56
        vaddsd    816(%r10,%r15,8), %xmm11, %xmm12              #171.56
        vaddsd    816(%r11,%r15,8), %xmm16, %xmm17              #172.56
        vaddsd    8(%r12,%r15,8), %xmm7, %xmm8                  #170.72
        vaddsd    8(%r10,%r15,8), %xmm12, %xmm13                #171.72
        vaddsd    8(%r11,%r15,8), %xmm17, %xmm18                #172.72
        vmulsd    %xmm8, %xmm0, %xmm9                           #170.72
        vmulsd    %xmm13, %xmm0, %xmm14                         #171.72
        vmulsd    %xmm18, %xmm0, %xmm19                         #172.72
        vmovsd    %xmm9, 808(%r12,%r15,8)                       #170.1
        vmovsd    %xmm14, 808(%r10,%r15,8)                      #171.1
        vmovsd    %xmm19, 808(%r11,%r15,8)                      #172.1
        incq      %r15                                          #159.11
        cmpq      $98, %r15                                     #159.11
...
..B1.40:                        # Preds ..B1.40 ..B1.39
                                # Execution count [2.58e+03]
        vmovsd    800(%r14,%r15,8), %xmm1                       #173.24
        vmovsd    800(%r13,%r15,8), %xmm6                       #174.24
        vaddsd    1608(%r14,%r15,8), %xmm1, %xmm2               #173.40
        vaddsd    1608(%r13,%r15,8), %xmm6, %xmm7               #174.40
        vaddsd    816(%r14,%r15,8), %xmm2, %xmm3                #173.56
        vaddsd    816(%r13,%r15,8), %xmm7, %xmm8                #174.56
        vaddsd    8(%r14,%r15,8), %xmm3, %xmm4                  #173.72
        vaddsd    8(%r13,%r15,8), %xmm8, %xmm9                  #174.72
        vmulsd    %xmm4, %xmm0, %xmm5                           #173.72
        vmulsd    %xmm9, %xmm0, %xmm10                          #174.72
        vmovsd    %xmm5, 808(%r14,%r15,8)                       #173.1
        vmovsd    %xmm10, 808(%r13,%r15,8)                      #174.1
        incq      %r15                                          #159.11
        cmpq      $98, %r15                                     #159.11
...
..B1.41:                        # Preds ..B1.40
                                # Execution count [2.64e+01]
        movq      1592(%r8), %r15                               #176.18
        incl      %eax                                          #155.5
        movq      %r15, 1600(%r8)                               #176.4
        movq      1592(%rdi), %r15                              #177.18
        movq      %r15, 1600(%rdi)                              #177.1
        movq      1592(%rsi), %r15                              #178.18
        movq      %r15, 1600(%rsi)                              #178.1
        movq      1592(%rbx), %r15                              #179.17
        movq      %r15, 1600(%rbx)                              #179.1
        movq      1592(%rcx), %r15                              #180.17
        movq      %r15, 1600(%rcx)                              #180.1
        movq      1592(%rdx), %r15                              #181.17
        movq      %r15, 1600(%rdx)                              #181.1
        movq      1592(%r9), %r15                               #182.17
        movq      %r15, 1600(%r9)                               #182.1
        movq      1592(%r12), %r15                              #183.17
        movq      %r15, 1600(%r12)                              #183.1
        movq      1592(%r10), %r15                              #184.17
        movq      %r15, 1600(%r10)                              #184.1
        movq      1592(%r11), %r15                              #185.17
        movq      %r15, 1600(%r11)                              #185.1
        movq      1592(%r14), %r15                              #186.17
        movq      %r15, 1600(%r14)                              #186.1
        movq      1592(%r13), %r15                              #187.17
        movq      %r15, 1600(%r13)                              #187.1
        cmpl      392(%rsp), %eax                               #155.5[spill]
        jb        ..B1.36       # Prob 82%                      #155.5
                                # LOE rdx rcx rbx rsi rdi r8 r9 r10 r11 r12 r13 r14 eax xmm0
..B1.42:                        # Preds ..B1.41
                                # Execution count [4.75e+00]
        movq      368(%rsp), %r15                               #[spill]
        movl      392(%rsp), %ebx                               #[spill]
        movl      360(%rsp), %r12d                              #[spill]
                                # LOE r13 r14 r15 ebx r12d
...
..B1.45:                        # Preds ..B1.44
        ...
        vfmadd231sd .L_2il0floatpacket.0(%rip), %xmm0, %xmm1    #192.15
        movl      %r12d, %edi                                   #193.15
        vmovsd    %xmm1, 384(%rsp)                              #192.15[spill]
        movl      $8, %edx                                      #193.15
        lea       376(%rsp), %rsi                               #193.15
...
..B1.46:                        # Preds ..B1.45
                                # Execution count [5.27e+00]
        vmovsd    384(%rsp), %xmm16                             #195.20[spill]
        addl      %ebx, %ebx                                    #194.19
        vmovsd    .L_2il0floatpacket.4(%rip), %xmm0             #195.30
        vsubsd    224(%rsp), %xmm16, %xmm1                      #195.20[spill]
        vcomisd   %xmm1, %xmm0                                  #195.30
        ja        ..B1.31       # Prob 82%                      #195.30
                                # LOE r13 r14 r15 ebx r12d xmm1
..B1.47:                        # Preds ..B1.46
                                # Execution count [9.49e-01]
        movl      %r12d, %edx                                   #
        lea       376(%rsp), %rsi                               #198.13
        movl      %edx, %edi                                    #198.13
        movl      $8, %edx                                      #198.13
        vmovsd    %xmm1, -152(%rsi)                             #[spill]
...
..B1.48:                        # Preds ..B1.47
        ...
        jge       ..B1.62       # Prob 59%                      #199.13
                                # LOE r12 r13 r14 r15 ebx
..B1.49:                        # Preds ..B1.48
                                # Execution count [2.58e-01]
        movq      280(%rsp), %rdi                               #200.2[spill]
...
..B1.52:                        # Preds ..B1.51
                                # Execution count [2.58e-01]
        movq      304(%rsp), %rdi                               #203.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #203.1
                                # LOE r12 r15
..B1.53:                        # Preds ..B1.52
                                # Execution count [2.58e-01]
        movq      312(%rsp), %rdi                               #204.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #204.1
                                # LOE r12 r15
..B1.54:                        # Preds ..B1.53
                                # Execution count [2.58e-01]
        movq      320(%rsp), %rdi                               #205.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #205.1
                                # LOE r12 r15
..B1.55:                        # Preds ..B1.54
...
..B1.57:                        # Preds ..B1.56
                                # Execution count [2.58e-01]
        movq      344(%rsp), %rdi                               #208.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #208.1
                                # LOE
..B1.58:                        # Preds ..B1.57
                                # Execution count [2.58e-01]
        movq      352(%rsp), %rdi                               #209.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #209.1
                                # LOE
..B1.59:                        # Preds ..B1.58
                                # Execution count [2.58e-01]
        movq      272(%rsp), %rdi                               #210.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #210.1
                                # LOE
..B1.60:                        # Preds ..B1.59
                                # Execution count [2.58e-01]
        movq      264(%rsp), %rdi                               #211.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #211.1
                                # LOE
..B1.61:                        # Preds ..B1.60
...
..B1.62:                        # Preds ..B1.48
        ...
        movl      %ebx, %edx                                    #219.55
        vxorpd    %xmm4, %xmm4, %xmm4                           #219.46
        shrl      $31, %edx                                     #219.55
        vxorpd    %xmm6, %xmm6, %xmm6                           #219.40
        addl      %edx, %ebx                                    #197.17
        movl      $.L_2__STRING.4, %edi                         #222.3
        sarl      $1, %ebx                                      #197.17
        movl      $3, %eax                                      #222.3
        vcvtsi2sd %ebx, %xmm4, %xmm4                            #219.46
        vmovsd    .L_2il0floatpacket.4(%rip), %xmm3             #219.46
        vdivsd    %xmm4, %xmm3, %xmm8                           #219.46
        movq      376(%rsp), %rcx                               #219.33
        subq      368(%rsp), %rcx                               #219.33[spill]
        vcvtsi2sdq %rcx, %xmm6, %xmm6                           #219.40
        vmovsd    224(%rsp), %xmm2                              #220.72[spill]
        vmulsd    .L_2il0floatpacket.3(%rip), %xmm2, %xmm5      #220.72
        vmulsd    .L_2il0floatpacket.2(%rip), %xmm6, %xmm7      #219.52
        vmulsd    %xmm8, %xmm5, %xmm1                           #220.75
        vmulsd    %xmm8, %xmm7, %xmm0                           #219.55
...
..B1.66:                        # Preds ..B1.65
                                # Execution count [3.82e-01]
        movq      304(%rsp), %rdi                               #226.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #226.1
                                # LOE r12 r15
..B1.67:                        # Preds ..B1.66
                                # Execution count [3.82e-01]
        movq      312(%rsp), %rdi                               #227.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #227.1
                                # LOE r12 r15
..B1.68:                        # Preds ..B1.67
                                # Execution count [3.82e-01]
        movq      320(%rsp), %rdi                               #228.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #228.1
                                # LOE r12 r15
..B1.69:                        # Preds ..B1.68
...
..B1.72:                        # Preds ..B1.71
                                # Execution count [3.82e-01]
        movq      352(%rsp), %rdi                               #232.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #232.1
                                # LOE
..B1.73:                        # Preds ..B1.72
                                # Execution count [3.82e-01]
        movq      272(%rsp), %rdi                               #233.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #233.1
                                # LOE
..B1.74:                        # Preds ..B1.73
                                # Execution count [3.82e-01]
        movq      264(%rsp), %rdi                               #234.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #234.1
                                # LOE
..B1.75:                        # Preds ..B1.74
...
..B1.77:                        # Preds ..B1.76
                                # Execution count [5.10e-02]: Infreq
        cmpq      $0, 280(%rsp)                                 #62.14[spill]
        je        ..B1.79       # Prob 32%                      #62.14
                                # LOE r12 r13 r14 r15
..B1.78:                        # Preds ..B1.77
                                # Execution count [3.44e-02]: Infreq
        movq      280(%rsp), %rdi                               #62.5[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #62.5
                                # LOE r12 r13 r14 r15
...
..B1.83:                        # Preds ..B1.81 ..B1.82
                                # Execution count [5.10e-02]: Infreq
        cmpq      $0, 304(%rsp)                                 #65.10[spill]
        je        ..B1.85       # Prob 32%                      #65.10
                                # LOE r12 r15
..B1.84:                        # Preds ..B1.83
                                # Execution count [3.44e-02]: Infreq
        movq      304(%rsp), %rdi                               #65.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #65.1
                                # LOE r12 r15
..B1.85:                        # Preds ..B1.83 ..B1.84
                                # Execution count [5.10e-02]: Infreq
        cmpq      $0, 312(%rsp)                                 #66.10[spill]
        je        ..B1.87       # Prob 32%                      #66.10
                                # LOE r12 r15
..B1.86:                        # Preds ..B1.85
                                # Execution count [3.44e-02]: Infreq
        movq      312(%rsp), %rdi                               #66.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #66.1
                                # LOE r12 r15
...
..B1.93:                        # Preds ..B1.91 ..B1.92
                                # Execution count [5.10e-02]: Infreq
        cmpq      $0, 344(%rsp)                                 #70.10[spill]
        je        ..B1.95       # Prob 32%                      #70.10
                                # LOE
..B1.94:                        # Preds ..B1.93
                                # Execution count [3.44e-02]: Infreq
        movq      344(%rsp), %rdi                               #70.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #70.1
                                # LOE
...
..B1.97:                        # Preds ..B1.95 ..B1.96
                                # Execution count [5.10e-02]: Infreq
        cmpq      $0, 272(%rsp)                                 #72.10[spill]
        je        ..B1.99       # Prob 32%                      #72.10
                                # LOE
..B1.98:                        # Preds ..B1.97
                                # Execution count [3.44e-02]: Infreq
        movq      272(%rsp), %rdi                               #72.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #72.1
                                # LOE
...
..L226:
	...
	.cfi_def_cfa_offset 32
        movl      $1, %edi                                      #6.3
        lea       (%rsp), %rsi                                  #6.3
..___tag_value__Z12getTimeStampv.228:
#       clock_gettime(clockid_t, timespec *)
...
..L233:
	...
	.cfi_def_cfa_offset 32
        movl      $1, %edi                                      #13.3
        lea       (%rsp), %rsi                                  #13.3
..___tag_value__Z17getTimeResolutionv.235:
