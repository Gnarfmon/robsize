...
..B1.13:                        # Preds ..B1.65
                                # Execution count [1.00e+00]
        movq      %r12, 128(%rsp)                               #46.3[spill]
        xorb      %dl, %dl                                      #46.3
        vxorpd    %ymm0, %ymm0, %ymm0                           #48.19
        xorl      %eax, %eax                                    #46.3
        movq      %r15, 112(%rsp)                               #46.3[spill]
        movq      %r13, 160(%rsp)                               #46.3[spill]
        movq      %r14, 152(%rsp)                               #46.3[spill]
                                # LOE rax dl ymm0
..B1.14:                        # Preds ..B1.16 ..B1.13
                                # Execution count [3.00e+00]
        movq      120(%rsp), %rdi                               #54.1[spill]
        xorl      %r14d, %r14d                                  #47.5
        movq      128(%rsp), %rbx                               #55.1[spill]
        movq      144(%rsp), %r15                               #57.1[spill]
        movq      136(%rsp), %rcx                               #56.1[spill]
        lea       (%rdi,%rax), %rsi                             #54.1
        movq      88(%rsp), %r13                                #48.7[spill]
        lea       (%rbx,%rax), %rdi                             #55.1
        movq      152(%rsp), %r12                               #49.1[spill]
        lea       (%r15,%rax), %rbx                             #57.1
        movq      40(%rsp), %r15                                #59.1[spill]
        movq      160(%rsp), %r11                               #50.1[spill]
        addq      %rax, %r13                                    #48.7
        movq      96(%rsp), %r10                                #51.1[spill]
        addq      %rax, %r12                                    #49.1
        movq      104(%rsp), %r9                                #52.1[spill]
        addq      %rax, %r15                                    #59.1
        movq      112(%rsp), %r8                                #53.1[spill]
        addq      %rax, %r11                                    #50.1
        movq      %rsi, 8(%rsp)                                 #54.1[spill]
        lea       (%rcx,%rax), %rsi                             #56.1
        movq      48(%rsp), %rcx                                #58.1[spill]
        addq      %rax, %r10                                    #51.1
        addq      %rax, %r9                                     #52.1
...
..B1.17:                        # Preds ..B1.16
                                # Execution count [1.00e+00]
        movq      144(%rsp), %r8                                #82.3[spill]
        movq      48(%rsp), %r9                                 #84.3[spill]
        movq      88(%rsp), %rax                                #64.9[spill]
        movq      96(%rsp), %rdx                                #70.3[spill]
        movq      104(%rsp), %rcx                               #72.3[spill]
        movq      120(%rsp), %rbx                               #76.3[spill]
        movq      136(%rsp), %rsi                               #80.3[spill]
        movq      40(%rsp), %r10                                #86.3[spill]
        ...
        movq      120(%rsp), %r8                                #88.3[spill]
        movq      104(%rsp), %r9                                #88.3[spill]
...
..B1.19:                        # Preds ..B1.18
        ...
        xorl      %eax, %eax                                    #88.3
        movq      96(%rsp), %rdx                                #88.3[spill]
        movq      88(%rsp), %rcx                                #88.3[spill]
        .align    16,0x90
...
..B1.22:                        # Preds ..B1.21
        ...
        movq      %r12, 128(%rsp)                               #129.27[spill]
        vmovsd    %xmm1, 32(%rsp)                               #129.27[spill]
        movl      %ebx, 56(%rsp)                                #129.27[spill]
        movq      %r15, 112(%rsp)                               #129.27[spill]
        movq      %r13, 160(%rsp)                               #129.27[spill]
        movq      %r14, 152(%rsp)                               #129.27[spill]
        movq      48(%rsp), %r12                                #129.27[spill]
        jmp       ..B1.23       # Prob 100%                     #129.27
                                # LOE r12
..B1.36:                        # Preds ..B1.35
                                # Execution count [4.10e+00]
        movl      %ebx, 56(%rsp)                                #[spill]
                                # LOE r12
..B1.23:                        # Preds ..B1.22 ..B1.36
                                # Execution count [5.00e+00]
        movq      88(%rsp), %r14                                #145.16[spill]
        xorl      %ebx, %ebx                                    #145.4
        movq      40(%rsp), %r15                                #156.15[spill]
        movq      152(%rsp), %rcx                               #146.16[spill]
        movq      160(%rsp), %rdx                               #147.16[spill]
        movq      96(%rsp), %r11                                #148.15[spill]
        movq      104(%rsp), %rdi                               #149.15[spill]
        movq      112(%rsp), %r8                                #150.15[spill]
        movq      120(%rsp), %rsi                               #151.15[spill]
        movq      128(%rsp), %r9                                #152.15[spill]
        movq      136(%rsp), %r10                               #153.15[spill]
        movq      144(%rsp), %rax                               #154.15[spill]
        movq      1592(%r14), %r14                              #145.16
        movq      1592(%r12), %r13                              #155.15
        movq      1592(%r15), %r15                              #156.15
        movq      %r14, 72(%rsp)                                #156.15[spill]
        movq      1592(%rcx), %rcx                              #146.16
        movq      1592(%rdx), %rdx                              #147.16
        movq      1592(%r11), %r11                              #148.15
        movq      1592(%rdi), %rdi                              #149.15
        movq      1592(%r8), %r8                                #150.15
        movq      1592(%rsi), %rsi                              #151.15
        movq      1592(%r9), %r9                                #152.15
        movq      1592(%r10), %r10                              #153.15
        movq      1592(%rax), %rax                              #154.15
        movq      %r15, 64(%rsp)                                #156.15[spill]
        movq      %r13, 80(%rsp)                                #156.15[spill]
        vmovsd    .L_2il0floatpacket.1(%rip), %xmm0             #156.15
        movq      40(%rsp), %r14                                #156.15[spill]
                                # LOE rax rdx rcx rsi rdi r8 r9 r10 r11 r12 r14 ebx xmm0
..B1.25:                        # Preds ..B1.23 ..B1.30
                                # Execution count [2.78e+01]
        movq      %rsi, 168(%rsp)                               #128.11[spill]
        xorl      %r13d, %r13d                                  #128.11
        movq      %r8, 176(%rsp)                                #128.11[spill]
        movq      %rdi, 184(%rsp)                               #128.11[spill]
        movq      %r11, 192(%rsp)                               #128.11[spill]
        movq      %rdx, 200(%rsp)                               #128.11[spill]
        movq      %rcx, 208(%rsp)                               #128.11[spill]
        movl      %ebx, 216(%rsp)                               #128.11[spill]
        movq      144(%rsp), %rdx                               #128.11[spill]
        movq      136(%rsp), %rcx                               #128.11[spill]
        movq      128(%rsp), %rbx                               #128.11[spill]
        movq      120(%rsp), %rsi                               #128.11[spill]
        movq      112(%rsp), %rdi                               #128.11[spill]
        movq      104(%rsp), %r8                                #128.11[spill]
        movq      96(%rsp), %r11                                #128.11[spill]
        movq      160(%rsp), %r12                               #128.11[spill]
        movq      152(%rsp), %r14                               #128.11[spill]
        movq      88(%rsp), %r15                                #128.11[spill]
                                # LOE rax rdx rcx rbx rsi rdi r8 r9 r10 r11 r12 r13 r14 r15 xmm0
..B1.26:                        # Preds ..B1.26 ..B1.25
                                # Execution count [2.72e+03]
        vmovsd    800(%r15,%r13,8), %xmm1                       #130.19
        vmovsd    800(%r14,%r13,8), %xmm6                       #133.25
        vmovsd    800(%r12,%r13,8), %xmm11                      #134.25
        vmovsd    800(%r11,%r13,8), %xmm16                      #135.24
        vmovsd    800(%r8,%r13,8), %xmm21                       #136.24
        vmovsd    800(%rdi,%r13,8), %xmm26                      #137.24
        vmovsd    800(%rsi,%r13,8), %xmm31                      #138.24
        vaddsd    1608(%r15,%r13,8), %xmm1, %xmm2               #130.33
        vaddsd    1608(%r14,%r13,8), %xmm6, %xmm7               #133.42
        vaddsd    1608(%r12,%r13,8), %xmm11, %xmm12             #134.42
        vaddsd    1608(%r11,%r13,8), %xmm16, %xmm17             #135.40
        vaddsd    1608(%r8,%r13,8), %xmm21, %xmm22              #136.40
        vaddsd    816(%r15,%r13,8), %xmm2, %xmm3                #131.19
        vaddsd    816(%r14,%r13,8), %xmm7, %xmm8                #133.59
        vaddsd    816(%r12,%r13,8), %xmm12, %xmm13              #134.59
        vaddsd    1608(%rdi,%r13,8), %xmm26, %xmm27             #137.40
        vaddsd    1608(%rsi,%r13,8), %xmm31, %xmm1              #138.40
        vaddsd    8(%r15,%r13,8), %xmm3, %xmm4                  #131.33
        vaddsd    8(%r14,%r13,8), %xmm8, %xmm9                  #133.76
        vaddsd    8(%r12,%r13,8), %xmm13, %xmm14                #134.76
        vaddsd    816(%r11,%r13,8), %xmm17, %xmm18              #135.56
        vaddsd    816(%r8,%r13,8), %xmm22, %xmm23               #136.56
        vmulsd    %xmm4, %xmm0, %xmm5                           #131.33
        vaddsd    816(%rdi,%r13,8), %xmm27, %xmm28              #137.56
        vaddsd    816(%rsi,%r13,8), %xmm1, %xmm2                #138.56
        vmulsd    %xmm9, %xmm0, %xmm10                          #133.76
        vaddsd    8(%r11,%r13,8), %xmm18, %xmm19                #135.72
        vmulsd    %xmm14, %xmm0, %xmm15                         #134.76
        vaddsd    8(%r8,%r13,8), %xmm23, %xmm24                 #136.72
        vaddsd    8(%rdi,%r13,8), %xmm28, %xmm29                #137.72
        vaddsd    8(%rsi,%r13,8), %xmm2, %xmm3                  #138.72
        vmulsd    %xmm19, %xmm0, %xmm20                         #135.72
        vmulsd    %xmm24, %xmm0, %xmm25                         #136.72
        vmulsd    %xmm29, %xmm0, %xmm30                         #137.72
        vmulsd    %xmm3, %xmm0, %xmm4                           #138.72
        vmovsd    %xmm5, 808(%r15,%r13,8)                       #129.15
        vmovsd    %xmm10, 808(%r14,%r13,8)                      #133.1
        vmovsd    %xmm15, 808(%r12,%r13,8)                      #134.1
        .byte     144                                           #139.24
        vmovsd    800(%rbx,%r13,8), %xmm5                       #139.24
        vmovsd    800(%rcx,%r13,8), %xmm10                      #140.24
        vmovsd    800(%rdx,%r13,8), %xmm15                      #141.24
        vmovsd    %xmm20, 808(%r11,%r13,8)                      #135.1
        vmovsd    %xmm25, 808(%r8,%r13,8)                       #136.1
        vmovsd    %xmm30, 808(%rdi,%r13,8)                      #137.1
        vmovsd    %xmm4, 808(%rsi,%r13,8)                       #138.1
        vaddsd    1608(%rbx,%r13,8), %xmm5, %xmm6               #139.40
        vaddsd    1608(%rcx,%r13,8), %xmm10, %xmm11             #140.40
        vaddsd    1608(%rdx,%r13,8), %xmm15, %xmm16             #141.40
        vaddsd    816(%rbx,%r13,8), %xmm6, %xmm7                #139.56
        vaddsd    816(%rcx,%r13,8), %xmm11, %xmm12              #140.56
        vaddsd    816(%rdx,%r13,8), %xmm16, %xmm17              #141.56
        vaddsd    8(%rbx,%r13,8), %xmm7, %xmm8                  #139.72
        vaddsd    8(%rcx,%r13,8), %xmm12, %xmm13                #140.72
        vaddsd    8(%rdx,%r13,8), %xmm17, %xmm18                #141.72
        vmulsd    %xmm8, %xmm0, %xmm9                           #139.72
        vmulsd    %xmm13, %xmm0, %xmm14                         #140.72
        vmulsd    %xmm18, %xmm0, %xmm19                         #141.72
        vmovsd    %xmm9, 808(%rbx,%r13,8)                       #139.1
        vmovsd    %xmm14, 808(%rcx,%r13,8)                      #140.1
        vmovsd    %xmm19, 808(%rdx,%r13,8)                      #141.1
        incq      %r13                                          #128.11
        cmpq      $98, %r13                                     #128.11
...
..B1.27:                        # Preds ..B1.26
                                # Execution count [2.78e+01]
        movq      168(%rsp), %rsi                               #[spill]
        movq      176(%rsp), %r8                                #[spill]
        movq      184(%rsp), %rdi                               #[spill]
        movq      192(%rsp), %r11                               #[spill]
        movq      200(%rsp), %rdx                               #[spill]
        movq      208(%rsp), %rcx                               #[spill]
        movl      216(%rsp), %ebx                               #[spill]
...
..B1.28:                        # Preds ..B1.27
        ...
        xorl      %r13d, %r13d                                  #128.11
        .align    16,0x90
                                # LOE rax rdx rcx rsi rdi r8 r9 r10 r11 r12 r13 r14 ebx xmm0
..B1.29:                        # Preds ..B1.29 ..B1.28
                                # Execution count [2.72e+03]
        vmovsd    800(%r12,%r13,8), %xmm1                       #142.24
        vmovsd    800(%r14,%r13,8), %xmm6                       #143.24
        vaddsd    1608(%r12,%r13,8), %xmm1, %xmm2               #142.40
        vaddsd    1608(%r14,%r13,8), %xmm6, %xmm7               #143.40
        vaddsd    816(%r12,%r13,8), %xmm2, %xmm3                #142.56
        vaddsd    816(%r14,%r13,8), %xmm7, %xmm8                #143.56
        vaddsd    8(%r12,%r13,8), %xmm3, %xmm4                  #142.72
        vaddsd    8(%r14,%r13,8), %xmm8, %xmm9                  #143.72
        vmulsd    %xmm4, %xmm0, %xmm5                           #142.72
        vmulsd    %xmm9, %xmm0, %xmm10                          #143.72
        vmovsd    %xmm5, 808(%r12,%r13,8)                       #142.1
        vmovsd    %xmm10, 808(%r14,%r13,8)                      #143.1
        incq      %r13                                          #128.11
        cmpq      $98, %r13                                     #128.11
...
..B1.30:                        # Preds ..B1.29
                                # Execution count [2.78e+01]
        movq      88(%rsp), %r15                                #145.4[spill]
        incl      %ebx                                          #124.5
        movq      72(%rsp), %r13                                #145.4[spill]
        movq      %r13, 800(%r15)                               #145.4
        movq      152(%rsp), %r13                               #146.1[spill]
        movq      160(%rsp), %r15                               #147.1[spill]
        movq      %rcx, 800(%r13)                               #146.1
        movq      96(%rsp), %r13                                #148.1[spill]
        movq      %rdx, 800(%r15)                               #147.1
        movq      104(%rsp), %r15                               #149.1[spill]
        movq      %r11, 800(%r13)                               #148.1
        movq      112(%rsp), %r13                               #150.1[spill]
        movq      %rdi, 800(%r15)                               #149.1
        movq      120(%rsp), %r15                               #151.1[spill]
        movq      %r8, 800(%r13)                                #150.1
        movq      128(%rsp), %r13                               #152.1[spill]
        movq      %rsi, 800(%r15)                               #151.1
        movq      136(%rsp), %r15                               #153.1[spill]
        movq      %r9, 800(%r13)                                #152.1
        movq      144(%rsp), %r13                               #154.1[spill]
        movq      %r10, 800(%r15)                               #153.1
        movq      80(%rsp), %r15                                #155.1[spill]
        movq      %rax, 800(%r13)                               #154.1
        movq      64(%rsp), %r13                                #156.1[spill]
        movq      %r15, 800(%r12)                               #155.1
        movq      %r13, 800(%r14)                               #156.1
        cmpl      56(%rsp), %ebx                                #124.5[spill]
...
..B1.33:                        # Preds ..B1.32
        ...
        vsubsd    32(%rsp), %xmm16, %xmm0                       #162.20[spill]
...
..B1.35:                        # Preds ..B1.34
        ...
        vmovsd    %xmm1, 32(%rsp)                               #122.17[spill]
        testl     %ebx, %ebx                                    #124.22
        jle       ..B1.32       # Prob 10%                      #124.22
        jmp       ..B1.36       # Prob 100%                     #124.22
                                # LOE r12 ebx
..B1.37:                        # Preds ..B1.33
...
..B1.41:                        # Preds ..B1.40
                                # Execution count [6.74e-01]: Infreq
        movq      96(%rsp), %rdi                                #175.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #175.1
                                # LOE r12 r15
..B1.42:                        # Preds ..B1.41
                                # Execution count [6.74e-01]: Infreq
        movq      104(%rsp), %rdi                               #176.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #176.1
                                # LOE r12 r15
..B1.43:                        # Preds ..B1.42
...
..B1.46:                        # Preds ..B1.45
                                # Execution count [6.74e-01]: Infreq
        movq      136(%rsp), %rdi                               #180.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #180.1
                                # LOE
..B1.47:                        # Preds ..B1.46
                                # Execution count [6.74e-01]: Infreq
        movq      144(%rsp), %rdi                               #181.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #181.1
                                # LOE
..B1.48:                        # Preds ..B1.47
