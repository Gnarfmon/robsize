...
..B1.8:                         # Preds ..B1.10 ..B1.7
        ...
        movq      32(%rsp), %rdi                                #47.1[spill]
        xorl      %esi, %esi                                    #41.5
        lea       (%r15,%rax), %r8                              #42.7
        lea       (%r14,%rax), %r9                              #43.1
        lea       (%r13,%rax), %r10                             #44.1
...
..B1.11:                        # Preds ..B1.10
        ...
        vmovsd    %xmm0, 800(%r14)                              #54.3
        vmovsd    %xmm0, 1592(%r14)                             #53.1
        vmovsd    %xmm0, 800(%r13)                              #56.3
        vmovsd    %xmm0, 1592(%r13)                             #55.1
        vmovsd    %xmm0, 800(%r12)                              #58.3
        ...
        vmovsd    %xmm0, 1600(%r14)                             #54.3
        vmovsd    %xmm0, 2392(%r14)                             #53.1
        vmovsd    %xmm0, 1600(%r13)                             #56.3
        vmovsd    %xmm0, 2392(%r13)                             #55.1
        vmovsd    %xmm0, 1600(%r12)                             #58.3
        ...
        xorl      %edx, %edx                                    #64.3
        movq      32(%rsp), %rcx                                #64.3[spill]
        .align    16,0x90
                                # LOE rdx rcx rbx r12 r13 r14 r15 xmm0
..B1.12:                        # Preds ..B1.12 ..B1.11
                                # Execution count [1.00e+02]
        vmovsd    %xmm0, (%rcx,%rdx,8)                          #75.1
        vmovsd    %xmm0, 1600(%rcx,%rdx,8)                      #76.2
        vmovsd    %xmm0, (%rbx,%rdx,8)                          #73.1
        vmovsd    %xmm0, 1600(%rbx,%rdx,8)                      #74.2
        vmovsd    %xmm0, (%r12,%rdx,8)                          #71.1
        vmovsd    %xmm0, 1600(%r12,%rdx,8)                      #72.2
        vmovsd    %xmm0, (%r13,%rdx,8)                          #69.1
        vmovsd    %xmm0, 1600(%r13,%rdx,8)                      #70.2
        vmovsd    %xmm0, (%r14,%rdx,8)                          #67.1
        vmovsd    %xmm0, 1600(%r14,%rdx,8)                      #68.2
        vmovsd    %xmm0, (%r15,%rdx,8)                          #65.9
        vmovsd    %xmm0, 1600(%r15,%rdx,8)                      #66.9
        incq      %rdx                                          #64.3
        cmpq      $100, %rdx                                    #64.3
...
..B1.14:                        # Preds ..B1.13
        ...
        vcvtsi2sdq 8(%rsp), %xmm0, %xmm0                        #86.17
        vcvtsi2sdq (%rsp), %xmm1, %xmm1                         #86.17
        vmovsd    .L_2il0floatpacket.0(%rip), %xmm2             #86.17
        movq      %r14, %rax                                    #93.27
        vfmadd231sd %xmm2, %xmm0, %xmm1                         #86.17
        movq      %r15, %rdi                                    #93.27
        vmovsd    %xmm1, 56(%rsp)                               #93.27[spill]
        movl      64(%rsp), %r14d                               #93.27[spill]
        movq      32(%rsp), %r15                                #93.27[spill]
        jmp       ..B1.15       # Prob 100%                     #93.27
                                # LOE rax rbx rdi r12 r13 r15 r14d
..B1.25:                        # Preds ..B1.24
                                # Execution count [4.10e+00]
        movq      48(%rsp), %rax                                #[spill]
        movq      40(%rsp), %rdi                                #[spill]
                                # LOE rax rbx rdi r12 r13 r15 r14d
..B1.15:                        # Preds ..B1.14 ..B1.25
                                # Execution count [5.00e+00]
        movq      1592(%rdi), %rsi                              #103.16
        xorl      %ecx, %ecx                                    #103.4
        movq      1592(%rax), %r8                               #104.15
        movq      1592(%r13), %r9                               #105.15
        movq      1592(%r12), %r10                              #106.15
        movq      1592(%rbx), %r11                              #107.15
        movq      1592(%r15), %rdx                              #108.15
        movl      %r14d, 64(%rsp)                               #108.15[spill]
        vmovsd    .L_2il0floatpacket.1(%rip), %xmm0             #108.15
                                # LOE rax rdx rbx rsi rdi r8 r9 r10 r11 r12 r13 r15 ecx xmm0
..B1.17:                        # Preds ..B1.15 ..B1.19
                                # Execution count [2.78e+01]
        xorl      %r14d, %r14d                                  #92.11
                                # LOE rax rdx rbx rsi rdi r8 r9 r10 r11 r12 r13 r14 r15 ecx xmm0
..B1.18:                        # Preds ..B1.18 ..B1.17
                                # Execution count [2.72e+03]
        vmovsd    800(%rdi,%r14,8), %xmm1                       #94.19
        vmovsd    800(%rax,%r14,8), %xmm6                       #97.24
        vmovsd    800(%r13,%r14,8), %xmm11                      #98.24
        vmovsd    800(%r12,%r14,8), %xmm16                      #99.24
        vmovsd    800(%rbx,%r14,8), %xmm21                      #100.24
        vmovsd    800(%r15,%r14,8), %xmm26                      #101.24
        vaddsd    1608(%rdi,%r14,8), %xmm1, %xmm2               #94.33
        vaddsd    1608(%rax,%r14,8), %xmm6, %xmm7               #97.40
        vaddsd    1608(%r13,%r14,8), %xmm11, %xmm12             #98.40
        vaddsd    1608(%r12,%r14,8), %xmm16, %xmm17             #99.40
        vaddsd    1608(%rbx,%r14,8), %xmm21, %xmm22             #100.40
        vaddsd    1608(%r15,%r14,8), %xmm26, %xmm27             #101.40
        vaddsd    816(%rdi,%r14,8), %xmm2, %xmm3                #95.19
        vaddsd    816(%rax,%r14,8), %xmm7, %xmm8                #97.56
        vaddsd    816(%r13,%r14,8), %xmm12, %xmm13              #98.56
        vaddsd    816(%r12,%r14,8), %xmm17, %xmm18              #99.56
        vaddsd    816(%rbx,%r14,8), %xmm22, %xmm23              #100.56
        vaddsd    816(%r15,%r14,8), %xmm27, %xmm28              #101.56
        vaddsd    8(%rdi,%r14,8), %xmm3, %xmm4                  #95.33
        vaddsd    8(%rax,%r14,8), %xmm8, %xmm9                  #97.72
        vaddsd    8(%r13,%r14,8), %xmm13, %xmm14                #98.72
        vaddsd    8(%r12,%r14,8), %xmm18, %xmm19                #99.72
        vaddsd    8(%rbx,%r14,8), %xmm23, %xmm24                #100.72
        vmulsd    %xmm4, %xmm0, %xmm5                           #95.33
        vaddsd    8(%r15,%r14,8), %xmm28, %xmm29                #101.72
        ...
        vmovsd    %xmm5, 808(%rdi,%r14,8)                       #93.15
        vmovsd    %xmm10, 808(%rax,%r14,8)                      #97.1
        vmovsd    %xmm15, 808(%r13,%r14,8)                      #98.1
        vmovsd    %xmm20, 808(%r12,%r14,8)                      #99.1
        vmovsd    %xmm25, 808(%rbx,%r14,8)                      #100.1
        vmovsd    %xmm30, 808(%r15,%r14,8)                      #101.1
        incq      %r14                                          #92.11
        cmpq      $98, %r14                                     #92.11
...
..B1.19:                        # Preds ..B1.18
                                # Execution count [2.78e+01]
        incl      %ecx                                          #88.5
        movq      %rsi, 800(%rdi)                               #103.4
        movq      %r8, 800(%rax)                                #104.1
        movq      %r9, 800(%r13)                                #105.1
        movq      %r10, 800(%r12)                               #106.1
        movq      %r11, 800(%rbx)                               #107.1
        movq      %rdx, 800(%r15)                               #108.1
        cmpl      64(%rsp), %ecx                                #88.5[spill]
        jb        ..B1.17       # Prob 82%                      #88.5
                                # LOE rax rdx rbx rsi rdi r8 r9 r10 r11 r12 r13 r15 ecx xmm0
..B1.20:                        # Preds ..B1.19
                                # Execution count [5.10e+00]
        movl      64(%rsp), %r14d                               #[spill]
        movq      %rax, 48(%rsp)                                #[spill]
        movq      %rdi, 40(%rsp)                                #[spill]
                                # LOE rbx r12 r13 r15 r14d
..B1.21:                        # Preds ..B1.24 ..B1.20
                                # Execution count [5.56e+00]
        movl      $1, %edi                                      #112.15
        lea       16(%rsp), %rsi                                #112.15
...
..B1.24:                        # Preds ..B1.23
        ...
        vmovsd    %xmm1, 56(%rsp)                               #86.17[spill]
        testl     %r14d, %r14d                                  #88.22
        jle       ..B1.21       # Prob 10%                      #88.22
        jmp       ..B1.25       # Prob 100%                     #88.22
                                # LOE rbx r12 r13 r15 r14d
..B1.26:                        # Preds ..B1.22
                                # Execution count [1.00e+00]: Infreq
        movl      %r14d, 64(%rsp)                               #[spill]
...
..___tag_value__Z12getTimeStampv.64:
...
..___tag_value__Z17getTimeResolutionv.71:
                                # LOE rbx rbp r12 r13 r14 r15
..B3.2:                         # Preds ..B3.1
                                # Execution count [1.00e+00]
