...
..B1.14:                        # Preds ..B1.68
        ...
        movq      %r12, 152(%rsp)                               #47.3[spill]
        movq      %r14, 128(%rsp)                               #47.3[spill]
        movq      %r15, 120(%rsp)                               #47.3[spill]
        movq      %r13, 176(%rsp)                               #47.3[spill]
                                # LOE ymm0
..B1.15:                        # Preds ..B1.17 ..B1.14
                                # Execution count [3.00e+00]
        movq      112(%rsp), %r12                               #49.7[spill]
        xorl      %r14d, %r14d                                  #48.5
        movq      8(%rsp), %r13                                 #49.7[spill]
        movq      176(%rsp), %r10                               #50.1[spill]
        movq      184(%rsp), %r9                                #51.1[spill]
        movq      120(%rsp), %r8                                #52.1[spill]
        lea       (%r12,%r13), %r11                             #49.7
        movq      128(%rsp), %rdi                               #53.1[spill]
        lea       (%r10,%r13), %r12                             #50.1
        movq      136(%rsp), %rsi                               #54.1[spill]
        movq      144(%rsp), %rbx                               #55.1[spill]
        lea       (%r8,%r13), %r10                              #52.1
        movq      152(%rsp), %rcx                               #56.1[spill]
        movq      160(%rsp), %rdx                               #57.1[spill]
        lea       (%rsi,%r13), %r8                              #54.1
        movq      168(%rsp), %rax                               #58.1[spill]
        movq      56(%rsp), %r15                                #59.1[spill]
...
..B1.18:                        # Preds ..B1.17
                                # Execution count [1.00e+00]
        movq      168(%rsp), %r8                                #84.3[spill]
        movq      56(%rsp), %r9                                 #86.3[spill]
        movq      48(%rsp), %r10                                #88.3[spill]
        movq      112(%rsp), %rax                               #66.9[spill]
        movq      184(%rsp), %rdx                               #70.3[spill]
        movq      136(%rsp), %rcx                               #76.3[spill]
        movq      144(%rsp), %rbx                               #78.3[spill]
        movq      160(%rsp), %rsi                               #82.3[spill]
        movq      40(%rsp), %r11                                #90.3[spill]
        vmovsd    .L_2il0floatpacket.3(%rip), %xmm0             #66.9
        movq      152(%rsp), %r12                               #[spill]
        ...
        vmovsd    %xmm0, (%rbx)                                 #78.3
        vmovsd    %xmm0, 792(%rbx)                              #77.1
        vmovsd    %xmm0, (%r12)                                 #80.3
        ...
        vmovsd    %xmm0, 800(%rbx)                              #78.3
        vmovsd    %xmm0, 1592(%rbx)                             #77.1
        vmovsd    %xmm0, 800(%r12)                              #80.3
        ...
        movq      %r10, %rcx                                    #92.3
        vmovsd    %xmm0, 1600(%rbx)                             #78.3
        vmovsd    %xmm0, 2392(%rbx)                             #77.1
        movq      %r9, %rbx                                     #92.3
        vmovsd    %xmm0, 1600(%r12)                             #80.3
        ...
        movq      160(%rsp), %r8                                #92.3[spill]
        movq      144(%rsp), %r9                                #92.3[spill]
        movq      136(%rsp), %r10                               #92.3[spill]
...
..B1.23:                        # Preds ..B1.22
        ...
        vmovsd    %xmm1, 32(%rsp)                               #135.27[spill]
        movl      %ebx, 64(%rsp)                                #135.27[spill]
        movq      %r12, 152(%rsp)                               #135.27[spill]
        movq      %r14, 128(%rsp)                               #135.27[spill]
        movq      %r15, 120(%rsp)                               #135.27[spill]
        movq      %r13, 176(%rsp)                               #135.27[spill]
        jmp       ..B1.24       # Prob 100%                     #135.27
                                # LOE
..B1.37:                        # Preds ..B1.36
                                # Execution count [4.10e+00]
        movl      %ebx, 64(%rsp)                                #[spill]
                                # LOE
..B1.24:                        # Preds ..B1.23 ..B1.37
                                # Execution count [5.00e+00]
        movq      112(%rsp), %r14                               #152.16[spill]
        xorl      %ecx, %ecx                                    #152.4
        movq      176(%rsp), %r13                               #153.16[spill]
        movq      56(%rsp), %r12                                #162.15[spill]
        movq      48(%rsp), %r11                                #163.15[spill]
        movq      40(%rsp), %r15                                #164.15[spill]
        movq      184(%rsp), %rdx                               #154.16[spill]
        movq      120(%rsp), %rsi                               #155.16[spill]
        movq      128(%rsp), %rdi                               #156.15[spill]
        movq      136(%rsp), %r8                                #157.15[spill]
        movq      144(%rsp), %rbx                               #158.15[spill]
        movq      152(%rsp), %r9                                #159.15[spill]
        movq      160(%rsp), %r10                               #160.15[spill]
        movq      168(%rsp), %rax                               #161.15[spill]
        movq      1592(%r14), %r14                              #152.16
        movq      1592(%r13), %r13                              #153.16
        movq      1592(%r12), %r12                              #162.15
        movq      1592(%r11), %r11                              #163.15
        movq      1592(%r15), %r15                              #164.15
        movq      %r12, 104(%rsp)                               #164.15[spill]
        movq      %r13, 96(%rsp)                                #164.15[spill]
        movq      %r14, 88(%rsp)                                #164.15[spill]
        movq      1592(%rdx), %rdx                              #154.16
        movq      1592(%rsi), %rsi                              #155.16
        movq      1592(%rdi), %rdi                              #156.15
        movq      1592(%r8), %r8                                #157.15
        movq      1592(%rbx), %rbx                              #158.15
        movq      1592(%r9), %r9                                #159.15
        movq      1592(%r10), %r10                              #160.15
        movq      1592(%rax), %rax                              #161.15
        movq      %r15, 72(%rsp)                                #164.15[spill]
        movq      %r11, 80(%rsp)                                #164.15[spill]
        vmovsd    .L_2il0floatpacket.1(%rip), %xmm0             #164.15
        movq      40(%rsp), %r14                                #164.15[spill]
        movq      48(%rsp), %r12                                #164.15[spill]
        movq      56(%rsp), %r13                                #164.15[spill]
                                # LOE rax rdx rbx rsi rdi r8 r9 r10 r12 r13 r14 ecx xmm0
..B1.26:                        # Preds ..B1.24 ..B1.31
                                # Execution count [2.78e+01]
        movq      %rbx, 192(%rsp)                               #134.11[spill]
        xorl      %r11d, %r11d                                  #134.11
        movq      %r8, 200(%rsp)                                #134.11[spill]
        movq      %rdi, 208(%rsp)                               #134.11[spill]
        movq      %rsi, 216(%rsp)                               #134.11[spill]
        movq      %rdx, 224(%rsp)                               #134.11[spill]
        movl      %ecx, 232(%rsp)                               #134.11[spill]
        movq      168(%rsp), %rdx                               #134.11[spill]
        movq      160(%rsp), %rcx                               #134.11[spill]
        movq      152(%rsp), %rbx                               #134.11[spill]
        movq      144(%rsp), %rsi                               #134.11[spill]
        movq      136(%rsp), %rdi                               #134.11[spill]
        movq      128(%rsp), %r8                                #134.11[spill]
        movq      120(%rsp), %r12                               #134.11[spill]
        movq      184(%rsp), %r13                               #134.11[spill]
        movq      176(%rsp), %r14                               #134.11[spill]
        movq      112(%rsp), %r15                               #134.11[spill]
                                # LOE rax rdx rcx rbx rsi rdi r8 r9 r10 r11 r12 r13 r14 r15 xmm0
..B1.27:                        # Preds ..B1.27 ..B1.26
                                # Execution count [2.72e+03]
        vmovsd    800(%r15,%r11,8), %xmm1                       #136.19
        vmovsd    800(%r14,%r11,8), %xmm6                       #139.25
        vmovsd    800(%r13,%r11,8), %xmm11                      #140.25
        vmovsd    800(%r12,%r11,8), %xmm16                      #141.25
        vmovsd    800(%r8,%r11,8), %xmm21                       #142.24
        vmovsd    800(%rdi,%r11,8), %xmm26                      #143.24
        vmovsd    800(%rsi,%r11,8), %xmm31                      #144.24
        vaddsd    1608(%r15,%r11,8), %xmm1, %xmm2               #136.33
        vaddsd    1608(%r14,%r11,8), %xmm6, %xmm7               #139.42
        vaddsd    1608(%r13,%r11,8), %xmm11, %xmm12             #140.42
        vaddsd    1608(%r12,%r11,8), %xmm16, %xmm17             #141.42
        vaddsd    1608(%r8,%r11,8), %xmm21, %xmm22              #142.40
        vaddsd    816(%r15,%r11,8), %xmm2, %xmm3                #137.19
        vaddsd    816(%r14,%r11,8), %xmm7, %xmm8                #139.59
        vaddsd    816(%r13,%r11,8), %xmm12, %xmm13              #140.59
        vaddsd    1608(%rdi,%r11,8), %xmm26, %xmm27             #143.40
        vaddsd    1608(%rsi,%r11,8), %xmm31, %xmm1              #144.40
        vaddsd    8(%r15,%r11,8), %xmm3, %xmm4                  #137.33
        vaddsd    8(%r14,%r11,8), %xmm8, %xmm9                  #139.76
        vaddsd    8(%r13,%r11,8), %xmm13, %xmm14                #140.76
        vaddsd    816(%r12,%r11,8), %xmm17, %xmm18              #141.59
        vaddsd    816(%r8,%r11,8), %xmm22, %xmm23               #142.56
        vmulsd    %xmm4, %xmm0, %xmm5                           #137.33
        vaddsd    816(%rdi,%r11,8), %xmm27, %xmm28              #143.56
        vaddsd    816(%rsi,%r11,8), %xmm1, %xmm2                #144.56
        vmulsd    %xmm9, %xmm0, %xmm10                          #139.76
        vaddsd    8(%r12,%r11,8), %xmm18, %xmm19                #141.76
        vmulsd    %xmm14, %xmm0, %xmm15                         #140.76
        vaddsd    8(%r8,%r11,8), %xmm23, %xmm24                 #142.72
        vaddsd    8(%rdi,%r11,8), %xmm28, %xmm29                #143.72
        vaddsd    8(%rsi,%r11,8), %xmm2, %xmm3                  #144.72
        vmulsd    %xmm19, %xmm0, %xmm20                         #141.76
        vmulsd    %xmm24, %xmm0, %xmm25                         #142.72
        vmulsd    %xmm29, %xmm0, %xmm30                         #143.72
        vmulsd    %xmm3, %xmm0, %xmm4                           #144.72
        vmovsd    %xmm5, 808(%r15,%r11,8)                       #135.15
        vmovsd    %xmm10, 808(%r14,%r11,8)                      #139.1
        vmovsd    %xmm15, 808(%r13,%r11,8)                      #140.1
        .byte     144                                           #145.24
        vmovsd    800(%rbx,%r11,8), %xmm5                       #145.24
        vmovsd    800(%rcx,%r11,8), %xmm10                      #146.24
        vmovsd    800(%rdx,%r11,8), %xmm15                      #147.24
        vmovsd    %xmm20, 808(%r12,%r11,8)                      #141.1
        vmovsd    %xmm25, 808(%r8,%r11,8)                       #142.1
        vmovsd    %xmm30, 808(%rdi,%r11,8)                      #143.1
        vmovsd    %xmm4, 808(%rsi,%r11,8)                       #144.1
        vaddsd    1608(%rbx,%r11,8), %xmm5, %xmm6               #145.40
        vaddsd    1608(%rcx,%r11,8), %xmm10, %xmm11             #146.40
        vaddsd    1608(%rdx,%r11,8), %xmm15, %xmm16             #147.40
        vaddsd    816(%rbx,%r11,8), %xmm6, %xmm7                #145.56
        vaddsd    816(%rcx,%r11,8), %xmm11, %xmm12              #146.56
        vaddsd    816(%rdx,%r11,8), %xmm16, %xmm17              #147.56
        vaddsd    8(%rbx,%r11,8), %xmm7, %xmm8                  #145.72
        vaddsd    8(%rcx,%r11,8), %xmm12, %xmm13                #146.72
        vaddsd    8(%rdx,%r11,8), %xmm17, %xmm18                #147.72
        vmulsd    %xmm8, %xmm0, %xmm9                           #145.72
        vmulsd    %xmm13, %xmm0, %xmm14                         #146.72
        vmulsd    %xmm18, %xmm0, %xmm19                         #147.72
        vmovsd    %xmm9, 808(%rbx,%r11,8)                       #145.1
        vmovsd    %xmm14, 808(%rcx,%r11,8)                      #146.1
        vmovsd    %xmm19, 808(%rdx,%r11,8)                      #147.1
        incq      %r11                                          #134.11
        cmpq      $98, %r11                                     #134.11
...
..B1.28:                        # Preds ..B1.27
        ...
        movq      208(%rsp), %rdi                               #[spill]
        movq      216(%rsp), %rsi                               #[spill]
        movq      224(%rsp), %rdx                               #[spill]
        movl      232(%rsp), %ecx                               #[spill]
...
..B1.29:                        # Preds ..B1.28
                                # Execution count [2.78e+01]
        xorl      %r11d, %r11d                                  #134.11
                                # LOE rax rdx rbx rsi rdi r8 r9 r10 r11 r12 r13 r14 ecx xmm0
..B1.30:                        # Preds ..B1.30 ..B1.29
                                # Execution count [2.72e+03]
        vmovsd    800(%r13,%r11,8), %xmm1                       #148.24
        vmovsd    800(%r12,%r11,8), %xmm6                       #149.24
        vmovsd    800(%r14,%r11,8), %xmm11                      #150.24
        vaddsd    1608(%r13,%r11,8), %xmm1, %xmm2               #148.40
        vaddsd    1608(%r12,%r11,8), %xmm6, %xmm7               #149.40
        vaddsd    1608(%r14,%r11,8), %xmm11, %xmm12             #150.40
        vaddsd    816(%r13,%r11,8), %xmm2, %xmm3                #148.56
        vaddsd    816(%r12,%r11,8), %xmm7, %xmm8                #149.56
        vaddsd    816(%r14,%r11,8), %xmm12, %xmm13              #150.56
        vaddsd    8(%r13,%r11,8), %xmm3, %xmm4                  #148.72
        vaddsd    8(%r12,%r11,8), %xmm8, %xmm9                  #149.72
        vaddsd    8(%r14,%r11,8), %xmm13, %xmm14                #150.72
        vmulsd    %xmm4, %xmm0, %xmm5                           #148.72
        vmulsd    %xmm9, %xmm0, %xmm10                          #149.72
        vmulsd    %xmm14, %xmm0, %xmm15                         #150.72
        vmovsd    %xmm5, 808(%r13,%r11,8)                       #148.1
        vmovsd    %xmm10, 808(%r12,%r11,8)                      #149.1
        vmovsd    %xmm15, 808(%r14,%r11,8)                      #150.1
        incq      %r11                                          #134.11
        cmpq      $98, %r11                                     #134.11
...
..B1.31:                        # Preds ..B1.30
                                # Execution count [2.78e+01]
        movq      112(%rsp), %r15                               #152.4[spill]
        incl      %ecx                                          #130.5
        movq      88(%rsp), %r11                                #152.4[spill]
        movq      %r11, 800(%r15)                               #152.4
        movq      176(%rsp), %r15                               #153.1[spill]
        movq      96(%rsp), %r11                                #153.1[spill]
        movq      %r11, 800(%r15)                               #153.1
        movq      184(%rsp), %r11                               #154.1[spill]
        movq      120(%rsp), %r15                               #155.1[spill]
        movq      %rdx, 800(%r11)                               #154.1
        movq      128(%rsp), %r11                               #156.1[spill]
        movq      %rsi, 800(%r15)                               #155.1
        movq      136(%rsp), %r15                               #157.1[spill]
        movq      %rdi, 800(%r11)                               #156.1
        movq      144(%rsp), %r11                               #158.1[spill]
        movq      %r8, 800(%r15)                                #157.1
        movq      152(%rsp), %r15                               #159.1[spill]
        movq      %rbx, 800(%r11)                               #158.1
        movq      160(%rsp), %r11                               #160.1[spill]
        movq      %r9, 800(%r15)                                #159.1
        movq      168(%rsp), %r15                               #161.1[spill]
        movq      %r10, 800(%r11)                               #160.1
        movq      104(%rsp), %r11                               #162.1[spill]
        movq      %rax, 800(%r15)                               #161.1
        movq      %r11, 800(%r13)                               #162.1
        movq      80(%rsp), %r15                                #163.1[spill]
        movq      72(%rsp), %r11                                #164.1[spill]
        movq      %r15, 800(%r12)                               #163.1
        movq      %r11, 800(%r14)                               #164.1
        cmpl      64(%rsp), %ecx                                #130.5[spill]
...
..B1.34:                        # Preds ..B1.33
        ...
        vsubsd    32(%rsp), %xmm16, %xmm0                       #170.20[spill]
...
..B1.36:                        # Preds ..B1.35
        ...
        vmovsd    %xmm1, 32(%rsp)                               #128.17[spill]
        testl     %ebx, %ebx                                    #130.22
        jle       ..B1.33       # Prob 10%                      #130.22
        jmp       ..B1.37       # Prob 100%                     #130.22
                                # LOE ebx
..B1.38:                        # Preds ..B1.34
...
..B1.44:                        # Preds ..B1.43
                                # Execution count [6.74e-01]: Infreq
        movq      136(%rsp), %rdi                               #185.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #185.1
                                # LOE r12
..B1.45:                        # Preds ..B1.44
                                # Execution count [6.74e-01]: Infreq
        movq      144(%rsp), %rdi                               #186.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #186.1
                                # LOE r12
..B1.46:                        # Preds ..B1.45
...
..B1.48:                        # Preds ..B1.47
                                # Execution count [6.74e-01]: Infreq
        movq      168(%rsp), %rdi                               #189.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #189.1
                                # LOE
..B1.49:                        # Preds ..B1.48
                                # Execution count [6.74e-01]: Infreq
        movq      56(%rsp), %rdi                                #190.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #190.1
                                # LOE
..B1.50:                        # Preds ..B1.49
                                # Execution count [6.74e-01]: Infreq
        movq      48(%rsp), %rdi                                #191.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #191.1
                                # LOE
..B1.51:                        # Preds ..B1.50
                                # Execution count [6.74e-01]: Infreq
        movq      40(%rsp), %rdi                                #192.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #192.1
                                # LOE
..B1.52:                        # Preds ..B1.51
