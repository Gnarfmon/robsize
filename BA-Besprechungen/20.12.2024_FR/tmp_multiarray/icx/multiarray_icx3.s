...
..B1.25:                        # Preds ..B1.24
        ...
        vmovsd    %xmm0, (%r13)                                 #48.9
        vmovsd    %xmm0, 792(%r13)                              #47.9
        vmovsd    %xmm0, (%r12)                                 #50.3
        vmovsd    %xmm0, 792(%r12)                              #49.1
        vmovsd    %xmm0, (%r14)                                 #52.3
        vmovsd    %xmm0, 792(%r14)                              #51.1
        vmovsd    %xmm0, (%rbx)                                 #54.3
        vmovsd    %xmm0, 792(%rbx)                              #53.1
        vmovsd    %xmm0, 800(%r13)                              #48.9
        vmovsd    %xmm0, 1592(%r13)                             #47.9
        vmovsd    %xmm0, 800(%r12)                              #50.3
        vmovsd    %xmm0, 1592(%r12)                             #49.1
        vmovsd    %xmm0, 800(%r14)                              #52.3
        vmovsd    %xmm0, 1592(%r14)                             #51.1
        vmovsd    %xmm0, 800(%rbx)                              #54.3
        vmovsd    %xmm0, 1592(%rbx)                             #53.1
        vmovsd    %xmm0, 1600(%r13)                             #48.9
        vmovsd    %xmm0, 2392(%r13)                             #47.9
        vmovsd    %xmm0, 1600(%r12)                             #50.3
        vmovsd    %xmm0, 2392(%r12)                             #49.1
        vmovsd    %xmm0, 1600(%r14)                             #52.3
        vmovsd    %xmm0, 2392(%r14)                             #51.1
        vmovsd    %xmm0, 1600(%rbx)                             #54.3
...
..B1.26:                        # Preds ..B1.26 ..B1.25
        ...
        vmovsd    %xmm0, (%r13,%rax,8)                          #57.9
        vmovsd    %xmm0, 1600(%r13,%rax,8)                      #58.9
        incq      %rax                                          #56.3
        cmpq      $100, %rax                                    #56.3
...
..B1.28:                        # Preds ..B1.27
        ...
        vmovsd    %xmm1, 32(%rsp)                               #81.27[spill]
                                # LOE rbx r12 r13 r14 r15d
..B1.29:                        # Preds ..B1.38 ..B1.28
                                # Execution count [5.00e+00]
        movq      1592(%r13), %rsi                              #89.16
        xorl      %r8d, %r8d                                    #89.4
        movq      1592(%r12), %rcx                              #90.15
        xorl      %r10d, %r10d                                  #92.15
        movq      1592(%r14), %rdx                              #91.15
        movq      1592(%rbx), %rax                              #92.15
        vmovsd    .L_2il0floatpacket.1(%rip), %xmm0             #92.15
...
..B1.32:                        # Preds ..B1.32 ..B1.31
        ...
        vmovsd    800(%r13,%r9,8), %xmm1                        #82.19
        vmovsd    800(%r12,%r9,8), %xmm6                        #85.24
        vmovsd    800(%r14,%r9,8), %xmm11                       #86.24
        vmovsd    800(%rbx,%r9,8), %xmm16                       #87.24
        vaddsd    1608(%r13,%r9,8), %xmm1, %xmm2                #82.33
        vaddsd    1608(%r12,%r9,8), %xmm6, %xmm7                #85.40
        vaddsd    1608(%r14,%r9,8), %xmm11, %xmm12              #86.40
        vaddsd    1608(%rbx,%r9,8), %xmm16, %xmm17              #87.40
        vaddsd    816(%r13,%r9,8), %xmm2, %xmm3                 #83.19
        vaddsd    816(%r12,%r9,8), %xmm7, %xmm8                 #85.56
        vaddsd    816(%r14,%r9,8), %xmm12, %xmm13               #86.56
        vaddsd    816(%rbx,%r9,8), %xmm17, %xmm18               #87.56
        vaddsd    8(%r13,%r9,8), %xmm3, %xmm4                   #83.33
        vaddsd    8(%r12,%r9,8), %xmm8, %xmm9                   #85.72
        vaddsd    8(%r14,%r9,8), %xmm13, %xmm14                 #86.72
        vaddsd    8(%rbx,%r9,8), %xmm18, %xmm19                 #87.72
        vmulsd    %xmm4, %xmm0, %xmm5                           #83.33
        vmulsd    %xmm9, %xmm0, %xmm10                          #85.72
        vmulsd    %xmm14, %xmm0, %xmm15                         #86.72
        vmulsd    %xmm19, %xmm0, %xmm20                         #87.72
        vmovsd    %xmm5, 808(%r13,%r9,8)                        #81.15
        vmovsd    %xmm10, 808(%r12,%r9,8)                       #85.1
        vmovsd    %xmm15, 808(%r14,%r9,8)                       #86.1
        vmovsd    %xmm20, 808(%rbx,%r9,8)                       #87.1
        incq      %r9                                           #80.11
        cmpq      $98, %r9                                      #80.11
...
..B1.33:                        # Preds ..B1.32
                                # Execution count [2.78e+01]
        incl      %r8d                                          #76.5
        movq      %rsi, 800(%r13)                               #89.4
        movq      %rcx, 800(%r12)                               #90.1
        movq      %rdx, 800(%r14)                               #91.1
        movq      %rax, 800(%rbx)                               #92.1
        cmpl      %r15d, %r8d                                   #76.5
...
..B1.36:                        # Preds ..B1.35
        ...
        vsubsd    32(%rsp), %xmm16, %xmm0                       #98.20[spill]
...
..B1.38:                        # Preds ..B1.37
        ...
        vmovsd    %xmm1, 32(%rsp)                               #74.17[spill]
