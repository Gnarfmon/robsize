...
..B1.24:                        # Preds ..B1.100
        ...
        movq      %rbx, 48(%rsp)                                #57.3[spill]
        movq      %r13, 104(%rsp)                               #57.3[spill]
        movq      %r14, 376(%rsp)                               #57.3[spill]
        movq      %r12, 400(%rsp)                               #57.3[spill]
                                # LOE rax ymm0
..B1.25:                        # Preds ..B1.27 ..B1.24
        ...
        movq      360(%rsp), %rdx                               #64.1[spill]
        movq      336(%rsp), %r13                               #59.7[spill]
        lea       (%rdi,%rax), %rsi                             #62.1
        movq      400(%rsp), %r11                               #60.1[spill]
        lea       (%rbx,%rax), %rcx                             #63.1
        movq      392(%rsp), %rdi                               #68.1[spill]
        lea       (%rdx,%rax), %r15                             #64.1
        movq      408(%rsp), %r9                                #61.1[spill]
        lea       (%r13,%rax), %r12                             #59.7
        movq      368(%rsp), %r13                               #65.1[spill]
        lea       (%r11,%rax), %r10                             #60.1
        movq      376(%rsp), %r11                               #66.1[spill]
        movq      %rcx, 184(%rsp)                               #63.1[spill]
        lea       (%r9,%rax), %r8                               #61.1
        movq      %r15, 192(%rsp)                               #64.1[spill]
        movq      128(%rsp), %rcx                               #70.1[spill]
...
..B1.28:                        # Preds ..B1.27
                                # Execution count [1.00e+00]
        movq      336(%rsp), %rax                               #86.9[spill]
        vmovsd    .L_2il0floatpacket.3(%rip), %xmm0             #86.9
        movq      408(%rsp), %rdx                               #90.3[spill]
        ...
        movq      344(%rsp), %rcx                               #92.3[spill]
        movq      128(%rsp), %rax                               #108.3[spill]
        ...
        movq      352(%rsp), %rsi                               #94.3[spill]
        movq      112(%rsp), %rcx                               #112.3[spill]
        movq      96(%rsp), %rax                                #116.3[spill]
        vmovsd    %xmm0, (%r8)                                  #96.3
        ...
        movq      384(%rsp), %r10                               #102.3[spill]
        movq      392(%rsp), %r11                               #104.3[spill]
        movq      88(%rsp), %rdx                                #118.3[spill]
        movq      64(%rsp), %r8                                 #124.3[spill]
        movq      40(%rsp), %r9                                 #126.3[spill]
        ...
        movq      416(%rsp), %r15                               #106.3[spill]
        movq      80(%rsp), %rcx                                #120.3[spill]
        movq      72(%rsp), %rsi                                #122.3[spill]
        movq      32(%rsp), %rax                                #130.3[spill]
        ...
        movq      80(%rsp), %r9                                 #132.3[spill]
        movq      88(%rsp), %r10                                #132.3[spill]
        movq      96(%rsp), %r11                                #132.3[spill]
...
..B1.30:                        # Preds ..B1.29
        ...
        xorl      %eax, %eax                                    #132.3
        movq      112(%rsp), %rdx                               #132.3[spill]
        movq      120(%rsp), %rcx                               #132.3[spill]
        movq      128(%rsp), %rsi                               #132.3[spill]
        movq      416(%rsp), %r8                                #132.3[spill]
        movq      392(%rsp), %r9                                #132.3[spill]
        movq      384(%rsp), %r10                               #132.3[spill]
                                # LOE rax rdx rcx rbx rsi r8 r9 r10 r12 r13 r14 xmm0
..B1.31:                        # Preds ..B1.31 ..B1.30
                                # Execution count [1.00e+02]
        vmovsd    %xmm0, (%r13,%rax,8)                          #161.1
        vmovsd    %xmm0, 1600(%r13,%rax,8)                      #162.2
        ...
        vmovsd    %xmm0, (%r14,%rax,8)                          #147.1
        vmovsd    %xmm0, 1600(%r14,%rax,8)                      #148.2
        incq      %rax                                          #132.3
        cmpq      $100, %rax                                    #132.3
...
..B1.32:                        # Preds ..B1.31
        ...
        vmovsd    .L_2il0floatpacket.3(%rip), %xmm0             #132.3
        xorl      %eax, %eax                                    #132.3
        movq      368(%rsp), %rdx                               #132.3[spill]
        movq      360(%rsp), %rcx                               #132.3[spill]
        movq      352(%rsp), %rsi                               #132.3[spill]
        movq      344(%rsp), %r8                                #132.3[spill]
        movq      408(%rsp), %r9                                #132.3[spill]
        movq      336(%rsp), %r10                               #132.3[spill]
        .align    16,0x90
                                # LOE rax rdx rcx rbx rsi r8 r9 r10 r12 r13 r14 xmm0
...
..B1.35:                        # Preds ..B1.34
        ...
        vmovsd    %xmm1, 56(%rsp)                               #195.27[spill]
        movl      %r15d, 136(%rsp)                              #195.27[spill]
        movq      %rbx, 48(%rsp)                                #195.27[spill]
        movq      %r13, 104(%rsp)                               #195.27[spill]
        movq      %r14, 376(%rsp)                               #195.27[spill]
        movq      %r12, 400(%rsp)                               #195.27[spill]
        jmp       ..B1.36       # Prob 100%                     #195.27
                                # LOE
..B1.49:                        # Preds ..B1.48
...
..B1.36:                        # Preds ..B1.35 ..B1.49
        ...
        movq      336(%rsp), %r14                               #222.16[spill]
        movq      400(%rsp), %r12                               #223.16[spill]
        movq      408(%rsp), %r10                               #224.16[spill]
        movq      344(%rsp), %r8                                #225.16[spill]
        movq      352(%rsp), %rsi                               #226.16[spill]
        movq      360(%rsp), %rcx                               #227.16[spill]
        movq      368(%rsp), %rax                               #228.16[spill]
        movq      1592(%r14), %r13                              #222.16
        movq      1592(%r12), %r11                              #223.16
        movq      1592(%r10), %r9                               #224.16
        movq      1592(%r8), %rdi                               #225.16
        movq      376(%rsp), %r14                               #229.16[spill]
        movq      384(%rsp), %r12                               #230.16[spill]
        movq      1592(%rsi), %rbx                              #226.16
        movq      1592(%rcx), %rdx                              #227.16
        movq      1592(%rax), %r15                              #228.16
        movq      %r9, 280(%rsp)                                #224.16[spill]
        movq      %rdi, 288(%rsp)                               #225.16[spill]
        movq      %rbx, 296(%rsp)                               #226.16[spill]
        movq      %rdx, 304(%rsp)                               #227.16[spill]
        movq      392(%rsp), %r10                               #231.16[spill]
        movq      416(%rsp), %r9                                #232.16[spill]
        movq      128(%rsp), %r8                                #233.16[spill]
        movq      120(%rsp), %rdi                               #234.16[spill]
        movq      112(%rsp), %rsi                               #235.16[spill]
        movq      104(%rsp), %rbx                               #236.15[spill]
        movq      96(%rsp), %rcx                                #237.15[spill]
        movq      88(%rsp), %rdx                                #238.15[spill]
        movq      %r15, 312(%rsp)                               #228.16[spill]
        movq      80(%rsp), %rax                                #239.15[spill]
        movq      72(%rsp), %r15                                #240.15[spill]
        movq      %r13, 264(%rsp)                               #222.16[spill]
        movq      %r11, 272(%rsp)                               #223.16[spill]
        movq      1592(%r14), %r13                              #229.16
        movq      1592(%r12), %r11                              #230.16
        movq      %r13, 320(%rsp)                               #229.16[spill]
        movq      %r11, 328(%rsp)                               #230.16[spill]
        movq      1592(%r10), %r14                              #231.16
        movq      1592(%r9), %r13                               #232.16
        movq      1592(%r8), %r12                               #233.16
        movq      1592(%rdi), %r11                              #234.16
        movq      1592(%rsi), %r10                              #235.16
        movq      1592(%rbx), %r9                               #236.15
        movq      1592(%rcx), %r8                               #237.15
        movq      1592(%rdx), %rdi                              #238.15
        movq      1592(%rax), %rsi                              #239.15
        movq      1592(%r15), %rbx                              #240.15
        movq      64(%rsp), %rcx                                #241.15[spill]
        movq      40(%rsp), %rdx                                #242.15[spill]
        movq      48(%rsp), %rax                                #243.15[spill]
        movq      32(%rsp), %r15                                #244.15[spill]
        movq      1592(%rcx), %rcx                              #241.15
        movq      1592(%rdx), %rdx                              #242.15
        movq      1592(%rax), %rax                              #243.15
        movq      1592(%r15), %r15                              #244.15
        movq      %rdx, 152(%rsp)                               #244.15[spill]
        movq      %rcx, 160(%rsp)                               #244.15[spill]
        movq      %rbx, 168(%rsp)                               #244.15[spill]
        movq      %rsi, 176(%rsp)                               #244.15[spill]
        movq      %rdi, 184(%rsp)                               #244.15[spill]
        movq      %r8, 192(%rsp)                                #244.15[spill]
        movq      %r9, 200(%rsp)                                #244.15[spill]
        movq      %r10, 208(%rsp)                               #244.15[spill]
        movq      %r11, 216(%rsp)                               #244.15[spill]
        movq      %r12, 224(%rsp)                               #244.15[spill]
        movq      %r13, 240(%rsp)                               #244.15[spill]
        movq      %r14, 232(%rsp)                               #244.15[spill]
        movl      $0, 256(%rsp)                                 #222.4[spill]
        movq      %r15, 248(%rsp)                               #244.15[spill]
        movq      %rax, 144(%rsp)                               #244.15[spill]
        vmovsd    .L_2il0floatpacket.1(%rip), %xmm0             #244.15
        movq      32(%rsp), %rdx                                #244.15[spill]
        movq      48(%rsp), %r13                                #244.15[spill]
        movq      40(%rsp), %r14                                #244.15[spill]
        movq      64(%rsp), %r12                                #244.15[spill]
        movq      72(%rsp), %r11                                #244.15[spill]
        movq      80(%rsp), %r10                                #244.15[spill]
        movq      88(%rsp), %rcx                                #244.15[spill]
        movq      96(%rsp), %rbx                                #244.15[spill]
        movq      104(%rsp), %rsi                               #244.15[spill]
        movq      112(%rsp), %rdi                               #244.15[spill]
        movq      120(%rsp), %r8                                #244.15[spill]
        movq      128(%rsp), %r9                                #244.15[spill]
                                # LOE rdx rcx rbx rsi rdi r8 r9 r10 r11 r12 r13 r14 xmm0
..B1.38:                        # Preds ..B1.36 ..B1.43
                                # Execution count [2.78e+01]
        movq      392(%rsp), %rcx                               #194.11[spill]
        xorl      %eax, %eax                                    #194.11
        movq      384(%rsp), %rbx                               #194.11[spill]
        movq      376(%rsp), %rsi                               #194.11[spill]
        movq      368(%rsp), %rdi                               #194.11[spill]
        movq      360(%rsp), %r8                                #194.11[spill]
        movq      352(%rsp), %r9                                #194.11[spill]
        movq      344(%rsp), %r10                               #194.11[spill]
        movq      408(%rsp), %r11                               #194.11[spill]
        movq      400(%rsp), %r12                               #194.11[spill]
        movq      336(%rsp), %r15                               #194.11[spill]
                                # LOE rax rdx rcx rbx rsi rdi r8 r9 r10 r11 r12 r13 r14 r15 xmm0
..B1.39:                        # Preds ..B1.39 ..B1.38
                                # Execution count [2.72e+03]
        vmovsd    800(%r15,%rax,8), %xmm1                       #196.19
        vmovsd    800(%r12,%rax,8), %xmm6                       #199.25
        vmovsd    800(%r11,%rax,8), %xmm11                      #200.25
        vmovsd    800(%r10,%rax,8), %xmm16                      #201.25
        vmovsd    800(%r9,%rax,8), %xmm21                       #202.25
        vmovsd    800(%r8,%rax,8), %xmm26                       #203.25
        vmovsd    800(%rdi,%rax,8), %xmm31                      #204.25
        vaddsd    1608(%r15,%rax,8), %xmm1, %xmm2               #196.33
        vaddsd    1608(%r12,%rax,8), %xmm6, %xmm7               #199.42
        vaddsd    1608(%r11,%rax,8), %xmm11, %xmm12             #200.42
        vaddsd    1608(%r10,%rax,8), %xmm16, %xmm17             #201.42
        vaddsd    1608(%r9,%rax,8), %xmm21, %xmm22              #202.42
        vaddsd    816(%r15,%rax,8), %xmm2, %xmm3                #197.19
        vaddsd    816(%r12,%rax,8), %xmm7, %xmm8                #199.59
        vaddsd    816(%r11,%rax,8), %xmm12, %xmm13              #200.59
        vaddsd    1608(%r8,%rax,8), %xmm26, %xmm27              #203.42
        vaddsd    1608(%rdi,%rax,8), %xmm31, %xmm1              #204.42
        vaddsd    8(%r15,%rax,8), %xmm3, %xmm4                  #197.33
        vaddsd    8(%r12,%rax,8), %xmm8, %xmm9                  #199.76
        vaddsd    8(%r11,%rax,8), %xmm13, %xmm14                #200.76
        vaddsd    816(%r10,%rax,8), %xmm17, %xmm18              #201.59
        vaddsd    816(%r9,%rax,8), %xmm22, %xmm23               #202.59
        vmulsd    %xmm4, %xmm0, %xmm5                           #197.33
        vaddsd    816(%r8,%rax,8), %xmm27, %xmm28               #203.59
        vaddsd    816(%rdi,%rax,8), %xmm1, %xmm2                #204.59
        vmulsd    %xmm9, %xmm0, %xmm10                          #199.76
        vaddsd    8(%r10,%rax,8), %xmm18, %xmm19                #201.76
        vmulsd    %xmm14, %xmm0, %xmm15                         #200.76
        vaddsd    8(%r9,%rax,8), %xmm23, %xmm24                 #202.76
        vaddsd    8(%r8,%rax,8), %xmm28, %xmm29                 #203.76
        vaddsd    8(%rdi,%rax,8), %xmm2, %xmm3                  #204.76
        vmulsd    %xmm19, %xmm0, %xmm20                         #201.76
        vmulsd    %xmm24, %xmm0, %xmm25                         #202.76
        vmulsd    %xmm29, %xmm0, %xmm30                         #203.76
        vmulsd    %xmm3, %xmm0, %xmm4                           #204.76
        vmovsd    %xmm5, 808(%r15,%rax,8)                       #195.15
        vmovsd    %xmm10, 808(%r12,%rax,8)                      #199.1
        vmovsd    %xmm15, 808(%r11,%rax,8)                      #200.1
        vmovsd    800(%rsi,%rax,8), %xmm5                       #205.25
        vmovsd    800(%rbx,%rax,8), %xmm10                      #206.25
        vmovsd    800(%rcx,%rax,8), %xmm15                      #207.25
        vmovsd    %xmm20, 808(%r10,%rax,8)                      #201.1
        vmovsd    %xmm25, 808(%r9,%rax,8)                       #202.1
        vmovsd    %xmm30, 808(%r8,%rax,8)                       #203.1
        vmovsd    %xmm4, 808(%rdi,%rax,8)                       #204.1
        vaddsd    1608(%rsi,%rax,8), %xmm5, %xmm6               #205.42
        vaddsd    1608(%rbx,%rax,8), %xmm10, %xmm11             #206.42
        vaddsd    1608(%rcx,%rax,8), %xmm15, %xmm16             #207.42
        vaddsd    816(%rsi,%rax,8), %xmm6, %xmm7                #205.59
        vaddsd    816(%rbx,%rax,8), %xmm11, %xmm12              #206.59
        vaddsd    816(%rcx,%rax,8), %xmm16, %xmm17              #207.59
        vaddsd    8(%rsi,%rax,8), %xmm7, %xmm8                  #205.76
        vaddsd    8(%rbx,%rax,8), %xmm12, %xmm13                #206.76
        .byte     144                                           #207.76
        vaddsd    8(%rcx,%rax,8), %xmm17, %xmm18                #207.76
        vmulsd    %xmm8, %xmm0, %xmm9                           #205.76
        vmulsd    %xmm13, %xmm0, %xmm14                         #206.76
        vmulsd    %xmm18, %xmm0, %xmm19                         #207.76
        vmovsd    %xmm9, 808(%rsi,%rax,8)                       #205.1
        vmovsd    %xmm14, 808(%rbx,%rax,8)                      #206.1
        vmovsd    %xmm19, 808(%rcx,%rax,8)                      #207.1
        incq      %rax                                          #194.11
        cmpq      $98, %rax                                     #194.11
...
..B1.41:                        # Preds ..B1.40
                                # Execution count [2.78e+01]
        movq      416(%rsp), %r15                               #194.11[spill]
        xorl      %eax, %eax                                    #194.11
                                # LOE rax rdx rcx rbx rsi rdi r8 r9 r10 r11 r12 r13 r14 r15 xmm0
..B1.42:                        # Preds ..B1.42 ..B1.41
                                # Execution count [2.72e+03]
        vmovsd    800(%r15,%rax,8), %xmm1                       #208.25
        vmovsd    800(%r9,%rax,8), %xmm6                        #209.25
        vmovsd    800(%r8,%rax,8), %xmm11                       #210.25
        vmovsd    800(%rdi,%rax,8), %xmm16                      #211.25
        vmovsd    800(%rsi,%rax,8), %xmm21                      #212.24
        vmovsd    800(%rbx,%rax,8), %xmm26                      #213.24
        vmovsd    800(%rcx,%rax,8), %xmm31                      #214.24
        vaddsd    1608(%r15,%rax,8), %xmm1, %xmm2               #208.42
        vaddsd    1608(%r9,%rax,8), %xmm6, %xmm7                #209.42
        vaddsd    1608(%r8,%rax,8), %xmm11, %xmm12              #210.42
        vaddsd    1608(%rdi,%rax,8), %xmm16, %xmm17             #211.42
        vaddsd    1608(%rsi,%rax,8), %xmm21, %xmm22             #212.40
        vaddsd    1608(%rbx,%rax,8), %xmm26, %xmm27             #213.40
        vaddsd    816(%r15,%rax,8), %xmm2, %xmm3                #208.59
        vaddsd    816(%r9,%rax,8), %xmm7, %xmm8                 #209.59
        vaddsd    816(%r8,%rax,8), %xmm12, %xmm13               #210.59
        vaddsd    816(%rdi,%rax,8), %xmm17, %xmm18              #211.59
        vaddsd    816(%rsi,%rax,8), %xmm22, %xmm23              #212.56
        vaddsd    816(%rbx,%rax,8), %xmm27, %xmm28              #213.56
        vaddsd    8(%r15,%rax,8), %xmm3, %xmm4                  #208.76
        vaddsd    8(%r9,%rax,8), %xmm8, %xmm9                   #209.76
        vaddsd    8(%r8,%rax,8), %xmm13, %xmm14                 #210.76
        vaddsd    8(%rdi,%rax,8), %xmm18, %xmm19                #211.76
        vaddsd    8(%rsi,%rax,8), %xmm23, %xmm24                #212.72
        vmulsd    %xmm4, %xmm0, %xmm5                           #208.76
        vaddsd    8(%rbx,%rax,8), %xmm28, %xmm29                #213.72
        vaddsd    1608(%rcx,%rax,8), %xmm31, %xmm1              #214.40
        vmulsd    %xmm9, %xmm0, %xmm10                          #209.76
        vmulsd    %xmm14, %xmm0, %xmm15                         #210.76
        vmulsd    %xmm19, %xmm0, %xmm20                         #211.76
        vaddsd    816(%rcx,%rax,8), %xmm1, %xmm2                #214.56
        vmulsd    %xmm24, %xmm0, %xmm25                         #212.72
        vmulsd    %xmm29, %xmm0, %xmm30                         #213.72
        .byte     144                                           #214.72
        vaddsd    8(%rcx,%rax,8), %xmm2, %xmm3                  #214.72
        vmovsd    %xmm5, 808(%r15,%rax,8)                       #208.1
        vmovsd    %xmm10, 808(%r9,%rax,8)                       #209.1
        vmovsd    %xmm15, 808(%r8,%rax,8)                       #210.1
        vmovsd    %xmm20, 808(%rdi,%rax,8)                      #211.1
        vmovsd    %xmm25, 808(%rsi,%rax,8)                      #212.1
        vmovsd    %xmm30, 808(%rbx,%rax,8)                      #213.1
        vmovsd    800(%r10,%rax,8), %xmm5                       #215.24
        vmovsd    800(%r11,%rax,8), %xmm10                      #216.24
        vmovsd    800(%r12,%rax,8), %xmm15                      #217.24
        vmovsd    800(%r14,%rax,8), %xmm20                      #218.24
        vmovsd    800(%r13,%rax,8), %xmm25                      #219.24
        vmovsd    800(%rdx,%rax,8), %xmm30                      #220.24
        vmulsd    %xmm3, %xmm0, %xmm4                           #214.72
        vaddsd    1608(%r10,%rax,8), %xmm5, %xmm6               #215.40
        vaddsd    1608(%r11,%rax,8), %xmm10, %xmm11             #216.40
        vaddsd    1608(%r12,%rax,8), %xmm15, %xmm16             #217.40
        vaddsd    1608(%r14,%rax,8), %xmm20, %xmm21             #218.40
        vaddsd    1608(%r13,%rax,8), %xmm25, %xmm26             #219.40
        vaddsd    1608(%rdx,%rax,8), %xmm30, %xmm31             #220.40
        vaddsd    816(%r10,%rax,8), %xmm6, %xmm7                #215.56
        vaddsd    816(%r11,%rax,8), %xmm11, %xmm12              #216.56
        vaddsd    816(%r12,%rax,8), %xmm16, %xmm17              #217.56
        vaddsd    816(%r14,%rax,8), %xmm21, %xmm22              #218.56
        vaddsd    816(%r13,%rax,8), %xmm26, %xmm27              #219.56
        vaddsd    816(%rdx,%rax,8), %xmm31, %xmm1               #220.56
        .byte     102                                           #215.72
        .byte     144                                           #215.72
        vaddsd    8(%r10,%rax,8), %xmm7, %xmm8                  #215.72
        vaddsd    8(%r11,%rax,8), %xmm12, %xmm13                #216.72
        vaddsd    8(%r12,%rax,8), %xmm17, %xmm18                #217.72
        vaddsd    8(%r14,%rax,8), %xmm22, %xmm23                #218.72
        vaddsd    8(%r13,%rax,8), %xmm27, %xmm28                #219.72
        vmulsd    %xmm8, %xmm0, %xmm9                           #215.72
        vaddsd    8(%rdx,%rax,8), %xmm1, %xmm2                  #220.72
        ...
        vmovsd    %xmm4, 808(%rcx,%rax,8)                       #214.1
        vmovsd    %xmm9, 808(%r10,%rax,8)                       #215.1
        vmovsd    %xmm14, 808(%r11,%rax,8)                      #216.1
        vmovsd    %xmm19, 808(%r12,%rax,8)                      #217.1
        vmovsd    %xmm24, 808(%r14,%rax,8)                      #218.1
        vmovsd    %xmm29, 808(%r13,%rax,8)                      #219.1
        vmovsd    %xmm3, 808(%rdx,%rax,8)                       #220.1
        incq      %rax                                          #194.11
        cmpq      $98, %rax                                     #194.11
...
..B1.43:                        # Preds ..B1.42
                                # Execution count [2.78e+01]
        movq      336(%rsp), %r15                               #222.4[spill]
        movq      264(%rsp), %rax                               #222.4[spill]
        movq      %rax, 800(%r15)                               #222.4
        movq      400(%rsp), %r15                               #223.1[spill]
        movq      272(%rsp), %rax                               #223.1[spill]
        movq      %rax, 800(%r15)                               #223.1
        movq      408(%rsp), %r15                               #224.1[spill]
        movq      280(%rsp), %rax                               #224.1[spill]
        movq      %rax, 800(%r15)                               #224.1
        movq      344(%rsp), %r15                               #225.1[spill]
        movq      288(%rsp), %rax                               #225.1[spill]
        movq      %rax, 800(%r15)                               #225.1
        movq      352(%rsp), %r15                               #226.1[spill]
        movq      296(%rsp), %rax                               #226.1[spill]
        movq      %rax, 800(%r15)                               #226.1
        movq      360(%rsp), %r15                               #227.1[spill]
        movq      304(%rsp), %rax                               #227.1[spill]
        movq      %rax, 800(%r15)                               #227.1
        movq      368(%rsp), %r15                               #228.1[spill]
        movq      312(%rsp), %rax                               #228.1[spill]
        movq      %rax, 800(%r15)                               #228.1
        movq      376(%rsp), %r15                               #229.1[spill]
        movq      320(%rsp), %rax                               #229.1[spill]
        movq      %rax, 800(%r15)                               #229.1
        movq      384(%rsp), %r15                               #230.1[spill]
        movq      328(%rsp), %rax                               #230.1[spill]
        movq      %rax, 800(%r15)                               #230.1
        movq      392(%rsp), %r15                               #231.1[spill]
        movq      232(%rsp), %rax                               #231.1[spill]
        movq      %rax, 800(%r15)                               #231.1
        movq      416(%rsp), %r15                               #232.1[spill]
        movq      240(%rsp), %rax                               #232.1[spill]
        movq      %rax, 800(%r15)                               #232.1
        movq      224(%rsp), %rax                               #233.1[spill]
        movq      %rax, 800(%r9)                                #233.1
        movq      208(%rsp), %rax                               #235.1[spill]
        movq      216(%rsp), %r15                               #234.1[spill]
        movq      %rax, 800(%rdi)                               #235.1
        movq      192(%rsp), %rax                               #237.1[spill]
        movq      %r15, 800(%r8)                                #234.1
        movq      200(%rsp), %r15                               #236.1[spill]
        movq      %rax, 800(%rbx)                               #237.1
        movq      176(%rsp), %rax                               #239.1[spill]
        movq      %r15, 800(%rsi)                               #236.1
        movq      184(%rsp), %r15                               #238.1[spill]
        movq      %rax, 800(%r10)                               #239.1
        movq      160(%rsp), %rax                               #241.1[spill]
        movq      %r15, 800(%rcx)                               #238.1
        movq      168(%rsp), %r15                               #240.1[spill]
        movq      %rax, 800(%r12)                               #241.1
        movq      144(%rsp), %rax                               #243.1[spill]
        movq      %r15, 800(%r11)                               #240.1
        movq      152(%rsp), %r15                               #242.1[spill]
        movq      %rax, 800(%r13)                               #243.1
        movl      256(%rsp), %eax                               #190.5[spill]
        movq      %r15, 800(%r14)                               #242.1
        incl      %eax                                          #190.5
        movq      248(%rsp), %r15                               #244.1[spill]
        movq      %r15, 800(%rdx)                               #244.1
        movl      %eax, 256(%rsp)                               #190.5[spill]
        cmpl      136(%rsp), %eax                               #190.5[spill]
...
..B1.46:                        # Preds ..B1.45
        ...
        addl      %r15d, %r15d                                  #249.19
        vmovsd    .L_2il0floatpacket.3(%rip), %xmm1             #250.30
        vsubsd    56(%rsp), %xmm16, %xmm0                       #250.20[spill]
...
..B1.48:                        # Preds ..B1.47
        ...
        vmovsd    %xmm1, 56(%rsp)                               #188.17[spill]
        testl     %r15d, %r15d                                  #190.22
        jle       ..B1.45       # Prob 10%                      #190.22
        jmp       ..B1.49       # Prob 100%                     #190.22
                                # LOE r15d
..B1.50:                        # Preds ..B1.46
        ...
        movl      $1, %eax                                      #259.3
        sarl      $1, %r15d                                     #259.3
        vcvtsi2sd %r15d, %xmm1, %xmm1                           #259.3
...
..B1.56:                        # Preds ..B1.55
                                # Execution count [6.74e-01]: Infreq
        movq      360(%rsp), %rdi                               #265.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #265.1
                                # LOE rbx r13 r14
..B1.57:                        # Preds ..B1.56
                                # Execution count [6.74e-01]: Infreq
        movq      368(%rsp), %rdi                               #266.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #266.1
                                # LOE rbx r13 r14
..B1.58:                        # Preds ..B1.57
...
..B1.62:                        # Preds ..B1.61
                                # Execution count [6.74e-01]: Infreq
        movq      128(%rsp), %rdi                               #271.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #271.1
                                # LOE rbx r13
..B1.63:                        # Preds ..B1.62
                                # Execution count [6.74e-01]: Infreq
        movq      120(%rsp), %rdi                               #272.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #272.1
                                # LOE rbx r13
..B1.64:                        # Preds ..B1.63
                                # Execution count [6.74e-01]: Infreq
        movq      112(%rsp), %rdi                               #273.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #273.1
                                # LOE rbx r13
..B1.65:                        # Preds ..B1.64
...
..B1.66:                        # Preds ..B1.65
                                # Execution count [6.74e-01]: Infreq
        movq      96(%rsp), %rdi                                #275.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #275.1
                                # LOE rbx
..B1.67:                        # Preds ..B1.66
                                # Execution count [6.74e-01]: Infreq
        movq      88(%rsp), %rdi                                #276.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #276.1
                                # LOE rbx
..B1.68:                        # Preds ..B1.67
                                # Execution count [6.74e-01]: Infreq
        movq      80(%rsp), %rdi                                #277.1[spill]
#       operator delete[](void *)
        call      _ZdaPv                                        #277.1
                                # LOE rbx
..B1.69:                        # Preds ..B1.68
...
..B2.1:                         # Preds ..B2.0
	...
	.cfi_startproc
	.cfi_personality 0x3,__gxx_personality_v0
..___tag_value__Z12getTimeStampv.337:
..L338:
                                                        #4.1
        subq      $24, %rsp                                     #4.1
...
..___tag_value__Z12getTimeStampv.341:
...
..B3.1:                         # Preds ..B3.0
	...
	.cfi_startproc
	.cfi_personality 0x3,__gxx_personality_v0
..___tag_value__Z17getTimeResolutionv.344:
..L345:
                                                        #11.1
        subq      $24, %rsp                                     #11.1
	.cfi_def_cfa_offset 32
...
..___tag_value__Z17getTimeResolutionv.348:
                                # LOE rbx rbp r12 r13 r14 r15
..B3.2:                         # Preds ..B3.1
                                # Execution count [1.00e+00]
