...
# mark_description "w -fargument-noalias -funroll-loops -fno-builtin -diag-disable=10441 -o results/icc/frontendTest/frontendThr";
# mark_description "oughputTest.s -S";
...
..B1.29:                        # Preds ..B1.28
        ...
        jl        ..B1.67       # Prob 10%                      #59.3
                                # LOE r12 r13 r14 r15 eax ecx
..B1.30:                        # Preds ..B1.29
                                # Execution count [5.60e-01]
        movl      %eax, %edi                                    #59.3
        movl      $715827883, %eax                              #59.3
        ...
        vmovsd    %xmm20, 56(%r14)                              #62.2
                                # LOE r12 r13 r14 r15 ecx edi
..B1.32:                        # Preds ..B1.30
                                # Execution count [7.05e-01]
        movslq    %edi, %rsi                                    #59.3
        movl      $7, %eax                                      #59.3
                                # LOE rax rsi r12 r13 r14 r15 ecx edi
..B1.33:                        # Preds ..B1.33 ..B1.32
                                # Execution count [3.92e+00]
        vmovupd   8(%r12,%rax,8), %ymm0                         #60.9
        vmovupd   40(%r12,%rax,8), %ymm3                        #60.9
        vmovupd   72(%r12,%rax,8), %ymm6                        #60.9
        vmovupd   104(%r12,%rax,8), %ymm9                       #60.9
        vmovupd   136(%r12,%rax,8), %ymm12                      #60.9
        vmovupd   168(%r12,%rax,8), %ymm15                      #60.9
        vmovupd   200(%r12,%rax,8), %ymm18                      #60.9
        vmovupd   232(%r12,%rax,8), %ymm21                      #60.9
        vmovupd   264(%r12,%rax,8), %ymm24                      #60.9
        vmovupd   296(%r12,%rax,8), %ymm27                      #60.9
        vmovupd   328(%r12,%rax,8), %ymm30                      #60.9
        ...
        vaddpd    %ymm24, %ymm24, %ymm26                        #60.16
        vaddpd    %ymm27, %ymm27, %ymm29                        #60.16
        vaddpd    %ymm30, %ymm30, %ymm0                         #60.16
        vmulpd    8(%r15,%rax,8), %ymm2, %ymm1                  #61.20
        vmovupd   %ymm2, 8(%r14,%rax,8)                         #62.2
        vmulpd    40(%r15,%rax,8), %ymm5, %ymm4                 #61.20
        vmulpd    72(%r15,%rax,8), %ymm8, %ymm7                 #61.20
        vmulpd    104(%r15,%rax,8), %ymm11, %ymm10              #61.20
        vmovupd   %ymm1, 8(%r13,%rax,8)                         #61.9
        vmovupd   360(%r12,%rax,8), %ymm1                       #60.9
        vmulpd    136(%r15,%rax,8), %ymm14, %ymm13              #61.20
        vmulpd    168(%r15,%rax,8), %ymm17, %ymm16              #61.20
        vmovupd   %ymm4, 40(%r13,%rax,8)                        #61.9
        vmulpd    200(%r15,%rax,8), %ymm20, %ymm19              #61.20
        vmulpd    232(%r15,%rax,8), %ymm23, %ymm22              #61.20
        .byte     144                                           #61.20
        vmulpd    264(%r15,%rax,8), %ymm26, %ymm25              #61.20
        vmovupd   %ymm5, 40(%r14,%rax,8)                        #62.2
        vmulpd    296(%r15,%rax,8), %ymm29, %ymm28              #61.20
        vmulpd    328(%r15,%rax,8), %ymm0, %ymm31               #61.20
        vmovupd   %ymm7, 72(%r13,%rax,8)                        #61.9
        vmovupd   %ymm8, 72(%r14,%rax,8)                        #62.2
        vmovupd   %ymm10, 104(%r13,%rax,8)                      #61.9
        vmovupd   %ymm11, 104(%r14,%rax,8)                      #62.2
        vmovupd   %ymm13, 136(%r13,%rax,8)                      #61.9
        vmovupd   %ymm14, 136(%r14,%rax,8)                      #62.2
        vmovupd   %ymm16, 168(%r13,%rax,8)                      #61.9
        vmovupd   %ymm17, 168(%r14,%rax,8)                      #62.2
        vmovupd   %ymm19, 200(%r13,%rax,8)                      #61.9
        vmovupd   %ymm20, 200(%r14,%rax,8)                      #62.2
        vmovupd   %ymm22, 232(%r13,%rax,8)                      #61.9
        vmovupd   %ymm23, 232(%r14,%rax,8)                      #62.2
        vmovupd   %ymm25, 264(%r13,%rax,8)                      #61.9
        vmovupd   %ymm26, 264(%r14,%rax,8)                      #62.2
        vmovupd   %ymm28, 296(%r13,%rax,8)                      #61.9
        vmovupd   %ymm29, 296(%r14,%rax,8)                      #62.2
        vmovupd   %ymm31, 328(%r13,%rax,8)                      #61.9
        vmovupd   %ymm0, 328(%r14,%rax,8)                       #62.2
        vaddpd    %ymm1, %ymm1, %ymm3                           #60.16
        vmulpd    360(%r15,%rax,8), %ymm3, %ymm2                #61.20
        vmovupd   %ymm3, 360(%r14,%rax,8)                       #62.2
        vmovupd   %ymm2, 360(%r13,%rax,8)                       #61.9
        addq      $48, %rax                                     #59.3
        cmpq      %rsi, %rax                                    #59.3
...
..B1.44:                        # Preds ..B1.44 ..B1.43
                                # Execution count [3.92e+00]
        vmovsd    8(%rsi,%rax,8), %xmm0                         #60.16
        vaddsd    %xmm0, %xmm0, %xmm2                           #60.16
        vmulsd    8(%r8,%rax,8), %xmm2, %xmm1                   #61.20
        vmovsd    %xmm1, 8(%r9,%rax,8)                          #61.9
        vmovsd    %xmm2, 8(%r10,%rax,8)                         #62.2
        incq      %rax                                          #59.3
        cmpq      %rcx, %rax                                    #59.3
...
..___tag_value_main.86:
	.byte	1
	.uleb128	..___tag_value_main.85 - ..___tag_value_main.84
..___tag_value_main.84:
	...
	.uleb128	..___tag_value_main.51 - ..___tag_value_main.32
	.uleb128	..___tag_value_main.1 - ..___tag_value_main.2
	.byte	0
	.uleb128	..___tag_value_main.70 - ..___tag_value_main.2
	.uleb128	..___tag_value_main.79 - ..___tag_value_main.70
	.byte	0
	.byte	0
	.uleb128	..___tag_value_main.80 - ..___tag_value_main.2
	.uleb128	..___tag_value_main.81 - ..___tag_value_main.80
	.uleb128	..___tag_value_main.1 - ..___tag_value_main.2
	.byte	0
